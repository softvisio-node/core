...
export default class Semver {
    ...
    get isPatch () {
        return this.patch || ( !this.major && !this.minor );
    }
    ...
    // XXX
    increment ( type, preRelease, { throwErrors = true } = {} ) {
        var version;
        ...
        if ( this.isPreRelease ) {
            ...
            if ( this.isMajor ) {
                ...
                version = this.#addPreRelease( version, preRelease );
            }
        ...
        version = this.constructor.new( version, { throwErrors } );
        if ( !version ) return;
    ...
    // private
    // XXX
    #addPreRelease ( version, preRelease ) {
        if ( preRelease === false ) {
            return version;
        }
        else if ( preRelease ) {
