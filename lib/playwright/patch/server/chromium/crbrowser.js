...
try {
    browser = require( "playwright-core/lib/server/chromium/crBrowser" );
}
catch ( e ) {
    try {
        browser = require( "playwright-chromium/lib/server/chromium/crBrowser" );
    }
    catch ( e ) {
        browser = require( "playwright/lib/server/chromium/crBrowser" );
    }
}
