...
try {
    browserType = require( "playwright-core/lib/client/browserType" );
}
catch ( e ) {
    try {
        browserType = require( "playwright-chromium/lib/client/browserType" );
    }
    catch ( e ) {
        browserType = require( "playwright/lib/client/browserType" );
    }
}
