...
const { QueryWhere, QueryBuilder } = require( "../dbi" );

// https://github.com/JoshuaWise/better-sqlite3/blob/master/docs/api.md

class Where extends QueryWhere {

    // in sqlite LIKE operator is case-insesitive by default (PRAGMA case_sensitive_like = true)
    _getLikeOperator () {
        return "LIKE";
    }
}
