...
module.exports = class DbhPoolSqlite extends DbhPool {
    ...
    async exec ( query, params ) {
        ...
        if ( query[1] ) query[0] = this.queryToString( query[0], query[1] );
    ...
    async do ( query, params, options ) {
        return this._do( query, params, false );
    }
    ...
    async _do ( query, params, selectRow ) {
        query = this._prepareQuery( query, params );
        ...
        try {
            ...
            const method = !sth.reader ? "run" : selectRow ? "get" : "all";
