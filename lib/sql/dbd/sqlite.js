...
module.exports = class DbhPoolSqlite extends DbhPool {
    ...
    async selectAll1 ( query, params ) {
        return this._select1( query, params, false );
    }

    async selectRow1 ( query, params ) {
        return this._select1( query, params, true );
    }
    ...
    async _select1 ( query, params, selectRow ) {
        query = this._prepareQuery( query, params );
