...
const BACKEND = {
    ...
    "COMMAND_COMPLETE": "C",
    "DATA_ROW": "D",
    "EMPTY_QUERY_RESPONSE": "I", // Identifies the message as a response to an empty query string. (This substitutes for CommandComplete.)
    "ERROR_RESPONSE": "E",
    ...
    _finishRequest ( res ) {
        ...
        if ( !res ) {
            if ( sth.error ) {
                ...
                res = result( 200, sth.data, { "rows": sth.rows } );
            }
        }
