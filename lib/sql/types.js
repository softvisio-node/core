...
export function decodeNumeric ( value, scale, safe ) {
    const numeric = Numeric( value, { scale } );

    if ( safe && !numeric.integer.isSafeInteger ) {
    ...
    DEFAULT_TYPES.push(
        {
            ...
            "decode": value => decodeNumeric( value, n, true ).number,
        },
        {
            "names": {
                [ `numeric${ n }` ]: null,
            ...
            "decode": value => decodeNumeric( value, n, false ),
        },
        {
            "names": {
                [ `number${ n }-array` ]: null,
            ...
            "decode": valhe => decodeArray( valhe, value => decodeNumeric( value, n, true ).number ),
        },
        {
            "names": {
                [ `numeric${ n }-array` ]: null,
            },

            "decode": valhe => decodeArray( valhe, value => decodeNumeric( value, n, false ) ),
        }
    );
}
