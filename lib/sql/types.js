...
export function numberToFixed ( value, fixed ) {
...
const DEFAULT_TYPES = [
    ...
    },
    {
        ...
        "decode": buffer => decodeArray( buffer, bigintToNumber ),
    },
    {
        "names": {
            "boolArray": 1000,
        ...
        // XXX sqlite
        "decodePostgresql": buffer => decodeArray( buffer, value => value === "t" ),
    },
    {
        "names": {
            "jsonArray": 199,
...
for ( let n = 1; n < 16; n++ ) {
    ...
    DEFAULT_TYPES.push( {
        ...
        "decode": valhe => value => numberToFixed( value, n ),
    } );
    ...
    DEFAULT_TYPES.push( {
        ...
        "decode": valhe => decodeArray( valhe, value => numberToFixed( value, n ) ),
    } );
}
