...
export function decodeSafeNumber ( value, precision ) {
...
const DEFAULT_TYPES = [
    ...
    },
    {
        ...
        "decode": buffer => decodeArray( buffer, decodeSafeInteger ),
    },
    {
        "names": {
            "int8Array": 1016,
...
for ( let n = 1; n < 16; n++ ) {
    ...
    DEFAULT_TYPES.push( {
        ...
        "decode": value => decodeSafeNumber( value, n ),
    } );
    ...
    DEFAULT_TYPES.push( {
        ...
        "decode": valhe => decodeArray( valhe, value => decodeSafeNumber( value, n ) ),
    } );
}
