...
export default class {
    ...
    async start () {
        ...
        if ( this.#pool.isPgsql ) {
            this.#events = new Events().link( this.#pool ).on( "_schema_cron/create", this.#addTask.bind( this ) ).on( "_schema_cron/update", this.#addTask.bind( this ) ).on( "_schema_cron/delete", this.#deleteTask.bind( this ) );
        }
