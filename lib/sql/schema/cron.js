...
const SQL = {
    "startTask": sql`UPDATE _schema_cron SET last_started = CURRENT_TIMESTAMP, next_start = ?, error = NULL WHERE id = ? AND next_start <= CURRENT_TIMESTAMP`,
