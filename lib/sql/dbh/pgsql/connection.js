...
export default class DbhPgsql extends Transactions( Dbh ) {
    ...
    async _ON_PG_AUTHENTICATION ( data ) {
        ...
        if ( type === BACKEND.AUTHENTICATION_OK ) {
            ...
            // SASLInitialResponse
            this.#socket.write( messageBuffer.beginMsg( FRONTEND.SASL_RESPONSE ).zbuf( this.#sasl.type ).ui32( response.length ).buf( response ).endMsg().done() );
        }
    ...
    #do ( resolve, query, params, options ) {
        ...
        // extended query mode
            ...
            messageBuffer
                ...
                .ui16( 0 ) // params format text
                .ui16( query.params?.length ?? 0 ); // params length
            ...
            if ( query.params ) {
                for ( let param of query.params ) {
                    ...
                    if ( param == null ) {
                        ...
                        messageBuffer.i32( Buffer.byteLength( param ) ).buf( param );
                    }
                }
            }
