...
export default Super =>
    class extends ( Super || Object ) {
        ...
        async #sync ( connect ) {
            if ( !this.#connection || ( !connect && !this.#isConnected ) ) return this._connect();
            ...
            // repeat, if has pending events
            if ( this.#pendingListen.size || this.#pendingUnlisten.size ) this.#sync();
        }
    };
