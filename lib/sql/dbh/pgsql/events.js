...
export default Super =>
    class extends ( Super || Object ) {
        ...
        _connect () {
            ...
            this.#appLockId = this.appName + "/lock:" + uuid.v4();

            this.#connection = this._newConnection( { "appName": this.#appLockId } );
        ...
        async #sync ( connect ) {
            ...
            while ( 1 ) {
                ...
                if ( connect ) {
                    ...
                    this.#abortController.signal.appLockId = this.#appLockId;
