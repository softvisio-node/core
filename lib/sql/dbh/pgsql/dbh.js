...
export default class DBHPgsql extends DBH {
    ...
    #do ( resolve, query, params, options ) {
        ...
        const useSimpleQuery = !( query[1] || sth.id || options.maxRows );
        ...
        // extended query mode
            ...
            if ( query[1] ) {
                for ( let param of query[1] ) {
                    ...
                    if ( param != null && typeof param === "object" && param[CONST.SQL_TYPE] ) param = this.#pool.encode[param[CONST.SQL_TYPE]]( param );
    ...
    #prepareQuery ( query, params, toString ) {
        ...
        if ( query instanceof SQL ) {
            query = [query.queryPgsql, params || query.params, query.id, query.types];
