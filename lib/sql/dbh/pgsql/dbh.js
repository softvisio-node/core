...
export default class DbhPgsql extends Transactions( Dbh ) {
    ...
    get isIdle () {
        return !this.#sth && !this.#queue.length;
    }
    ...
    // XXX
    _checkIdle () {
        if ( this.#isPersistent || !this.#pool.idleTimeout ) return;
        ...
        // dbh is connected
        // dbh is not locked
        // if ( !this.#queue.length && this.#isConnected && !this.isLocked ) this.#setIdleTimeout();
    }
}
