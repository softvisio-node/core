...
` );
            ...
            if ( schema.size ) {
                res = dbh.begin( dbh => {
                    for ( const version of [...schema.keys()].sort( ( a, b ) => a - b ) ) {
                        ...
                        // apply patch
                        if ( moduleVersion === undefined ) this.#applySchemaPatch( dbh, module, version, patch );

                        // apply types
                        this.#applySchemaTypes( dbh, module, version, patch );
                    }
    ...
    #applySchemaTypes ( dbh, module, version, patch ) {
