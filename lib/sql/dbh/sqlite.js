...
const DEFAULT_CACHE = "shared"; // "shared", "private"
...
export default class DBHPoolSQLite extends DBHPool {
    ...
    constructor ( url, options = {} ) {
        ...
        this.#sqlite.pragma( `temp_store = ${options.tempStore}` );
        this.#sqlite.pragma( `journal_mode = ${options.journalMode}` );
        this.#sqlite.pragma( `synchronous = ${options.synchronous}` );
        this.#sqlite.pragma( `cache_size = ${options.cacheSize}` );
    ...
    attach ( name, url, options = {} ) {
        ...
        this.#sqlite.pragma( `${name}.temp_store = ${options.tempStore}` );
        this.#sqlite.pragma( `${name}.journal_mode = ${options.journalMode}` );
        this.#sqlite.pragma( `${name}.synchronous = ${options.synchronous}` );
        this.#sqlite.pragma( `${name}.cache_size = ${options.cacheSize}` );
    }
