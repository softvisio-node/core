...
import { POSTGRESQL_DECODERS } from "#lib/sql/types";
import { READ_ONLY_SQL_TRANSACTION } from "#lib/sql/dbh/postgresql/error-codes";

// NOTE unix socket: postgresql://postgres:1@unix/var/run/postgres.sock:database
...
export default class DbhPoolPostgreSql extends mixins( Transactions, Main, Pool, Dbh ) {
    ...
    constructor ( url, options = {} ) {
        ...
        if ( url.hostname === "unix" ) {
            ...
            this.#port = +url.port || getDefaultPort( "postgresql:" );
