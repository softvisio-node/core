import { DbhPool } from "#lib/sql/dbh";
...
import Migration from "./pgsql/migration.js";
...
export default class DbhPoolPgsql extends Migration( Transactions( DbhPool ) ) {
    #url;
    ...
    #subscribe ( name ) {
        ...
        if ( this.isSchemaApplied && !this.emits.has( name ) ) throw `Event name "${name}" is not emitted by the database`;
