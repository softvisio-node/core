            ...
            // XXX
                ...
                for ( const field in arg ) {
                    ...
                    if ( Array.isArray( arg[field] ) ) {
                        ...
                        // operator is invalid
                        if ( !operator ) throw Error( `SQL condition operator "${arg[field][0]}" is invalid` );
                    ...
                    if ( operator !== "IS NULL" && operator !== "IS NOT NULL" ) {
                        ...
                        if ( operator === "IN" || operator === "NOT IN" ) condition += "(";
                        ...
                        for ( const v of value ) {
                            if ( v instanceof Sql ) {
                                ...
                                // prepare LIKE values
                                if ( operator === "ILIKE" && typeof v === "string" ) {
                                    values.push( PLACEHOLDER + " ESCAPE '\\'" );
