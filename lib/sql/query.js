                ...
                for ( const field in arg ) {
                    ...
                    // glob
                        ...
                        if ( patterns.length === 1 && !GlobPatterns.isGlobPattern( patterns[0] ) ) {
                            const pattern = path.posix.join( "/", cwd || "", patterns[0] );
                            ...
                            if ( operator.isCaseSensitive ) {
                                ...
                                params.push( quoteLikePattern( pattern ) );
                            }
                        }
                        ...
                        // patterns
                            ...
                            // allwed list has patterns
                                ...
                                if ( cwd ) {
                                    if ( operator.isCaseSensitive ) {
                                        condition += id + " LIKE " + PLACEHOLDER + " ESCAPE '\\' AND ";
                                    }
                                    else {
                                        condition += id + " ILIKE " + PLACEHOLDER + " ESCAPE '\\' AND ";
                                    }
