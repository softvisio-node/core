...
export class SqlQuery extends Sql {
    ...
    prepare () {
        ...
        if ( cachedQuery ) {
            ...
            this.#cachedQuery = new SqlQuery( this.query ).readOnly( this.readOnly ).prepare();

            this.#cachedQuery[ SET_IS_DYNAMIC ]( this.#dynamic );
        }
        else {
            this.#id = uuid();
