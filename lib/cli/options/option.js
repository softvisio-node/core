...
module.exports = class {
    ...
    constructor ( name, option ) {
        ...
        if ( this.schema.type === "boolean" && this.default === true ) {
            if ( this.short != null && this.short !== false ) this._throwSpecError( `"boolean" option with default value "true" can't have short value` );
