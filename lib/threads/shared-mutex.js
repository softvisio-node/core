...
export default class SharedMutex {
    ...
    async isLocked ( { signal } = {} ) {
        ...
        while ( true ) {
            ...
            res = await this.#api.call( "mutex/is-locked", this.#clusterMutexId );
    ...
    async tryLock ( { signal } = {} ) {
        ...
        while ( true ) {
            ...
            res = await this.#api.call( "mutex/try-lock", this.#clusterMutexId );
    ...
    async lock ( { signal } = {} ) {
        ...
        while ( true ) {
            ...
            res = await this.#api.call( "mutex/lock", this.#clusterMutexId );
