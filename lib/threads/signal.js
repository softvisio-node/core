import ProxyRegistry from "#lib/threads/proxy-registry";
import Events from "#lib/events";
import IndexedDeque from "#lib/data/indexed-deque";

class SignalsSet extends ProxyRegistry {
...
export default class Signal {
    ...
    get isDestroyable () {
        return !this.#_events?.listenerCount() && !this.isSent && !this.waitingThreads.length;
    }
