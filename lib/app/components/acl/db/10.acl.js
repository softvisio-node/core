...
CREATE TRIGGER acl_type_after_insert_or_update_or_delete AFTER INSERT OR UPDATE OR DELETE ON acl_type FOR EACH STATEMENT EXECUTE FUNCTION acl_type_after_update_trigger();

CREATE TRIGGER acl_role_after_insert_or_update_or_delete AFTER INSERT OR UPDATE OR DELETE ON acl_role FOR EACH STATEMENT EXECUTE FUNCTION acl_type_after_update_trigger();

CREATE TRIGGER acl_permission_after_insert_or_update_or_delete AFTER INSERT OR UPDATE OR DELETE ON acl_permission FOR EACH STATEMENT EXECUTE FUNCTION acl_type_after_update_trigger();
