...
CREATE FUNCTION acl_has_user ( _acl_id int53, _user_id int53 ) RETURNS boolean STABLE AS $$
BEGIN
    IF _user_id = ${ constants.rootUserId } THEN
...
CREATE FUNCTION acl_user_editable ( _acl_id int53, _acl_user_id int53, _parent_user_id int53 ) RETURNS boolean STABLE AS $$
BEGIN
