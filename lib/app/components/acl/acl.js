...
export default class Acl {
    ...
    // XXX
    async getFullAclPermissions ( userId, aclResolvers ) {

        // user is guest
        if ( !userId ) return GUESTS_PERMISSIONS;

        // user is root
        if ( this.app.userIsRoot( userId ) ) return ROOT_PERMISSIONS;
        ...
        return new Permissions( userId, permissions, { member } );
    }
