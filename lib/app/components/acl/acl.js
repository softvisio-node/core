...
import Permissions from "./acl/permissions.js";
    ...
    async getAclUserPermissions ( aclId, userId ) {
        if ( this.app.userIsRoot( userId ) ) {
            ...
            if ( aclType === false ) {
                ...
                if ( !this.#sclRootPermissions[ aclType ] ) {
                    const permissions = [];
                    ...
                    this.#sclRootPermissions[ aclType ] = new Permissions( [ permissions ] );
                }

                return this.#sclRootPermissions[ aclType ];
            }
        }
        else {
            const user = await this.getAclUser( aclId, userId );
