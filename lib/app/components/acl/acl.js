...
`,
    ...
    "setAclUserNotificationActive": sql`
INSERT INTO
...
` );
        ...
        for ( const notification of this.#types[user.aclType].notifications ) {
            ...
            for ( const channel of Object.values( notification.channels ) ) {
                notificationProfile.channels[channel.channel] = {
                    ...
                    "active": channel.editable ? userNotifications[notification.notification][channel.channel] ?? channel.default : channel.default,
                };
            }
        }
    ...
    async setAclUserNotificationActive ( aclId, userId, notification, active ) {
        const user = await this.#getAclUser( aclId, userId );
