                    ...
                    if ( type.notifications ) {
                        for ( const notification of Object.values( type.notifications ) ) {
                            ...
                            if ( !indexedNotification ) {
                                ...
                                updated = true;
                                index[type.type].notifications[notification.notification] = {
                                    "id": res.data.id,
                                    "enabled": true,
                                };
                            }
                            ...
                            // update notification
                            else if ( !indexedNotification.enabled || indexedNotification.name !== notification.name || indexedNotification.description !== notification.description ) {
                                ...
                                updated = true;
                                index[type.type].notifications[notification.notification].enabled = true;
                            }
                        }
                    }
                }
