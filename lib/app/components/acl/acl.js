        ...
        for ( const notification of this.#types[user.aclType].notifications ) {
            ...
            for ( const channel of Object.values( notification.channels ) ) {
                notificationProfile.channels[channel.channel] = {
                    ...
                    "active": channel.editable ? userNotifications[notification.notification][channel.channel] ?? channel.active : channel.active,
                };
            }
        }
                    ...
                    if ( !notification.enabled ) {
                        ...
                        for ( const channel of ["internal", "email", "telegram", "push"] ) {
                            ...
                            if ( notification.channels[channel].enabled ) {
                                ...
                                notification.channels[channel].active ??= true;
                            }
                            else {
                                notification.channels[channel].editable = false;
                                notification.channels[channel].active = false;
                            }
                        }
                    }
                }
