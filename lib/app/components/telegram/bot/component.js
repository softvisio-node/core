...
const PROTOTYPE = Super => class extends Super {};
...
export default Super =>
    class extends Super {
        ...
        get Bot () {
            return ( this.#bot ||= this._Bot( TelegramBot ) );
        }

        get User () {
            return ( this.#user ||= this._User( TelegramBotUser ) );
        }

        get Users () {
            return ( this.#users ||= this._User( TelegramBotUsers ) );
        }
