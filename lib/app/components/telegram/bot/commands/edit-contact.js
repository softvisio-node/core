    ...
    class extends Super {
        ...
        async run ( ctx, requestMessage ) {
            ...
            if ( ctx.state?.edit ) {
                ...
                // address
                else if ( ctx.state.edit === "address" ) {
                    if ( config.addressEnabled ) {
                        if ( requestMessage?.text ) {
        ...
        async API_editAddress ( ctx ) {
            ...
            await this.#setEditState( ctx, config.addressEnabled ? "address" : null );
        ...
        async _sendContacts ( ctx ) {
            ...
            if ( config.phoneEnabled ) {
                if ( contact.phone ) {
                    res = await ctx.sendMessage( {
                        "text": l10nt( locale => "<b>" + locale.l10n( `Phone` ) + ":</b> " + contact.phone ),
                        "parse_mode": "HTML",
                        "reply_markup": {
                            "inline_keyboard": [
                                [
                    ...
                    res = await ctx.sendMessage( {
                        "text": l10nt( locale => "<b>" + locale.l10n( `Phone` ) + ":</b> " + locale.l10n( `not set` ) ),
                        "parse_mode": "HTML",
                        "reply_markup": {
                            "inline_keyboard": [
                                [
            ...
            if ( config.emailEnabled ) {
                if ( contact.email ) {
                    res = await ctx.sendMessage( {
                        "text": l10nt( locale => "<b>" + locale.l10n( `Emain` ) + ":</b> " + contact.email ),
                        "parse_mode": "HTML",
                        "reply_markup": {
                            "inline_keyboard": [
                                [
                    ...
                    res = await ctx.sendMessage( {
                        "text": l10nt( locale => "<b>" + locale.l10n( `Email` ) + ":</b> " + locale.l10n( `not set` ) ),
                        "parse_mode": "HTML",
                        "reply_markup": {
                            "inline_keyboard": [
                                [
            ...
            if ( config.addressEnabled ) {
                if ( contact.address ) {
                    res = await ctx.sendMessage( {
                        "text": l10nt( locale => "<b>" + locale.l10n( `Address` ) + ":</b>\n" + contact.address ),
                        "parse_mode": "HTML",
                        "reply_markup": {
                            "inline_keyboard": [
                                [
                    ...
                    res = await ctx.sendMessage( {
                        "text": l10nt( locale => "<b>" + locale.l10n( `Address` ) + ":</b> " + locale.l10n( `not set` ) ),
                        "parse_mode": "HTML",
                        "reply_markup": {
                            "inline_keyboard": [
                                [
            ...
            if ( config.notesEnabled ) {
                if ( contact.notes ) {
                    res = await ctx.sendMessage( {
                        "text": l10nt( locale => "<b>" + locale.l10n( `Notes` ) + ":</b>\n" + contact.notes ),
                        "parse_mode": "HTML",
                        "reply_markup": {
                            "inline_keyboard": [
                                [
                    ...
                    res = await ctx.sendMessage( {
                        "text": l10nt( locale => "<b>" + locale.l10n( `Notes` ) + ":</b> " + locale.l10n( `not set` ) ),
                        "parse_mode": "HTML",
                        "reply_markup": {
                            "inline_keyboard": [
                                [
