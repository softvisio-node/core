        ...
        async _sendContacts ( ctx ) {
            ...
            if ( fields.phoneEnabled !== false ) {
                if ( contact.phone ) {
                    ...
                    res = await ctx.sendMessage( {
                        "text": l10nt( locale => "<b><u>" + locale.l10n( `Phone` ) + "</u>:</b> " + locale.l10n( `not set` ) ),
                        "parse_mode": "HTML",
                        "reply_markup": {
                            "inline_keyboard": [
                                [
            ...
            if ( fields.emailEnabled !== false ) {
                if ( contact.email ) {
                    ...
                    res = await ctx.sendMessage( {
                        "text": l10nt( locale => "<b><u>" + locale.l10n( `Email` ) + ":</u></b> " + locale.l10n( `not set` ) ),
                        "parse_mode": "HTML",
                        "reply_markup": {
                            "inline_keyboard": [
                                [
            ...
            if ( fields.addressEnabled !== false ) {
                if ( contact.address ) {
                    ...
                    res = await ctx.sendMessage( {
                        "text": l10nt( locale => "<b><u>" + locale.l10n( `Address` ) + ":</u></b> " + locale.l10n( `not set` ) ),
                        "parse_mode": "HTML",
                        "reply_markup": {
                            "inline_keyboard": [
                                [
            ...
            if ( fields.notesEnabled !== false ) {
                if ( contact.notes ) {
                    ...
                    res = await ctx.sendMessage( {
                        "text": l10nt( locale => "<b><u>" + locale.l10n( `Notes` ) + ":</u></b> " + locale.l10n( `not set` ) ),
                        "parse_mode": "HTML",
                        "reply_markup": {
                            "inline_keyboard": [
                                [
