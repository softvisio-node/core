...
export default Super =>
    class extends Super {
                ...
                "reply_markup": {
                    "inline_keyboard": [
                        [
                            {
                                "text": l10nt( `Refresh` ),
                                "callback_data": this.encodeCallbackData( "refresh" ),
                            },
                        ],
                        [
                            {
                                ...
                                "web_app": {
                                    "url": ctx.createWebAooUrl( "bot-statistics" ),
                                },
                            },
                        ],
                    ],
        ...
        async API_refresh ( ctx ) {
            return ctx.send( "https://core.telegram.org/bots/api#editmessagetext", {
                "message_id": ctx.request.message.id,
                "text": await this.#setStatsText(),
            } );
        }
        ...
        async #setStatsText () {
            ...
            return l10nt( msgid`Bot's statistics:
