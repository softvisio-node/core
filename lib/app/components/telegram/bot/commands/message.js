...
export default Super =>
    class extends Super {
        ...
        async _showAddTextPrompt ( ctx ) {
            const text = this.l10nt( `Send me a text to add to the message.
...
||text under spoiler||: <span class="tg-spoiler">text under spoiler</span>` );
        ...
        async _showAddMediaPrompt ( ctx ) {
            const text = this.l10nt( `Send me medfia files ( photos, videos, audios, documents ) to add to the message.
                ...
                const res = await media.send( ctx, {
                    ...
                    "reply_markup": {
                        "inline_keyboard": [
                            [
                                {
                                    "text": this.l10nt( `Delete media file` ),
