        ...
        async _showMessage ( ctx, message, { canEdit } = {} ) {
            ...
            if ( !message?.text ) {
                buttons.push( [
                    {
                        "text": l10nt( `Add text` ),
                        "callback_data": this.createCallbackData( "addText" ),
                    },
                ] );
            }
            else {
                buttons.push( [
                    ...
                    },
                    {
                        ...
                        "callback_data": this.createCallbackData( "deleteText" ),
                    },
                ] );
            }
            ...
            buttons.push( [
                {
                    ...
                    "callback_data": this.createCallbackData( "addMedia" ),
                },
            ] );
            ...
            if ( message?.isMedia ) {
                buttons[ 1 ].push( {
                    ...
                    "callback_data": this.createCallbackData( "editMedia" ),
                } );
            }
                ...
                "reply_markup": {
                    "inline_keyboard": [
                        [
                            {
                                "text": l10nt( `Cancel` ),
                                "callback_data": this.createCallbackData( "cancelMessage" ),
                            },
                        ],
                    ],
                },
                            ...
                            [
                                {
                                    ...
                                    "callback_data": this.createCallbackData( "deleteMedia", uuidToBuffer( media.id ) ),
                                },
                            ],
                        ],
                    },
