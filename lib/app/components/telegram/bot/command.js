...
export default class {
    ...
    createCallbackData ( method, ...args ) {
        ...
        return this.bot.telegram.createCallbackData( method, ...args );
    }
    ...
    async _registerStartCallback ( id, method ) {
        return this.bot.commands.registerStartCallback( id, this.id + "/" + method );
    }
    ...
    #translate ( ctx, template ) {
        return L10nt.toString( template, {
