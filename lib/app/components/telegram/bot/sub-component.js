...
export default Super =>
    class extends Super {
        ...
        async _configure () {
            ...
            if ( this.config.telegram.signoutEnabled ) {
                if ( this.config.telegram.signinRequired && !this.config.telegram.signupEnabled ) {
                    return result( [ 400, `signoutEnabled can not be true if signinRequired is true and signupEnabled is false` ] );
                }
            }
