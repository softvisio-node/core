import TelegramGroup from "../groupl.js";
...
export default class TelegramBotGroup extends TelegramGroup {
    #bot;
    #id;
    #fields = {};
    ...
    constructor ( bot, data ) {
        ...
        this.updateTelegramBotGrouplFields( fields );
    }
    ...
    async setTelegramBotGroupFields ( fields ) {
        ...
        const res = await this.gbh.do( sql`UPDATE telegram_bot_group`.SET( updatedFields ).sql`WHERE id = ${ this.#id }` );
