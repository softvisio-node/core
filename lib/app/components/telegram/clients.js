...
const SQL = {
    ...
    "insertClient": sql`INSERT INTO telegram_client ( phone_number, static, phone_code, password ) VALUES ( ?, ?, ?, ?, ? ) ON CONFLICT ( phone_number ) DO UPDATE SET app_hash = EXCLUDED.static RETURNING id`.prepare(),
