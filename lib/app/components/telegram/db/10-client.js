...
CREATE TRIGGER telegram_client_after_update AFTER UPDATE OF session ON telegram_client FOR EACH ROW EXECUTE FUNCTION telegram_client_after_update_trigger();
