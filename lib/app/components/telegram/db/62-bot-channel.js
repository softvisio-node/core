...
CREATE SEQUENCE telegram_bot_channel_id_seq AS int8 MAXVALUE ${ Number.MAX_SAFE_INTEGER };

CREATE TABLE telegram_bot_channel (
    id int53 PRIMARY KEY DEFAULT nextval( 'telegram_bot_channel_id_seq' ),
    ...
    UNIQUE ( telegram_bot_id, telegram_channel_id )
);

ALTER SEQUENCE telegram_bot_channel_id_seq OWNED BY telegram_bot_channel.id;
