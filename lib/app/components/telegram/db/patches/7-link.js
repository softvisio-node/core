...
CREATE TABLE telegram_bot_user_link (
    telegram_bot_user_id int8 NOT NULL REFERENCES telegram_bot_user ( id ) ON DELETE CASCADE,
    telegram_bot_link_id int8 NOT NULL REFERENCES telegram_bot_link ( id ) ON DELETE CASCADE,
...
DROP FUNCTION _telegram_bot_user_subscribe_update;

ALTER TABLE telegram_bot_link ADD COLUMN total_new_users int4 NOT NULL DEFAULT 0;
