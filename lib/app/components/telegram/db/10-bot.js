...
CREATE TRIGGER telegram_bot_after_update AFTER UPDATE OF telegram_api_key, telegram_username, telegram_first_name, telegram_can_join_groups, telegram_can_read_all_group_messages, telegram_supports_inline_queries, started,error, error_text ON telegram_bot FOR EACH ROW EXECUTE FUNCTION telegram_bot_after_update_trigger();
