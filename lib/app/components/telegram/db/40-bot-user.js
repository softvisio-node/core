...
UPDATE
    ...
    ON CONFLICT ( date, telegram_bot_id, telegram_bot_ad_campaign_id ) DO UPDATE SET
        subscribed_users = CASE WHEN _subscribed THEN subscribed_users + 1 ELSE subscribed_users END,
        unsubscribed_users = CASE WHEN _subscribed THEN unsubscribed_users ELSE unsubscribed_users + 1 END
    ;
