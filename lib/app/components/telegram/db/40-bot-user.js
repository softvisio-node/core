...
CREATE TRIGGER telegram_bot_user_after_update AFTER UPDATE OF api_user_id, subscribed, disabled ON telegram_bot_user FOR EACH ROW EXECUTE FUNCTION telegram_bot_user_after_update_trigger();
