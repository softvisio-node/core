...
CREATE TABLE telegram_bot_link (
    ...
    total_new_users int4 NOT NULL DEFAULT 0,
...
CREATE VIEW telegram_bot_view AS
SELECT
    telegram_bot.id AS telegram_bot_id,
    row_to_json( telegram_bot ),
