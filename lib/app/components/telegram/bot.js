...
export default class TelegramBot {
    ...
    constructor ( telegram, component, id, type, data ) {
        ...
        this.#telegramId = fields.telegram_user_id;
    ...
    async authenticateWebApp ( webAppInitData ) {
        try {
            ...
            const botUser = await this.users.getTelegramBotUserByTelegramId( user.id );
    ...
    async #runPrivateRequest ( req ) {
        ...
        // get user
        user = await this.#users.getTelegramBotUserByTelegramId( req.from.id );
