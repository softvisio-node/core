...
export default class TelegramBot {
    ...
    constructor ( telegram, component, id, type, data ) {
        ...
        this.#api = new TelegramBotApi( this.app.crypto.decrypt( data.telegram_bot_api_token, {
    ...
    updateTelegramBotFields ( fields ) {
        if ( "telegram_bot_api_token" in fields ) {
            this.#api.apiToken = this.app.crypto.decrypt( fields.telegram_bot_api_token, {
                "outputEncoding": "latin1",
            } );
