...
const SQL = {
    "setTelegramFields": sql`UPDATE telegram_user SET username = ?, first_name = ?, last_name = ?, language_cpde = ? WHERE id = ?`.prepare(),
...
export default class TelegramUser extends Events {
    ...
    updateUserFields ( fields ) {
        ...
        if ( "language_code" in fields ) this.#languageCode = fields.language_code;
