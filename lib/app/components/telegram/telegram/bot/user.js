...
export default class TelegramBotUser extends TelegramUser {
    ...
    async setApiUserId ( apiUserId ) {
        ...
        if ( !apiUserId ) {
            ...
            this.app.templates["telegramAccountUnlink/subject"] ??= this.app.locale.l10nt( `Telegram account removed` );

            this.app.templates["telegramAccountUnlink/body"] ??= this.app.locale.l10nt( `Your Telegram account removed from your user profile.` );
            ...
            await this.app.notifications.sendNotification(
                ...
                "security",
                oldApiUserId,
                this.app.templates["telegramAccountUnlink/subject"],
                this.app.templates["telegramAccountUnlink/body"]
            );
        }
        ...
        // link
            ...
            this.app.templates["telegramAccountLink/subject"] ??= this.app.locale.l10nt( `Telegram account linked` );

            this.app.templates["telegramAccountLink/body"] ??= this.app.locale.l10nt( `Your Telegram account linked to your user profile.` );
            ...
            await this.app.notifications.sendNotification(
                ...
                "security",
                apiUserId,
                this.app.templates["telegramAccountLink/subject"],
                this.app.templates["telegramAccountLink/body"]
            );
        }
