...
export default class TelegramBotUser extends TelegramUser {
    ...
    async getPermissions () {
        ...
        if ( this.app.userIsRoot( this.id ) ) {
            return this.app.acl.getAclUserPermissions( this.bot.aclId, this.id );
        }

        res = await this.app.acl.getAclUserPermissions( this.bot.aclId, this.id );

        res = await this.app.acl.getAclUserPermissions( constants.mainAclId, this.id );
