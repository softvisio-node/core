...
export default class TelegramBotUser extends TelegramUser {
    ...
    async setApiUserId ( apiUserId ) {
        ...
        if ( !apiUserId ) {
            ...
            await this.app.notifications.sendNotification(
                ...
                "security",
                oldApiUserId,
                this.app.locale.l10nt( `Telegram account removed` ),
        ...
        // link
            ...
            this.app.publishToApi( "/notifications/telegram/update/", apiUserId, this.username );
    ...
    get avatarUrl () {
        this.#avatarUrl ??= this.app.telegram.config.avatarUrl + this.bot.id + "/" + this.id;
