        ...
        const res = await dbh.begin( async dbh => {
            ...
            if ( !apiUserId ) {
                ...
                await this.app.notifications.sendNotification(
                    ...
                    this.app.templates.get( "telegram/unlink-account/body" )
                );
            }
            ...
            // link
                ...
                // XXX
                const oldUser = await this.bot.users.getByApiUserId( this.apiUserId, { dbh } );
                ...
                if ( this.bot.locales.has( apiUser.locale ) ) {
                    await this.setLocale( apiUser.locale );
                }
                ...
                await this.app.notifications.sendNotification(
                    ...
                    this.app.templates.get( "telegram/link-account/body" )
                );
            }
