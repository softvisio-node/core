...
export default class TelegramBotUser extends TelegramUser {
    ...
    async updateAvatar () {
        ...
        try {
            ...
            if ( !photo ) {
                res = await this.dbh.selectRow( sql`UPDATE telegram_bot_user SET avatar_updated = CURRENT_TIMESTAMP WHERE id = ?`, [this.botUserId] );
            ...
            res = await this.dbh.selectRow( sql`
