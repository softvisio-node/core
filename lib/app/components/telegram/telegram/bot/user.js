    ...
    async setApiUserId ( apiUserId ) {
        ...
        if ( !apiUserId ) {
            ...
            this.app.notifications.sendNotification(
                ...
                "security",
                oldApiUserId,
                this.app.telegram.locale.i18nt( `Telegram account removed` ),
                this.app.telegram.locale.i18nt( `Your Telegram account removed from your user profile.` )
            );
        }
        ...
        // link
            ...
            this.app.notifications.sendNotification(
                ...
                "security",
                apiUserId,
                this.app.telegram.locale.i18nt( `Telegram account linked` ),
                this.app.telegram.locale.i18nt( `Your Telegram account linked to your user profile.` )
            );
        }
