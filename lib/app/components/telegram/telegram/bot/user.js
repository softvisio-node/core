...
import TelegramBotContext from "./context.js";
...
export default class TelegramBotUser extends TelegramUser {
    ...
    async runModule ( module, ctx ) {
        ...
        // clone ctx
        ctx = new TelegramBotContext( this.#bot, ctx.abortSignal, { "user": this } );

        return this.#bot.tunModule( module, ctx );
    }
