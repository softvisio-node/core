    ...
    async send ( method, data ) {
        ...
        if ( mediaMethods.has( method ) ) {
            ...
            for ( let item of data.media ) {
                ...
                if ( media.caption ) media.caption = LocaleTranslation.toString( media.caption, { "localeDomain": this.locale } );

                if ( media.title ) media.title = LocaleTranslation.toString( media.title, { "localeDomain": this.locale } );
            }
