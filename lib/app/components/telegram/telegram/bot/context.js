export default class TelegramBotContext {
    ...
    constructor ( bot, user, permissions, req, { module, newUser } = {} ) {
        this.#bot = bot;
        this.#req = req;
        this.#user = user;
    ...
    async runCallback ( callbackData ) {
        ...
        const module = this.#bot.modules.get( method.substring( 0, idx ) );
    ...
    #clone ( module ) {
        ...
        return new TelegramBotContext( this.#bot, this.#user, this.#permissions, this.#req, {
