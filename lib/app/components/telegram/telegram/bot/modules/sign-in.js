...
export default Super =>
    class extends Super {
        ...
        async _waitForToken ( ctx ) {
            return this.#waitConfirmation( ctx, this.l10n( `Please, click on link from emaul, which I sent to complete sign in process.` ) );
        }
        ...
        async #waitConfirmation ( ctx, message ) {
            ...
            return ctx.user.sendMessage( {
                "text": this.l10nt( locale =>
                    this.l10n( msgid`${Translation.toString( message, { locale } )}
