...
export default class {
    ...
    async sendCommandsList ( ctx, commands ) {
        ...
        //             const command = this.bot.commands.get( command );

        //             if ( !command?.isCommand ) {
        //                 console.warn( `Telegram command is not valid: ${ command }` );
        //             }
        //             else if ( command.checkPermissions( ctx ) ) {
        //                 data.data.push( {
        //                     "command": command.command,
        //                     "description": command.getTitle( ctx ),
        //                 } );
        //             }
        //         }
        //     }
            ...
            // no commands
                ...
                for ( const group of commands ) {
                    ...
                    for ( const command of groupCommands ) {
                        ...
                        if ( !commandInstance?.isCommand ) {
                            console.warn( `Telegram command is not valid: ${ command }` );
                        }
                        else if ( commandInstance.checkPermissions( ctx ) ) {
                            data.data.push( {
