        ...
        if ( this.#commandsList[ id ] === undefined ) {
            ...
            // level 2
                ...
                for ( const commandInstance of this.childCommands ) {
                    ...
                    // group title
                    const groupDescription = this.getGroupDescription( ctx );

                    if ( groupDescription ) {
                        commands.push( "<b>" + this.#translate( groupDescription ) + "</b>" );
                    }
            ...
            if ( commands.length ) {
                commands.unshift( this.#translate( ctx, this.l10nt( `You can control me by sending these commands::\n` ) ) );
            }
