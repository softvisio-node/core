...
export default Super =>
    class extends Super {
        ...
        // XXX
        async API_moveMediaLeft ( ctx, id ) {
        ...
        // XXX
        async API_moveMediaRight ( ctx, id ) {
            if ( ctx.state.mode !== "editMedia" ) return;
        ...
        async API_deleteMedia ( ctx, id ) {
            ...
            if ( !message.isMedia ) return this._cancel( ctx );
        }
            ...
            return ctx.send( "sendMessage", {
                ...
                "reply_markup": {
                    "inline_keyboard": [
                        [
                            {
                                "text": this.createBackButtonText( this.l10nt( `Cancel` ) ),
        ...
        async _showAddMediaPrompt ( ctx ) {
            return ctx.send( "sendMessage", {
                "text": this.l10nt( `Send me a photo or video. You can add up to 10 medua fikes,` ),
                "reply_markup": {
                    "inline_keyboard": [
                        [
                            {
                            ...
                            [
                                {
                                    ...
                                    "callback_data": this.encodeCallbackData( "moveMediaLeft", uuidToBuffer( media.id ) ),
                                },
                                {
                                    "text": this.l10nt( `↓ Move down` ),
                                    "callback_data": this.encodeCallbackData( "moveMediaRight", uuidToBuffer( media.id ) ),
                                },
                                {
