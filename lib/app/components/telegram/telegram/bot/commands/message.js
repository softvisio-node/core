                            ...
                            [
                                {
                                    ...
                                    "callback_data": this.encodeCallbackData( "moveMediaLeft", media.id ),
                                },
                                {
                                    "text": this.l10nt( `↓ Move down` ),
                                    "callback_data": this.encodeCallbackData( "moveMediaRight", media.id ),
                                },
                                {
                                    "text": this.l10nt( `x Delete` ),
                                    "callback_data": this.encodeCallbackData( "deleteMedia", media.id ),
                                },
                            ],
                        ],
                    },
