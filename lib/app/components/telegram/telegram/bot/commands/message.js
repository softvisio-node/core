...
export default Super =>
    class extends Super {
        ...
        // XXX
        async API_moveMediaLeft ( ctx, index ) {
        ...
        // XXX
        async API_moveMediaRight ( ctx, index ) {
            if ( ctx.state.mode !== "editMedia" ) return;
                            ...
                            [
                                {
                                    ...
                                    "callback_data": this.encodeCallbackData( "moveMediaLeft", index ),
                                },
                                {
                                    "text": this.l10nt( `↓ Move down` ),
                                    "callback_data": this.encodeCallbackData( "moveMediaRight", index ),
                                },
                                {
