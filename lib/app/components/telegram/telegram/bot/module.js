...
export default class {
    ...
    // protected
    async _setMenuButton ( ctx, menuButton ) {
        this.#menuButtonHash = null;

        return this.#setMenuButton( ctx, menuButton );
    }

    async _setCommands ( ctx, commands ) {
        this.#commandsHash = null;

        return this.#setCommands( ctx, commands );
    }
