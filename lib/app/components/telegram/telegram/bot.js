...
export default class TelegramBot {
    ...
    updateTelegramBotFields ( fields ) {
        ...
        if ( "telegram_username" in fields ) this.#username = fields.telegram_username;
    ...
    async #updateTelegramData ( apiToken ) {
        ...
        if ( this.#username !== res.data.username ) fields.set( "telegram_username", res.data.username );
