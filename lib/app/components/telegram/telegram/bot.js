...
export default class TelegramBot {
    ...
    async _userBlocked ( user ) {}

    async _userUbblocked ( user ) {}
    ...
    async #privateChatUpdate ( update, signal ) {
        ...
        // messagge
            ...
            // contact
                ...
                await update.user.updateContact( update.data.contact );
            }
        }
        ...
        // callbacl query
            ...
            try {
                await this.#modules[module][method]( ctx, ...args );
            }
            catch ( e ) {
