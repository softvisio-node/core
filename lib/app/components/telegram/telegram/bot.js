...
UPDATE telegram_bot_update USING cte WHERE id = cte.id RETURNING *
...
export default class TelegramBot {
    ...
    async #startProcessor () {
        ...
        START: while ( true ) {
            ...
            // lock mutex
            await this.#processorMutex.lock( { "signal": stopSignal } );
            ...
            const mutexSignal = this.#processorMutex.unlockSignal;
