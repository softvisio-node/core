...
UPDATE telegram_bot_update SET locked = TRUE USING cte WHERE id = cte.id RETURNING id, type, data
...
export default class TelegramBot {
    ...
    async #startUpdater () {
        ...
        START: while ( true ) {
            ...
            signal.addSignals( this.#upderMutex.unlockSignal );
        ...
        START: while ( true ) {
            ...
            while ( true ) {
                ...
                for ( let update of updates.data ) {
                    ...
                    if ( !res.ok ) continue START; // XXX what to do
                }
            }
        }
