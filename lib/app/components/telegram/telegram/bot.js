...
export default class TelegramBot {
    ...
    // XXX session
    async authenticateWebApp ( webAppInitialData ) {
        ...
        const botUser = await this.users.getTelegramBotUserByTelegramUserId( webAppInitialData.get( "user_id" ) );

        if ( !botUser?.apiUserId ) return;

        return this.app.users.getUserById( botUser.apiUserId );
    }
