...
export default class TelegramBot {
    ...
    async unlinkUser ( userId ) {
        return this.dbh.do( SQL.unlinkUser, [this.id, userId] );
    }
    ...
    async #onTelegramUpdate ( update ) {
        ...
        if ( update.type === "message" ) {
            if ( update.data.text.startsWith( "/start link-user-" ) ) {
                ...
                const res = await this.app.api.userActionTokens.activateUserActionToken( token, constants.tokenTypeLinkTelegramAccount );
