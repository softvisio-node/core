...
export default class TelegramBot {
    ...
    async getFile ( fileId, { fileUniwueId, contentType } = {} ) {
        ...
        if ( fileUniwueId ) {
            storagePath = `${this.telegram.config.storageFilePath}/${fileUniwueId}`;
    ...
    async downloadFile ( req, fileId ) {
        ...
        const storagePath = `${this.telegram.config.storageFilePath}/${res.data.file_unique_id}`;
        ...
        if ( await this.app.storage.isFileExists( storagePath ) ) {
            return this.app.storage.downloadFile( req, {
                ...
                "cacheControl": this.telegram.config.telegramFileCacheControl,
            } );
        }
