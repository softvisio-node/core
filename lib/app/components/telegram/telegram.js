...
export default class Telegram {
    ...
    // XXX control length
    encodeTelegramCallback ( method, ...args ) {
        return msgpack.encode( [method, args], "base64url" );
    }

    decodeTelegramCallback ( string ) {
        try {
            return msgpack.decode( string, { "encoding": "base64url" } );
        }
        catch ( e ) {
            return [null, []];
        }
