...
export default class Telegram {
    ...
    async init () {
        ...
        this.app.publicHttpServer.get( "/api/telegram/bots/users/avatar/*", this.#getBotUserAvatar.bind( this ) );
    ...
    async #getBotUserAvatar ( req ) {
        const telegramBotUserId = path.basename( req.path ),
            telegramBotId = path.basename( path.dirname( req.path ) );

        const bot = this.getBot( telegramBotId );
        ...
        return user.downloadAvatar( req );
    }
}
