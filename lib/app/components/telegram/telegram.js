...
export default class Telegram {
    ...
    async #loadBot ( id, type ) {
        ...
        const data = await botComponent.loadBot( id );

        const bot = new botComponent.Bot( this, botComponent, id, type, data );
    ...
    async #downloadAvatar ( req ) {
        const [ botId, telegramBotUserId ] = req.path.substring( this.config.avatarUrl.length ).split( "/" );
