...
export default class Telegram {
    ...
    async init () {
        ...
        this.app.publicHttpServer?.get( this.config.avatarLocation + "/*", this.#downloadAvatar.bind( this ) );
    ...
    async #downloadAvatar ( req ) {
        const path = req.path.substring( this.config.avatarLocation.length + 1 );
