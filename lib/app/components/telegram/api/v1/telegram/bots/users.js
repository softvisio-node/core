...
SELECT
    ...
    CASE
        WHEN telegram_bot_user.api_user_id IS NOT NULL THEN 'https://s.gravatar.com/avatar/' || "user".gravatar || ${"?d=" + this.app.users.defaultGravatarParam}
        ELSE ${this.app.users.defaultAvatarUrl}
