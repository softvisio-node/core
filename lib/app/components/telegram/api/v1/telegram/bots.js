...
`.WHERE( where );
        ...
        async [ "API_get-registered-components" ] ( ctx ) {
            return result(
                200,
        ...
        async [ "API_check-bot-api-token" ] ( ctx, apiToken ) {
        ...
        async [ "API_create-bot" ] ( ctx, apiToken, type ) {
        ...
        async [ "API_get-bot-stats" ] ( ctx, botId, period ) {
        ...
        async [ "API_set-bot-started" ] ( ctx, botId, started ) {
        ...
        async [ "API_set-bot-api-token" ] ( ctx, botId, botApiToken ) {
            const bot = this.app.telegram.bots.getBotById( botId );
        ...
        async [ "API_update-bot-details" ] ( ctx, botId, options ) {
            const bot = this.app.telegram.bots.getBotById( botId );
        ...
        async [ "API_delete-bot" ] ( ctx, botId ) {
