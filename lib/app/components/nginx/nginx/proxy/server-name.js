        ...
        if ( this.app.nginxUpstream ) {
            ...
            if ( res.ok ) {
                ...
                if ( this.#certificateFingerprint !== res.data.fingerprint ) {
                    ...
                    ( this.#certificatePath = new TmpFile() ), ( this.#privateKeyPath = new TmpFile() ), await fs.promises.writeFile( this.#certificatePath.path, res.data.certificate );
                    await fs.promises.writeFile( this.#certificatePath.path, res.data.privateKey );
                }
            }
        }
        else if ( this.app.acme ) {
