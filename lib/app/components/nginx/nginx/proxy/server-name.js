...
export default class NginxProxyServerName {
    ...
    // properties
    get app () {
        return this.#serverNames.proxy.nginx.app;
    }

    get proxy () {
        return this.#serverNames.proxy;
    }

    get nginx () {
        return this.#serverNames.proxy.nginx;
    }
    ...
    delete () {
        ...
        this.#serverNames.proxy.deleteServerName( this.#name );
