...
export default class NginxProxyServer extends DefaultServer {
    ...
    constructor ( proxy, { port, type, proxyProtocol, sslEnabled, serverName, maxBodySize, cacheEnabled, cacheBypass, httpsRedirectPort, hstsMaxAge } = {} ) {
        ...
        if ( this.isHttp ) {
            ...
            if ( this.ssl ) {
                if ( hstsMaxAge ) this.#hstsMaxAge = new Interval( hstsMaxAge ).toSeconds();
            }
            else {
