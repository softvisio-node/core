...
export default class {
    ...
    async getCertificate ( domains ) {
        ...
        CERTIFICATE: {
            ...
            res = await this.#getStoredCertificate( domains, {
    ...
    // XXX
    async #getStoredCertificate ( domains, { checkRenewInterval } = {} ) {
    ...
    // XXX
    async #uploadCertificate ( { domains, certificate, privateKey, expires } ) {
