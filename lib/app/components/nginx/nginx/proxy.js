...
import NginxProxyServerName from "./proxy/server-name.js";
...
export default class NginxProxy {
    ...
    constructor ( nginx, name, upstreamPort, { upstreamProxyProtocol, serverNames, servers, upstreams } = {} ) {
        ...
        // add server names
        this.#addServerNames( serverNames );
    ...
    addServerNames ( serverNames ) {
        const updated = this.#addServerNames( serverNames );
    ...
    deleteServerNames ( serverNames ) {
        const updated = this.#deleteServerNames( serverNames );
