...
const configTemplate = fs.readFileSync( new URL( "../resources/templates/server.http.nginx.conf", import.meta.url ), "utf8" );
...
export default class NginxServer {
    ...
    constructor ( nginx, id, { serverNames, upstreamHttpPort, streamPorts, clientMaxBodySize, cacheEnabled, cacheStatus, cacheBypass, upstreams } = {} ) {
        ...
        this.#configPath = this.#nginx.configsDir + "/" + this.id + ".http.nginx.conf";
    }
