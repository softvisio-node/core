...
export default class NginxServer {
    ...
    async reload () {
        ...
        console.log( "--- RELOAD 1", this.id );

        // lock nginx update
        await mutex.lock();

        console.log( "--- RELOAD 2", this.id );
        ...
        while ( true ) {
            ...
            try {
                ...
                console.log( "--- RELOAD updst", this.id, this.#upstreams );
                ...
                if ( !this.#upstreams.size ) {
                    ...
                    console.log( "--- RELOAD 1", this.id, "write cnfig", updated );

                    // config updated
                    if ( updated ) {
                        console.log( "--- RELOAD test", this.id );

                        // test
                        res = await this.#nginx.test();

                        console.log( "--- RELOAD test tes", this.id, res + "" );
            ...
            console.log( "--- RELOAD done", this.id );
