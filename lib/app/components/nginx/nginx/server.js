...
const sslRenewInterval = new Duration( "1 day" );
...
export default class NginxServer {
    ...
    async updateNginxConfigs () {
        ...
        // configs was updated
            ...
            // config is valid
            if ( !res.ok ) {
                console.log( `Nginx config ${this.#id} failed: ${res}` );
    ...
    async #updateSsl () {
        ...
        try {
            ...
            if ( this.#sslNames === sslNames && this.#sslCertificate && this.#sslCertificateKey ) {
            ...
            if ( !res.ok ) {
                console.log( `Nginx get certificates for ${this.#id}] failed: ${res}` );
            ...
            this.#sslRenewTimeout = setTimeout( this.#renewSsl.bind( this ), sslRenewInterval.toMilliseconds() );
        ...
        if ( !this.#sslEnabled ) this.#clearSsl();
    }
    ...
    #clearSsl () {
        clearTimeout( this.#sslRenewTimeout );
        this.#sslRenewTimeout = null;
