...
export default class NginxServer {
    ...
    constructor ( nginx, id, { type, port, serverName, defaultUpstreamPort, upstreams, maxBodySize, cacheEnabled, cacheBypass, sslEnabked = true } = {} ) {
        this.#nginx = nginx;
        this.#id = id;
        this.#type = type;
        ...
        if ( !this.#serverName.length ) this.#sslEnabked = false;
