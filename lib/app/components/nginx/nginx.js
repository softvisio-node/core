...
export default class Nginx {
    ...
    async start () {
        ...
        const conf = ejs.render( fs.readFileSync( new URL( "resources/nginx.conf", import.meta.url ), "utf8" ), {
            ...
            "cacheMaxSize": Duration.new( this.config.cacheMaxSize ).toNginx(),
            "cacheMinFree": Duration.new( this.config.cacheMinFree ).toNginx(),
            "cacheInactive": new Duration( this.config.cacheInactive ).toNginx(),
        } );
