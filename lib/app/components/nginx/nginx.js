...
export default class Nginx {
    ...
    async start () {
        ...
        if ( this.app.privateHttpServer ) {
            ...
            const server = this.addServer( "_private-http-server", {
                ...component.config.nginx,
                "type": "http",
                "port": component.config.port,
                "upstreamDefaultPort": this.app.privateHttpServer.port,
            } );
        ...
        if ( this.app.publicHttpServer ) {
            ...
            const server = this.addServer( "_public-http-server", {
                ...component.config.nginx,
                "type": "http",
                "port": component.config.port,
                "upstreamDefaultPort": this.app.publicHttpServer.port,
            } );
    ...
    addServer ( id, { type, port, serverName, upstreamDefaultPort, maxBodySize, cacheEnabled, cacheBypass, sslEnabled } = {} ) {
