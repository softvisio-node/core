        ...
        while ( true ) {
            ...
            for ( const proxy of this.proxies.values() ) {
                ...
                for ( const server of proxy.servers.values() ) {
                    ...
                    // register port
                    ports[server.port] ||= {};
                    ports[server.port].port = server.port;
                    ports[server.port].servers ||= [];
                    ports[server.port].servers.push( server );
            ...
            // XXX
            // proxy.updateConfig ( { hasHttpServers, hasStreamServers } = {} ) {
