...
export default class Nginx {
    ...
    async init () {
        ...
        const certificate = await certificates.createCertificate( this.app.crypto.privateKey );

        this.#defaultCertificate = {
            "certificate": new this.app.env.TmpFile(),
            "privateKey": this.app.crypto.privateKeyPath,
        };
    ...
    getSocketPath ( name, port, ssl ) {
        ...
        // XXX https://trac.nginx.org/nginx/ticket/2593#ticket
