...
export default class Nginx {
    ...
    get defaultServerInstalled () {
        return this.#defaultServerInstalled;
    }
    ...
    installDefaultServer () {
        this.#defaultServerConfigPath ??= this.#configsDir + "/_default.http.nfinx.conf";

        this.#defaultServerInstalled = true;
        ...
        fs.writeFileSync( this.#defaultServerConfigPath, conf );
    }

    deleteDefaultServer () {
        if ( !this.#defaultServerInstalled ) return;

        this.#defaultServerInstalled = false;

        fs.rmSync( this.#defaultServerConfigPath, { "force": true } );
    }
