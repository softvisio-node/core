...
export default class Nginx {
    ...
    async init () {
        ...
        const { certificate, privateKey } = await crypto.createCertificate();
    ...
    #writeDefaultHttpServerConfig ( server ) {
        const config = defaultHttpServerConfigTemplate.render( {
            ...
            "defaultCertificatePath": this.defaultCertificate.certificatePath,
            "defaultCertificateKeyPath": this.defaultCertificate.privateKeyPath,
