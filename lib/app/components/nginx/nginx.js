...
export default class Nginx {
    ...
    constructor ( app, config ) {
        ...
        this.#sslServerUpstreamsConfigPath = this.configsDir + "/ssl-server-upstreams.nginx.conf";
    ...
    get sslServerUpstreamsConfigPath () {
        return this.#sslServerUpstreamsConfigPath;
    }
    ...
    async reload () {
        ...
        while ( true ) {
            ...
            fs.mkdirSync( path.dirname( this.#sslServerUpstreamsConfigPath ), { "recursive": true } );
            fs.writeFileSync( this.#sslServerUpstreamsConfigPath, "" );
