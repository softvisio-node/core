...
export default class Nginx {
    ...
    async init () {
        ...
        this.#defaultCertificate = {
            "certificate": new this.app.env.TmpFile( { "tmpDir": this.#configsDir } ),
            "privateKey": new this.app.env.TmpFile( { "tmpDir": this.#configsDir } ),
        };

        fs.writeFileSync( this.#defaultCertificate.certificate + "", certificate.certificate );

        fs.writeFileSync( this.#defaultCertificate.privateKey + "", certificate.privateKey );
