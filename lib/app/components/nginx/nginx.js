...
export default class Nginx {
    ...
    async #updateConfig () {
        ...
        this.#writeDefaultHttpServersConfig( config.getDefaultHttpServers() );
    ...
    #writeDefaultHttpServersConfig ( defaultHttpServers ) {
        for ( const server of defaultHttpServers ) {
            ...
            let name = `_default-http-${server.port}`;
    ...
    #writeRouterConfig ( { port, proxyProtocol, serverName, defaultSocket, defaultSslSocket } = {} ) {
