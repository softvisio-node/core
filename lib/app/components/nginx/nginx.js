...
export default class Nginx {
    ...
    #writeSetRealIpFromConfig () {
        ...
        if ( this.condig.httpSetRealIpFrom ) {
            http.push( "", "# custom", ...this.condig.httpSetRealIpFrom );
        }
        ...
        if ( this.condig.streamSetRealIpFrom ) {
            stream.push( "", "# custom", ...this.condig.streamSetRealIpFrom );
        }
