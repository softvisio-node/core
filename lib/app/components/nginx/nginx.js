...
export default class Nginx {
    ...
    async #updateConfig () {
        ...
        this.#writeNginxConfig( {
            "defaultHttpServers": config.getDefaultHttpServers(),
            "useRouter80": config.useRouter( 80 ),
            "useRouter443": config.useRouter( 443 ),
        } );
    ...
    // XXX
    #writeNginxConfig ( { defaultHttpServers, useRouter80, useRouter443 } = {} ) {
