...
export default class Nginx {
    ...
    async start () {
        ...
        if ( this.app.privateHttpServer ) {
            ...
            const server = this.addServer( `_private-http-server_http_${component.config.port}`, {
        ...
        if ( this.app.publicHttpServer ) {
            ...
            const server = this.addServer( `_public-http-server_http_${component.config.port}`, {
                ...component.config.nginx,
                "type": "http",
                "port": component.config.port,
    ...
    addServer ( id, { type, port, serverName, upstreamPort, upstreamProxyProtocol, maxBodySize, cacheEnabled, cacheBypass, sslEnabled } = {} ) {
