...
export default class Nginx {
    ...
    async init () {
        ...
        await fs.promises.writeFile( this.#defaultCertificate.certificatePath.path, certificate );

        await fs.promises.writeFile( this.#defaultCertificate.privateKeyPath.path, privateKey );
    ...
    async start () {
        ...
        if ( this.app.privateHttpServer ) {
            ...
            this.proxies.add( "private-http-server", component.config.port, {
                "serverNames": component.config.nginx.serverNames,
                "servers": [
                    {
                        ...component.config.nginx.server,
        ...
        if ( this.app.publicHttpServer ) {
            ...
            this.proxies.add( "public-http-server", component.config.port, {
                "serverNames": component.config.nginx.serverNames,
                "servers": [
                    {
                        ...component.config.nginx.server,
