...
export default class Nginx {
    ...
    get unixSocketsDir () {
        if ( !this.#unixSocketsDir ) {
            this.#unixSocketsDir = "/var/run/nginx." + this.app.env.instanceId;
    ...
    async reload () {
        ...
        while ( true ) {
            ...
            for ( const upstream of this.#proxies.values() ) {
    ...
    addProxy ( name, port, options ) {
        ...
        proxy = new NginxProxy( this, name, port, options );
