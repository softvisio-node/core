...
export default class Nginx {
    ...
    #writeSetRealIpFromConfig () {
        ...
        fs.writeFileSync( this.#httpSetRealIpFromPath, this.#buildSetRealIpFrom( this.#config.httpSetRealIpFrom ) );

        fs.writeFileSync( this.#streamSetRealIpFromPath, this.#buildSetRealIpFrom( this.#config.streamSetRealIpFrom ) );
    }

    #buildSetRealIpFrom ( subnets ) {
        ...
        if ( subnets ) {
            for ( const subnet of subnets ) {
                const range = subnets.get( subnet );

                if ( range ) {
                    ranges[ subnet ] = range.toJSON();
