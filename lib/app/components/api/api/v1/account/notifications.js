...
export default Super =>
    class extends Super {
        async API_getUserNotificationsProfile ( ctx ) {
            ...
            const profile = {
                "internalNotificationsEnabled": notifications.internalNotificationsEnabled,
                "emailNotificationsEnabled": notifications.emailNotificationsEnabled,
                "telegramNotificationsEnabled": notifications.telegramNotificationsEnabled,
                "pushNotificationsEnabled": notifications.pushNotificationsEnabled,
                "telegramSupported": notifications.telegramSupported,
            };

            if ( notifications.telegramSupported ) {
