        ...
        async #getAppSettings () {
            if ( !this.#settings ) {
                this.#settings = {
                    ...
                    "internal_notifications_channel_enabled": this.api.notifications.internalChannelEnabled,
                    "push_notifications_enabled": this.api.notifications.pushNotificationsEnabled,
