...
` ) );
            ...
            return this.app.notifications.sendEmail(
                email,
                this.app.templates["confirm-email/subject"].toString( {
                    "domain": userLocale,
                } ),
                this.app.templates["confirm-email/body"].toString( {
                    "domain": userLocale,
                    "data": {
...
` ) );
            ...
            return this.app.notifications.sendEmail(
                email,
                this.app.templates["password-recovery-email/subject"].toString( {
                    "domain": userLocale,
                } ),
                this.app.templates["password-recovery-email/body"].toString( {
                    "domain": userLocale,
                    "data": {
