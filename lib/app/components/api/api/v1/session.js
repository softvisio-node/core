...
export default Super =>
    class extends Super {
        ...
        async API_signIn ( ctx, { email, password, "oauth_provider": oauthProvider, "oauth_code": oauthCode, "oauth_redirect_uri": oauthRedirectUri, "telegram_bot_id": telegramBotId, "telegram_webapp_init_data": telegramWebAppInitData } ) {
            var user;
            ...
            if ( oauthProvider ) {
                ...
                if ( bot ) {
                    user = await bot.authenticateWebApp( telegramWebAppInitData );
                }
            }
            else {
