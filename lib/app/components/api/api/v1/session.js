        ...
        async #getAppSettings () {
            if ( !this.#settings ) {
                this.#settings = {
                    ...
                    "internal_notifications_enabled": this.app.notifications.isChannelEnabled( "internal" ),
                    "push_notifications_supported": this.app.notifications.isChannelSupported( "push" ),
