    ...
    class extends Super {
        ...
        async API_setPasswordByToken ( ctx, token, password ) {
            return this.dbh.begin( async dbh => {
                ...
                this.#sendPasswordChangedEmail( userId );
...
` ) );
        ...
        async #sendNewSigninNotification ( userId, { userAgent, remoteAddress } ) {
            ...
            this.app.templates["NewSigninNotification/body"] ??= this.app.locale.l10nt( ( locale, data ) =>
...
` ) );
            ...
            return this.app.notifications.sendNotification(
                "security",
                userId,
                this.app.templates["NewSigninNotification/subject"],
                this.app.templates["NewSigninNotification/body"].createTemplate( {
                    remoteAddress,
                    userAgent,
                } )
            );
