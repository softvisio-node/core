...
export default Super =>
    class extends Super {
        ...
        async _sendConfirmationEmail ( email, token, locale ) {
            ...
            const subject = this.app.locale.l10nt( "Confirm your email address" );

            const body = this.app.locale.l10nt( msgid`Use the following link to confirm your email on ${this.api.config.frontendUrl}:
