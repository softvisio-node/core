        ...
        async #getAppSettings () {
            if ( !this.#settings ) {
                this.#settings = {
                    ...
                    "locales": this.app.locales.config.locales,
                    "default_locale": this.app.locales.config.defaultLocale,
                    ...
                    "internal_notifications_enabled": this.app.notifications.internalNotificationsEnabled,
                    "push_notifications_supported": this.app.notifications.pushNotificationsSupported,
