...
export default Super =>
    class extends Super {
        ...
        async API_checkAuthorization ( ctx, { locale } = {} ) {
            var permissions;
            ...
            return result( 200, {
                ...
                "locale": this.app.locales.getClientLocale( locale ),
            } );
        }
...
`;
        ...
        async _sendNewSigninNotification ( userId, { userAgent, remoteAddress } ) {
            const locale = this.app.locales.getComponentLocale( "api" );

            return this.app.notifications.sendNotification(
                "security",
                userId,
                locale.i18nt( locale => locale.i18n( "New device" ) ),
                locale.i18nt( locale =>
                    locale.i18n( msgid`You just signed in on the new device.
