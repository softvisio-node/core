...
`;
        ...
        async API_create ( ctx, email, fields, roles ) {
            return this.api.users.createUser( email, fields, { roles, "parentUserId": ctx.user.id } );
        }
        ...
        async API_delete ( ctx, userId ) {
            ...
            return this.api.users.deleteUser( userId );
        }
        ...
        async API_setEnabled ( ctx, userId, enabled ) {
            ...
            return this.api.users.setUserEnabled( userId, enabled );
        }
        ...
        async API_setPassword ( ctx, userId, password ) {
            ...
            return this.api.users.setUserPassword( userId, password );
        }

        async API_getSessions ( ctx, userId ) {
            return this.api.sessions.getUserSessions( userId, { "currentSessionId": ctx.token.id } );
        }
        ...
        async API_signOutSession ( ctx, userId, sessionId ) {
            ...
            return await this.api.sessions.deleteUserSession( sessionId, { userId } );
        }
        ...
        async API_signOutAllSessions ( ctx, userId ) {
            ...
            return this.api.sessions.deleteUserSessions( userId, { "excludeSessionId": ctx.token.id } );
        }
    };
