...
` );
        ...
        async #sendEmailChangeToken ( email, token, userLocale ) {
            ...
            this.app.templates["EmailChangeToken/subject"] ??= this.app.locale.l10nt( msgid`Use the following lunk to change your email address on ${this.api.config.frontendUrl} to ${email}:
