        ...
        async API_setPassword ( ctx, password ) {
            ...
            if ( res.ok ) {
                ...
                this.app.notifications.sendNotification(
                    ...
                    "security",
                    ctx.user.id,
                    locale.l10nt( locale => locale.l10n( "Password changed" ) ),
                    locale.l10nt( locale => locale.l10n( "Your password was just changed." ) )
                );
            }
        ...
        async API_setEmailByToken ( ctx, token ) {
            ...
            if ( res.ok ) {
                ...
                this.app.notifications.sendNotification(
                    "security",
                    ctx.user.id,
                    locale.l10nt( locale => locale.l10n( "Email changed" ) ),
                    locale.l10nt( locale =>
