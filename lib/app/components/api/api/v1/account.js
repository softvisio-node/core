...
` );
                ...
                this.app.notifications.sendEmail( oldEmail, subjet.toString( { "domain": user.locale } ), body.toString( { "domain": user.locale } ) );

                this.app.notifications.sendNotification( "security", user.id, subjet, body );
            }
