...
CREATE TRIGGER api_session_last_authorized_after_update AFTER UPDATE OF last_authorized, remote_address, geoip_name, user_agent ON api_session FOR EACH ROW EXECUTE FUNCTION api_session_after_update_trigger();
