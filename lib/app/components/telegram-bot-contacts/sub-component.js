...
const SQL = {
    "createContact": sql`INSERT INTO telegram_bot_telegram_bot_contact ( telegram_bot_id, telegram_bot_contact_id ) VALUES ( ?, ? ) ON CONFLICT DO NOTHING`,
};
...
export default Super =>
    class extends Super {
        ...
        async _createBot ( dbh, id, options ) {
            ...
            res = await dbh.do( SQL.createContact, [ id, contact.id ] );
