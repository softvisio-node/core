...
const SQL = {
    ...
    "revokeKey": sql`UPDATE crypto_key SET revoked = TRUE, revoke_date = CURRENT_TIMESTAMP`,
    ...
    "inssertMasterKeyHash": sql`INSERT INTO crypto_key ( id, key, revoked ) VALUES ( ?, ?, TRUE )`,
