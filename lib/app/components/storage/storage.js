...
export default class Storage {
    ...
    async run () {
        ...
        var publicHttpServer = this.app.publicHttpServer,
            privateHttpServer = this.app.privateHttpServer;
    ...
    async uploadFile ( path, file, { lastModified, contentType, cacheControl, contentDisposition, expires, ttl } = {} ) {
        ...
        if ( ttl ) expires = new Date( Date.now() + ttl );
