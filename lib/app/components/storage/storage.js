...
INSERT INTO storage_link
    ( name, storage_file_id, content_type, cache_control, content_disposition )
    VALUES (
    ?, ?, ?, ?, ? )
...
export default class Storage {
    ...
    async uploadFile ( path, file, { contentType, cacheControl, contentDisposition } = {} ) {
        ...
        // upsert file link
        return this.#dbh.do( QUERIES.upsertLink, [path, fileId, contentType, cacheControl, contentDisposition] );
    }
