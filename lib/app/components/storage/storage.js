...
export default class Storage {
    ...
    async run () {
        ...
        if ( privaPaths.has( "/" ) ) {
            this.app.publicHttpServer.get( `${this.#location}/*`, this.#privateLocation.bind( this ) );
            this.app.publicHttpServer.head( `${this.#location}/*`, this.#privateLocation.bind( this ) );
        }
        else {
            this.app.publicHttpServer.get( `${this.#location}/*`, this.downloadFile.bind( this ) );
            this.app.publicHttpServer.head( `${this.#location}/*`, this.downloadFile.bind( this ) );

            for ( const privaPath of privaPaths ) {
                this.app.publicHttpServer.get( `${this.#location}${privaPath}/*`, this.#privateLocation.bind( this ) );
                this.app.publicHttpServer.head( `${this.#location}${privaPath}/*`, this.#privateLocation.bind( this ) );
            }
        }
