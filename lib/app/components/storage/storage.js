...
`,
    ...
    "deleteFile": sql`DELETE FROM storage_link WHERE name = ?`.prepare(),
};
...
export default class Storage {
    ...
    async uploadFile ( name, file, { lastModified, contentType, cacheControl, contentDisposition } = {} ) {
        ...
        // upsert file link
        return this.#dbh.do( SQL.upsertLink, [name, fileId, lastModified || new Date(), contentType, cacheControl, contentDisposition] );
    }
