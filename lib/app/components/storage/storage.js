...
export default class Storage {
    ...
    async run () {
        ...
        const privateLocations = new Set( this.config.privateLocations );

        if ( privateLocations.has( "/" ) ) {
            ...
            for ( const privateLocation of privateLocations ) {
                this.app.publicHttpServer.get( `${this.#location}${privateLocation}/*`, this.#privateLocation.bind( this ) );
            }
        }
