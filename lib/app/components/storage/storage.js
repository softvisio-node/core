...
export default class Storage {
    ...
    async init () {
        ...
        // init locations
        this.#locations = new Locations( this, this.config.locations, this.#buckets );
    ...
    async uploadFile ( filePath, file, { cwd, lastModified, contentType, cacheControl, contentDisposition, expires, maxAge, inactiveMaxAge, encrypt, dbh } = {} ) {
        ...
        const bucket = this.#buckets.getBucket( filePath ),
    ...
    async getFileMeta ( filePath, { cwd, checkImage, dbh } = {} ) {
        ...
        // check image exists
        if ( checkImage ) {
            const bucket = this.#buckets.getBucket( file.path );
