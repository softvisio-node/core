...
export default class Storage {
    ...
    async uploadFile ( file, path, { lastModified, contentType, cacheControl, contentDisposition, expires, maxAge, inactiveMaxAge, dbh } = {} ) {
    ...
    async downloadFile ( req, { path, contentType, cacheControl, contentDisposition, dbh } = {} ) {
        if ( path ) {
            path = this.#cache.normalizePath( path );
        }
        else {
