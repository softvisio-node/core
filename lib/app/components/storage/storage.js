...
export default class Storage {
    ...
    async configure () {
        ...
        for ( const location in this.config.locations ) {
            this.config.locations[location].private ??= false;
        }
    ...
    async init () {
        ...
        for ( var [location, config] of Object.entries( this.config.locations ) ) {
            ...
            if ( this.#locations[location].maxAge ) this.#locations[location].maxAge = Duration.new( this.#locations[location].maxAge );

            if ( this.#locations[location].inactiveMaxAge ) this.#locations[location].inactiveMaxAge = Duration.new( this.#locations[location].inactiveMaxAge );
