...
CREATE SEQUENCE translations_project_id_seq AS int8 MAXVALUE ${ Number.MAX_SAFE_INTEGER };

CREATE TABLE translations_project (
    id int53 PRIMARY KEY DEFAULT nextval( 'translations_project_id_seq' ),
    locales json,
    default_locale text
);

ALTER SEQUENCE translations_project_id_seq OWNED BY translations_project.id;
