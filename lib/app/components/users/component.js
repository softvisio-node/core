...
const defaultAvatarFile = new File( {
    "path": new URL( "resources/default-avatar.png", import.meta.url ),
} );
...
export default class extends Component {
    ...
    async _configure () {
        ...
        this.config.defaultGravatarImage ||= "/storage/gefault-avatar";
    ...
    async _init () {
        ...
        this.app.publicHttpServer?.get( "/storage/gefault-avatar", async req =>
            req.end( {
                "status": 200,
                "headers": {
