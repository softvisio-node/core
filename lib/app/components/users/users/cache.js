...
export default class {
    ...
    constructor ( app, maxSize ) {
        this.#app = app;

        this.#usersCache = new CacheLru( { maxSize } ).on( "delete", this.#onDeleteUserFromCache.bind( this ) );
    }
    ...
    async init () {
        ...
        this.dbh.on( "api/user-notifications-profile/update", this.#onUserUpdate.bind( this ) );
