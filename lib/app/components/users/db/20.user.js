...
CREATE TABLE api_user_password_hash (
...
CREATE TRIGGER user_password_hash_after_update AFTER UPDATE ON api_user_password_hash FOR EACH ROW EXECUTE FUNCTION user_password_hash_after_update_trigger();
