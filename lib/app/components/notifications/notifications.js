...
export default class {
    ...
    async sendNotification ( type, users, subject, body, options = {} ) {
        ...
        for ( const userId of users ) {
            ...
            // telegram
            if ( defaultChannels.telegram.enabled && ( defaultChannels.telegram.editableled ? userChannels?.telegram ?? defaultChannels.telegram.default : defaultChannels.telegram.default ) ) {
