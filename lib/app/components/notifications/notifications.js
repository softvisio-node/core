    ...
    async configure () {
        ...
        for ( const type of Object.values( this.#types ) ) {
            ...
            for ( const channel of Object.keys( this.#channels ) ) {
                ...
                channels[channel].enabled ??= this.#channels[channel].enabled;
        ...
        for ( const channel of Object.keys( this.#channels ) ) {
            if ( !enabledChannels[channel] ) this.#channels[channel].enabled = false;

            if ( this.#channels[channel].enabled ) this.#hasEnabledChannels = true;
        }
