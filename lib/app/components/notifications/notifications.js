...
const SQL = {
    ...
    "subscribeUserNotification": sql`INSERT INTO user_notification_profile ( user_id, notification, internal, email, telegram, push ) VALUES ( ?, ?, ?, ?, ?, ? ) ON CONFLICT ( user_id, notification ) DO UPDATE SET internal = EXCLUDED.internal, email = EXCLUDED.email, telegram = EXCLUDED.telegram, push = EXCLUDED.push`.prepare(),
};
...
export default class {
    ...
    async subscribeUserNotification ( userId, notification ) {
        ...
        return this.dbh.do( SQL.subscribeUserNotification, [
