    ...
    async sendEmailNotification ( users, subject, body, options = {} ) {
        ...
        for ( const userId of users ) {
            ...
            this.sendEmail(
                ...
                //
                user.email,
                LocaleTemplate.translate( subject, { "domain": user.locale } ),
                LocaleTemplate.translate( body, { "domain": user.locale } ),
                options
            ...
            if ( !PUSH_NOTIFICATION_GROUPS.has( target ) ) {
                ...
                this.#googleCloudMessagingApi
                    .send( {
                        ...
                        "notification": {
                            "title": LocaleTemplate.translate( subject, { "domain": user.locale } ),
                            "body": LocaleTemplate.translate( body, { "domain": user.locale } ),
                            ...message.notification,
                        },
                    } )
                    .then( res => counter.dec() );
