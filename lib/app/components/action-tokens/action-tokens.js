...
export default class {
    ...
    async createActionToken ( userId, tokenType, { length, data, dbh } = {} ) {
        dbh ||= this.dbh;
        ...
        return dbh.begin( async dbh => {
            ...
            const expires = new Duration( this.config.actionTokenMaxAge ).toDate();
            ...
            // generate token
            const token = Token.generate( this.app, tokenType, tokenId, { "length": length || this.config.ActionTokenLength } );
