...
export default class PostgreSql {
    ...
    constructor ( app, config ) {
        ...
        this.#binDir = `/usr/lib/postgresql/${this.config.clusterVersion}/bin`;
        ...
        this.#dataDir = path.join( this.#dataRoot, this.config.clusterVersion + "", this.config.clusterName );

        this.#unixSocketDirectories = "/var/run/postgresql";

        this.#backupDir = path.join( this.#dataRoot, this.config.clusterVersion, `${this.config.clusterName}.backups` );
...
Cluster upgraded to the version: ${this.config.clusterVersion}.
