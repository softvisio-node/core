...
export default class PostgreSql {
    ...
    async start () {
        ...
        // start server
        this.#proc = childProcess.spawn( "postgres", ["-D", this.#dataDir, "-k", this.#unixSocketDirectories, "--hostname", "0.0.0.0"], {
            "encoding": "utf8",
            "uid": this.#uid,
            "gid": this.#gid,
            "stdio": "inherit",
        ...
        childProcess.spawnSync( "pg_isready", ["--timeout=0"], { "encoding": "utf8", "stdio": "inherit" } );
    ...
    async #updatePrimary () {
        ...
        // run server
        const proc = childProcess.spawn( "postgres", ["-D", this.#dataDir, "-k", this.#unixSocketDirectories, "--hostname="], {
            "encoding": "utf8",
            "uid": this.#uid,
            "gid": this.#gid,
            "stdio": "inherit",
