...
export default class PostgreSql {
    ...
    async upgrade ( clusterVersion, clusterName ) {
        ...
        this.#cluster = new PostgreSqlCluster( this.#dataRoot, process.env.POSTGRESQL_VERSION, this.config.clusterName );

        const oldCluster = new PostgreSqlCluster( this.#dataRoot, clusterVersion, clusterName );
