...
export default class PostgreSql {
    ...
    constructor ( app, config ) {
        ...
        this.#binDir = `/usr/lib/postgresql/${this.config.postgresVersion}/bin`;
        ...
        this.#dataDir = path.join( this.#dataRoot, this.config.postgresVersion + "", this.config.clusterName );

        this.#unixSocketDirectories = "/var/run/postgresql";

        this.#backupDir = path.join( this.#dataRoot, `backup.${this.config.postgresVersion}.${this.config.clusterName}` );
...
Cluster upgraded to the version: ${this.config.postgresVersion}.
