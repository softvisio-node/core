...
` );
    ...
    #startBackupCron () {
        ...
        this.#backupCron = new Cron( this.#config.backup.cron, { "runMissed": true } ).on( "tick", this.#makeBackup.bind( this ) ).unref().start();
    }
    ...
    async #makeBackup () {
        ...
        // XXX
        // daily: getHours() = 0;
        // weekly: getHours() = 0, getDay() = 0;
        // monthly: getHours() = 0, getDate() = 1;
