...
export default class PostgreSqlBaclup {
    ...
    async #makeBackup () {
        ...
        this.#activityManager.startThread();
        ...
        this.#activityManager.stopThread();
    ...
    #doStart () {
        if ( !this.#postgresql.isPrimary ) return result( 500 );

        if ( !this.config.backups ) return result( 500 );
