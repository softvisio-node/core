...
export default class PostgreSqlCluster extends Events {
    ...
    constructor ( postgresql, version, name ) {
        ...
        this.#backupsDir = path.join( this.#postgresql.dataRootDir, this.#version + "", this.#name + ".backups" );
    ...
    async makeBackup () {
        ...
        const backupDate = new Date(),
            backupId = backupDate.toISOString(),
            backupPath = path.join( this.backupsDir, backupId );
