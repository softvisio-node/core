...
CREATE TYPE payments_transaction_type AS ENUM ( 'TOP-UP', 'WITHDRAW', 'PAYMENT', 'TRANSFER' );

-- XXX
CREATE TYPE payments_transaction_status AS ENUM ( 'NEW', 'APPROVED', 'DECLINED', 'DONE' );
...
CREATE TABLE payments_transaction (
    ...
    type payments_transaction_type NOT NULL,
    status payments_transaction_status NOT NULL,
