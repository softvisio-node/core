...
INSERT INTO
    ...
    ON CONFLICT ( monitoring_instance_id, date ) DO UPDATE SET
        ...
        memory_used = greatest( monitoring_instance_stats.memory_used, EXCLUDED.memory_used ),
        memory_used_percent = greatest( monitoring_instance_stats.memory_used_percent, EXCLUDED.memory_used_percent ),
        memory_rss = greatest( monitoring_instance_stats.memory_rss, EXCLUDED.memory_rss ),
        memory_rss_percent = greatest( monitoring_instance_stats.memory_rss_percent, EXCLUDED.memory_rss_percent ),
        fs_used = greatest( monitoring_instance_stats.fs_used, EXCLUDED.fs_used ),
        fs_used_percent = greatest( monitoring_instance_stats.fs_used_percent, EXCLUDED.fs_used_percent )
`.prepare(),
};
...
export default class {
    ...
    async monitorMethodCall ( component, method, call ) {
        ...
        try {
            ...
            res = result.catch( e, { "silent": false } );
        }
