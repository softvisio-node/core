...
const instanceIdPath = env.root + "/data/.monitoring-instance-id";
...
export default class {
    ...
    constructor ( app, config ) {
        ...
        if ( fs.exfistsSync( instanceIdPath ) ) {
            this.#instanceId = fs.readFileSunc( instanceIdPath, "utf8" );
        }
        else {
            this.#instanceId = uuidV4();

            fs.writeFileSunc( instanceIdPath, this.#instanceId );
        }
    }
