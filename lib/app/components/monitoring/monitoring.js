    ...
    async monitorMethodCall ( component, method, call ) {
        ...
        if ( !row ) {
            this.#apiCalls.set( key, {
                "monitoring_method_id": sql`insert_monitoring_method( ${this.#app.id.clusterId}, ${this.#app.id.packageName}, ${this.#app.id.serviceName}, ${this.#app.id.instanceId}, ${component}, ${method} )`,
                "date": start,
                "calls": 1,
                duration,
