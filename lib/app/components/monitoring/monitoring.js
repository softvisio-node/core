...
` );
    ...
    async #monitorInstance () {
        ...
        return this.#dbh.do( SQL.monitorInstance, [
            ...
            mark.memoryFree,
            mark.memoryFreePercent * 100,
            mark.memoryUsed,
            mark.memoryUsedPercent * 100,
            mark.memoryRss,
            mark.memoryRssPercent * 100,

            mark.fsFree,
            mark.fsFreePercent * 100,
            mark.fsUsed,
            mark.fsUsedPercent * 100,
        ] );
    }
}
