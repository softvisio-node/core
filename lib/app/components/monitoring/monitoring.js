...
INSERT INTO
    ...
    ON CONFLICT ( monitoring_instance_id, date ) DO UPDATE SET
        ...
        rss_usage = greatest( monitoring_instance_stats.rss_usage, EXCLUDED.rss_usage ),
        rss_usage_percent = greatest( monitoring_instance_stats.rss_usage_percent, EXCLUDED.rss_usage_percent ),
