...
CREATE FUNCTION insert_monitoring_instance ( _instance uuid, _service text ) RETURNS int8 AS $$
DECLARE
    _id int8;
BEGIN
...
CREATE TRIGGER monitoring_instance_stats_after_insert AFTER INSERT ON telegram_bot FOR EACH ROW EXECUTE FUNCTION monitoring_instance_stats_after_insert_trigger();
