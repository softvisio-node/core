...
CREATE INDEX monitoring_instance_cluster_id_package_name_service_name_instance_id_idx ON monitoring_instance ( cluster_id, package_name, service_name, instance_id );
...
BEGIN
    ...
    WHERE
        ...
        AND package_name = _package_name
    ...
    IF _id IS NULL THEN
        INSERT INTO
            monitoring_instance
        ( cluster_id, package_name, service_name, instance_id )
        VALUES
        ( _cluster_id, _package_name, _service_name, _instance_id )
