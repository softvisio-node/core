...
stats AS (
    SELECT
        ...
        avg( cpu_usage )::number2::float8 AS cpu_usage,
        ( avg( memory_used ) / 1048576)::int53 AS memory_used,
        avg( memory_used_percent )::number2::float8 AS memory_used_percent,
        ( avg( memory_rss ) / 1048576)::int53 AS memory_rss,
        avg( memory_rss_percent )::number2::float8 AS memory_rss_percent,
        ( avg( fs_used ) / 1048576)::int53 AS fs_used,
        avg( fs_used_percent )::number2::float8 AS fs_used_percent
    FROM
