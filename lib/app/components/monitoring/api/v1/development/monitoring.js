...
export default Super =>
    class extends Super {
        ...
        async API_getLatestTimeSeries ( ctx, component, method ) {
            return this.dbh.select( SQL.getLatestTimeSeries, [component, method] );
        }

        async API_getHistoricalTimeSeries ( ctx, component, method ) {
            return this.dbh.select( SQL.getHistoricalTimeSeries, [component, method] );
        }
        ...
        async API_clearMethodExceptions ( ctx, component, method ) {
            return this.dbh.do( SQL.clearApiMethodExceptions, [component, method] );
        }
    };
