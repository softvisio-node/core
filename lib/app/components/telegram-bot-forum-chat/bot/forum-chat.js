...
const notInChatMessageId = "notInChatMessageId";
...
export default class {
    ...
    async deleteNotInChatMessage ( user ) {
        if ( !user.state.forumChat?.[ notInChatMessageId ] ) return;
                        ...
                        [
                            {
                                ...
                                "callback_data": this.#command.encodeCallbackData( "run", this.#command.id ),
                            },
                        ],
                    ],
                },
