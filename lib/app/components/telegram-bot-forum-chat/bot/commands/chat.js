...
export default Super =>
    class extends Super {
        ...
        // // XXX
        // async init () {
        //     this.bot.forumChat.setCommand( this );
        ...
        // XXX send notification to unjoined users
...
To exit chat use "Start" menu.` ),
                ...
                await group.send( "forwardMessage", {
                    "message_thread_id": topicId,
                    "from_chat_id": message.chat.id,
                    "message_id": message.id,
                } );

                return this.bot.forumChat.sendNewMessageMotification();
            }
        }
