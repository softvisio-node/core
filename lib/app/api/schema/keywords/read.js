...
function generateType ( type, _const, _enum, checkAcl ) {
    ...
    if ( checkAcl ) macro["checkAcl"] = checkAcl;
    ...
    "macro": ( schema, parentSchema, it ) => {
        ...
        for ( const fieldName in schema.fields ) {
            ...
            if ( fieldName === "id" ) {
                ...
                if ( field["checkAcl"] ) macro.properties.id["checkAcl"] = field["checkAcl"];
            }
            ...
            if ( field.operator ) {
                ...
                macro.properties.where.properties[fieldName] = generateMacro( field.type, field.operator, field.const, field.enum, field["checkAcl"] );
            }
        }
