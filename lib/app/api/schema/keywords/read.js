...
const TYPES = {
    ...
    "string": new Set( ["=", "!=", "like", "not like", "contains", "not contains", "in", "not in"] ),
                    ...
                    "properties": {
                        ...
                        "operator": {
                            "anyOf": [
                                ...
                                //
                                { "enum": ["=", "!=", "<", ">", "<=", ">=", "like", "not like", "contains", "not contains", "in", "not in"] },
                                { "type": "array", "items": { "enum": ["=", "!=", "<", ">", "<=", ">=", "like", "not like", "contains", "not contains", "in", "not in"] }, "minItems": 1, "uniqueItems": true },
                            ],
                        },
                        "const": {},
