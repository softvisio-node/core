    ...
    if ( scalarOperators.length ) {
        macros.push( {
            ...
            "items": [
                ...
                //
                scalarOperators.length === 1 ? { "const": scalarOperators[0] } : { "enum": scalarOperators },
    ...
    if ( arrayOperators.length ) {
        macros.push( {
            ...
            "items": [
                ...
                //
                arrayOperators.length === 1 ? { "const": arrayOperators[0] } : { "enum": arrayOperators },
                {
                    "type": "array",
    ...
    if ( globOperators.length ) {
        macros.push( {
            ...
            "items": [
                ...
                //
                globOperators.length === 1 ? { "const": globOperators[0] } : { "enum": globOperators },
                {
                    "anyOf": [
