...
const TYPES = {
    ...
    "string": new Set( ["=", "!=", "like", "not like", "ilike", "not ilike", "contains", "not contains", "icontains", "not icontains", "in", "not in"] ),
                    ...
                    "properties": {
                        ...
                        "operator": {
                            "anyOf": [
                                ...
                                //
                                {
                                    "enum": ["=", "!=", "<", ">", "<=", ">=", "like", "not like", "ilike", "not ilike", "contains", "not contains", "icontains", "not icontains", "in", "not in"],
                                },
                                {
                                    "type": "array",
                                    "items": {
