...
export default class ApiMethod {
    ...
    setConfig ( config ) {
        ...
        if ( config.deprecated != null ) this.#deprecated = config.deprecated;
        if ( Reflect.has( config, "permission" ) ) this.#permission = config.permission;
        if ( config.authorizationRequired != null ) this.#authorizationRequired = config.authorizationRequired;
        if ( config.persistentConnectionRequired != null ) this.#persistentConnectionRequired = config.persistentConnectionRequired;
