...
export default class ApiMethod {
    ...
    setConfig ( config ) {
        ...
        if ( Reflect.has( config, "deprecated" ) ) this.#deprecated = config.deprecated;
        if ( Reflect.has( config, "permission" ) ) this.#permission = config.permission;
        if ( Reflect.has( config, "authorizationRequired" ) ) this.#authorizationRequired = config.authorizationRequired;
        if ( Reflect.has( config, "persistentConnectionRequired" ) ) this.#persistentConnectionRequired = config.persistentConnectionRequired;
