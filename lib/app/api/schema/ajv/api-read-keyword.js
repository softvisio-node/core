...
const TMPL = utils.resolve( "#resources/templates/api-read-keyword.md.ejs", import.meta.url );
...
class apiReadKeyword {
    ...
    async getDescription ( schema, meta = {} ) {
        ...
        return ejs.renderFile( TMPL, {
            ...
            "orderBy": Object.keys( schema ).filter( field => schema[field].sortable ),
            meta,
        } );
    }
}
