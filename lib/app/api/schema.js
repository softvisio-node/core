...
import apiReadKeyword from "./schema/ajv/api-read-keyword.js";
import fileKeyword from "./schema/ajv/file-keyword.js";
...
export default class ApiSchema {
    ...
    async #getParamDescription ( method, param ) {
        ...
        // apiRead keyword
        if ( param.schema.apiRead ) {
            desc += await apiReadKeyword.getDescription( param.schema.apiRead );
        }

        // file keyword
        else if ( param.schema.file ) {
            desc += await fileKeyword.getDescription( param.schema.file );
        }
