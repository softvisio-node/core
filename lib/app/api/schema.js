...
export default class APISchema {
    ...
    async generate ( options = {} ) {
        const fileTree = new fs.FileTree(),
            ...
            readmeTmpl = fs.resolve( "#resources/templates/api/README.md.ejs", import.meta.url ),
            sidebarTmpl = fs.resolve( "#resources/templates/api/_sidebar.md.ejs", import.meta.url ),
            moduleTmpl = fs.resolve( "#resources/templates/api/module.md.ejs", import.meta.url ),
            index = {};
