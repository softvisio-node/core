...
export default class APISchema {
    ...
    async generate ( options = {} ) {
        const fileTree = new fs.FileTree(),
            ...
            readmeTmpl = fs.resolve( "#assets/templates/api/README.md.ejs", import.meta.url ),
            sidebarTmpl = fs.resolve( "#assets/templates/api/_sidebar.md.ejs", import.meta.url ),
            moduleTmpl = fs.resolve( "#assets/templates/api/module.md.ejs", import.meta.url ),
            index = {};
