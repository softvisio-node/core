...
export default class ApiSchema {
    ...
    get allowAllevents () {
        this.#allowAllEvents ??= this.#emits.has( "*" );
        ...
        try {
            ...
            for ( const file of modules ) {
                ...
                if ( /^v\d+\.yaml$/.test( file ) ) {
                    ...
                    if ( index.emits ) index.emits.forEach( name => this.#emits.add( name ) );
                }
                ...
                // module
                    ...
                    if ( module.namespace ) module.emits.forEach( name => this.#emits.add( name ) );
