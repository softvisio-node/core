...
export default Super =>
    class Connection extends ( Super || Object ) {
        ...
        async #onWebsocketOpen ( ws, req ) {
            ...
            ws.auth = await this._authenticateConnection();

            this._onWebsocketAuth( ws );
        }
        ...
        async #onWebsocketMessage ( ws, msg, isBinary ) {
            ...
            // auth
                ...
                ws.auth = await this._authenticateConnection( msg.token );
        ...
        async #onHttpRequest ( req, methodId ) {
            ...
            try {
                ...
                if ( isUpload ) {
                    ...
                    // check permissions
                    if ( !this._connectionHasPermissions( auth, method.permissions ) ) throw result( [403, "Insufficient permissions"] );
