        ...
        async #onWebsocketMessage ( ws, msg, isBinary ) {
            ...
            if ( msg.method ) {
                ...
                // event
                    ...
                    if ( !Array.isArray( msg.params[1] ) ) msg.params[1] = msg.params[1] === undefined ? [] : [msg.params[1]];

                    this._onUserEvent( ws.auth, msg.params[0], msg.params[1] );
                }
        ...
        async #onHttpRequest ( req, methodId ) {
            ...
            try {
                ...
                if ( methodId === "/event" ) {
                    ...
                    this._onUserEvent( auth, params[0], params[1] );
