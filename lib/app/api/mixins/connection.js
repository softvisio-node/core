...
export default Super =>
    class Connection extends ( Super || Object ) {
        ...
        async #onWebSocketOpen ( ws, req ) {
            ...
            // register connection
            this.#connections[ws.clientId] = ws;
            ...
            this.emit( "client/connect", ws.clientId );
        }
        ...
        #onWebSocketClose ( ws, status, statusText ) {
            ...
            this.emit( "client/disconnect", ws.clientId );
        }
            ...
            if ( msg.method ) {
                ...
                // rpc
                    ...
                    // regular call
                        ...
                        const res = await this.#call( ws.auth, msg.method, msg.params, false, ws.clientId );
                    ...
                    // void call
                        ...
                        this.#call( ws.auth, msg.method, msg.params, true, ws.clientId );
                    }
                }
            }
        }
        ...
        async #call ( auth, methodId, args, isVoid, clientId ) {
