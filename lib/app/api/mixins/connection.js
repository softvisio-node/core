...
class Client extends Events {
    ...
    #subscribe ( name ) {
        ...
        this.#api.app.hub.on( this.isRpc ? "rpc/out" : "api/out", name, this.#eventsListener );
    }
    ...
    #unsubscribe ( name ) {
        ...
        this.#api.app.hub.off( this.isRpc ? "rpc/out" : "api/out", name, this.#eventsListener );
    }
...
export default Super =>
    class Connection extends ( Super || Object ) {
        ...
        #onRemoteEvent ( name, auth, args ) {
            ...
            this.app.hib.publish( this.isRpc ? "rpc/in" : "api/in", name, [auth, args] );
        }
    };
