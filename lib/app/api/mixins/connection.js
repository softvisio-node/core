...
const LOCAL_EVENTS = new Set( ["connect", "disconnect", "remote", "client/connect", "client/disconnect"] );
    ...
    class Connection extends ( Super || Object ) {
        ...
        publish ( targets, name, ...args ) {
            ...
            for ( const target of targets ) {
                ...
                if ( !this.#events.listenerCount( targetName ) ) continue;
                ...
                this.#events.emit( targetName, msg, cache );
            }
        }
        ...
        // protected
        _isLocalEventName ( name ) {
            return LOCAL_EVENTS.has( name );
        }
        ...
        _onRemoteEvent ( name, auth, args ) {
            if ( this._isLocalEventName( name ) ) return;
        ...
        async #onWebSocketOpen ( ws, req ) {
            ws.client = new Client( this, ws, this.#events );
