...
export default Super =>
    class Connection extends ( Super || Object ) {
        ...
        async #onWebSocketOpen ( ws, req ) {
            ...
            this.emit( "client/connect", ws.id );
        }
        ...
        #onWebSocketClose ( ws, status, statusText ) {
            ...
            this.emit( "client/disconnect", ws.id );
        }
            ...
            if ( msg.method ) {
                ...
                // rpc
                    ...
                    // regular call
                        ...
                        const res = await this.#call( ws.auth, msg.method, msg.params, false, ws.id );
                    ...
                    // void call
                        ...
                        this.#call( ws.auth, msg.method, msg.params, true, ws.id );
                    }
                }
            }
        }
        ...
        async #call ( auth, methodId, args, isVoid, connectionId ) {
