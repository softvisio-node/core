...
export default Super =>
    class Connection extends ( Super || Object ) {
        ...
        async #onWebsocketOpen ( ws, req ) {
            ...
            ws.listener = this.#wsPublish.bind( this, ws );

            ws.events = this.#getEventNames( auth );
        ...
        async #onWebsocketMessage ( ws, msg, isBinary ) {
            ...
            if ( msg.method ) {
                ...
                if ( msg.method === "/ping" ) {
                    ...
                    if ( msg.id ) this.#wsSend( ws, { "jsonrpc": "2.0", "id": msg.id, "method": "/pong" } );
                }
                ...
                // healthcheck
                    ...
                    if ( msg.id ) this.#wsSend( ws, res.toRPC( msg.id ) );
                }
                ...
                // rpc
                    ...
                    if ( method?.upload ) {
                        if ( msg.id ) this.#wsSend( ws, result( -32900 ).toRPC( msg.id ) );
                    }
                    ...
                    // regular call
                        ...
                        this.#wsSend( ws, res.toRPC( msg.id ) );
                    }
