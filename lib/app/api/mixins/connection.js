...
export default Super =>
    class Connection extends ( Super || Object ) {
            ...
            // rpc
                ...
                if ( msg.method ) {
                    ...
                    // void call
                        ...
                        this.#call( auth, msg.method, msg.args, true );
                    }

                    // regular call
                    else {
                        const res = await this.#call( auth, msg.method, msg.args );
        ...
        async #onHttpRequest ( req, method ) {
            ...
            try {
                ...
                if ( isUpload ) {
                    ...
                    res = await this.#call( auth, method, data );
                }
                else {
                    res = await this.#call( auth, method, data === undefined ? [] : [data] );
                }
            }
            catch ( e ) {
        ...
        async #call ( auth, method, args, isVoid ) {
            const ctx = new Context( this, auth, true, null );
