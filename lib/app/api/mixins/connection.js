...
export default Super =>
    class Connection extends ( Super || Object ) {
        ...
        async #upload ( req, methodId, token ) {
            ...
            try {
                ...
                formDataDecoder.on( "field", ( formDataDecoder, name, value, options ) => {
                    ...
                    try {
                        [isBinary, params] = this.#decodeMessage( Buffer.from( value, "binary" ), options.type );
                    }
                    catch ( e ) {
                ...
                formDataDecoder.on( "file", ( formDataDecoder, name, stream, options ) => {
                    ...
                    // params
                        ...
                        stream.on( "end", () => {
                            ...
                            // decode params
                            try {
                                [isBinary, params] = this.#decodeMessage( _params, options.type );
                            }
                            catch ( e ) {
                                formDataDecoder.finish( e );
                            }
                ...
                res = await formDataDecoder.decode( req.headers, req.stream );
        ...
        #decodeMessage ( msg, type ) {
            ...
            try {
                msg = isBinary ? MSGPACK.decode( msg ) : JSON.parse( msg );
            }
            catch ( e ) {
                throw result( -32807 );
            }
