...
export default Super =>
    class Connections extends ( Super || Object ) {
        ...
        async #onWebSocketUpgrade ( res, req, context ) {
            ...
            if ( this.authCache ) this.authCache.updateAuthLastUsed( auth );
        ...
        async #onWebSocketMessage ( ws, msg, isBinary ) {
            ...
            // update auth last used timestamp
            if ( this.authCache ) this.authCache.updateAuthLastUsed( ws.auth );
        ...
        #publishRemoteEvent ( name, auth, args ) {
            ...
            if ( this.isRpc ) this.app.hub.publish( "rpc/in", name, [auth, ...args] );
            else this.app.hub.publish( "api/in", name, [auth, ...args] );
        }
    };
