            ...
            try {
                ...
                formDataDecoder.on( "field", async ( name, stream, headers ) => {
                    ...
                    if ( name === "file" ) {
                        ...
                        // not a file
                        if ( !headers.filename ) return stream.destroy( result( -32906 ) );

                        // check content type
                        if ( method.meta.uploadContentType ) {
                            const types = new Set( method.meta.uploadContentType );

                            if ( !types.has( headers["content-type"] ) ) return stream.destroy( result( -32906 ) );
                        }
                        ...
                        if ( !tmpFile ) return stream.destroy( result( -32906 ) );
                    ...
                    // params
                        ...
                        if ( !buffer ) return stream.destroy( result( -32907 ) );
                    ...
                    // unexpected parameter
                        ...
                        stream.destroy( result( 500 ) );
                    }
                } );

                formDataDecoder.decode().then( res1 => {
                    res = res1;
