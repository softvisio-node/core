...
export default Super =>
    class Connections extends ( Super || Object ) {
        ...
        async #onHttpRequest ( req, methodId ) {
            var res, token, voidCall, isBinary, id, args;
            ...
            try {
                ...
                if ( req.method === "post" ) {
                    ...
                    // decode body
                        ...
                        try {
                            args = isBinary ? msgpack.decode( body ) : JSON.parse( body );
                        }
                        catch ( e ) {
                            throw result( -32807 );
                        }
                ...
                // rpc
                    ...
                    // check protocol
                    if ( method.protocol ) {
                        if ( isBinary && method.protocol === "text" ) throw result( -32811 );
                        else if ( !isBinary && method.protocol === "binary" ) throw result( -32811 );
                    }
                ...
                formDataDecoder.on( "field", async ( name, stream, headers ) => {
                    ...
                    // args
                        ...
                        if ( buffer ) {
                            ...
                            // decode args
                            try {
                                [isBinary, args] = this.#decodeArguments( buffer, headers["content-type"] );
        ...
        #decodeArguments ( args, type ) {
            ...
            try {
                args = isBinary ? msgpack.decode( args ) : JSON.parse( args );
            }
            catch ( e ) {
                throw result( -32807 );
            }

            return [isBinary, args];
        }
