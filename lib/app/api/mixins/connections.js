...
export default Super =>
    class Connections extends ( Super || Object ) {
        ...
        getHttpServerConfig () {
            return {
                "ws": {
                    ...
                    "maxPayloadLength": 16 * 1024, // this.app.config.apiMaxPayload
                    "idleTimeout": 40, // this.app.config.apiIdleTimeout
                    "sendPingsAutomatically": true,
                    "connection": ws => new Connection( this, ws, this.#in, this.#out, this.#publishRemoteIncomingEvent.bind( this ), this.#call.bind( this ) ),
                },
        ...
        async #onWebSocketOpen ( connection ) {
            ...
            this.#in.publish( "connect", connection );
        }
