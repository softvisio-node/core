...
export default Super =>
    class Connections extends ( Super || Object ) {
        ...
        getHttpServerConfig () {
            return {
                "ws": {
                    ...
                    "maxPayloadLength": this.config.connections.maxPayloadLength,
                    "idleTimeout": this.config.connections.idleTimeout,
                    "compress": this.config.connections.compress,
                    "sendPingsAutomatically": this.config.connections.sendPingsAutomatically,
        ...
        async #onHttpRequest ( req, methodId ) {
            ...
            try {
                ...
                // rpc
                    ...
                    // void api call
                    if ( voidCall ) {
                        this.#call( auth, methodId, args, true, {
                            "connection": false,
                            "userAgent": req.headers.get( "user-agent" ),
                            "remoteAddress": req.realRemoteAddress,
                        } );
                        ...
                        res = await this.#call( auth, methodId, args, false, {
                            "connection": false,
                            "userAgent": req.headers.get( "user-agent" ),
                            "remoteAddress": req.realRemoteAddress,
                        } );
        ...
        async #call ( auth, methodId, args, isVoid, data ) {
