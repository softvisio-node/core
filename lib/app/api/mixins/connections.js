...
class Connection extends Events {
    ...
    #subscribe ( name ) {
        ...
        this.#api.app.on( ( this.#api.isRpc ? "rpc:" : "api:" ) + name, this.#eventsListener );
    }
    ...
    #unsubscribe ( name ) {
        ...
        this.#api.app.hub.off( ( this.#api.isRpc ? "rpc:" : "api:" ) + name, this.#eventsListener );
    }
...
export default Super =>
    class Connections extends ( Super || Object ) {
        ...
        #publishRemoteEvent ( name, auth, args ) {
            ...
            if ( this.isRpc ) this.app.publish( "rpc:" + name, ...args );
            else this.app.publish( "api:" + name, auth, ...args );
        }
    };
