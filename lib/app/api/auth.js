...
export default class Auth extends Events {
    ...
    get avatar () {
        if ( !this.#avatar ) {
            if ( this.#gravatar ) {
                this.#avatar = `https://s.gravatar.com/avatar/${this.#gravatar}?d=${this.#api.app.settings.defaultGravatarImage}`;
            }
            else {
                this.#avatar = this.#api.app.settings.defaultGravatarUrl;
            }
        }
