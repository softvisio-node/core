...
export default class Connection extends _Connection {
    ...
    constructor ( ws, options, api, incomingEvents, outgoingEvents, publishRemoteIncomingEvent, call ) {
        super( ws, options );
    ...
    async _onMessage ( msg, isBinary ) {
        ...
        if ( msg.method ) {
            ...
            // rpc
                ...
                // check protocol
                else if ( method?.protocol && ( ( isBinary && method.protocol !== "binary" ) || ( !isBinary && method.protocol !== "text" ) ) ) {
