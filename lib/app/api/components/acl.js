    ...
    async _postInit ( acl ) {
        ...
        // check api schema permissions, create permissions index
        {
            for ( const method of Object.values( this.api.frontend.schema.methods ) ) {
                ...
                if ( !isKebabCasePath( namespace, { "absolute": false, "folder": false } ) || !isKebabCasePath( name, { "absolute": false, "folder": false } ) ) return result( [500, `Permission "${method.permission}" is invalid`] );
