...
export default class extends Component {
    ...
    async setAclUserScopes ( aclId, userId, scopes, parentUserId, { dbh } = {} ) {
        ...
        if ( !parentUserIsRoot ) {
            ...
            if ( !parentUser ) return result( [400, `Unable to add user`] );
        }
...
` );
    ...
    // XXX
    async addAclUserScope ( aclId, userId, scope, parentUserId ) {}

    // XXX
    async deleteAclUserScope ( aclId, userId, scope, parentUserId ) {}
