...
import createUserAgent from "#lib/user-agent";
    ...
    async createSession ( userId, { hostname, userAgent, remoteAddress, dbh } = {} ) {
        ...
        var res = await dbh.begin( async dbh => {
            ...
            let res = await dbh.selectRow( SQL.insertSession, [
                ...
                userAgent.browser.majorVersion,
                null, // userAgent.engineName,
                null, // userAgent.engineVersion,
                userAgent.os.family,
                userAgent.os.version,
                userAgent.device.brand,
                userAgent.device.model,
                null, // userAgent.deviceType,
                null, // userAgent.cpuArchitecture,
            ] );
