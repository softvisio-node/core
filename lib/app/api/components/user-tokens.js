...
export default class extends Component {
    ...
    async authenticate ( token ) {
        ...
        return {
            ...
            "roles": this.api.userRoles.buildUserRoles( res.data.id, res.data.user_roles, res.data.token_roles ),
    ...
    async createUserToken ( userId, name, enabled, roles = {}, options = {} ) {
        ...
        res = await dbh.begin( async dbh => {
            ...
            // generate token
            const token = Token.generate( this.api, constants.tokenTypeUserToken, id );
