...
const QUERIES = {
    ...
    "upsertUserNotificationChannel": sql`INSERT INTO user_notification_type ( user_id, type, channel, enabled ) VALUES ( ?, ?, ?, ? ) ON CONFLICT ( user_id, type ) DO UPDATE SET enabled = EXCLUDED.enabled`.prepare(),
};
...
export default class extends Component {
    ...
    async setUserNotificationChannelEnabled ( userId, type, channel, enabled ) {
        ...
        return this.dbh.do( QUERIES.upsertUserNotificationChannel, [userId, type, channel, enabled] );
    }
