...
export default class extends Component {
    ...
    async getUserNotificationsProfile ( userId ) {
        const profile = {
            ...
            "telegram_supported": this.telegramSupported,
        };

        if ( this.telegramSupported ) {
            profile.telegram_bot_username = this.telegramBotUsername;

            profile.telegram_url = "tg://resolve?domain=" + profile.telegram_bot_username;
        }
