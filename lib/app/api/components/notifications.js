...
export default class extends Component {
    ...
    // properties
    get internalNotificationsEbabled () {
        return this.#internalNotificationsEbabled;
    }
    ...
    async sendNotification ( type, users, subject, body, options = {} ) {
        ...
        for ( const userId of users ) {
            ...
            // internal
            if ( this.internalNotificationsEbabled && defaultChannels.internal != null ) {
    ...
    async _init () {
        ...
        this.#internalNotificationsEbabled = this.api.config.internalNotificationsEbabled;
    ...
    async _run () {
        ...
        if ( this.internalNotificationsEbabled ) {
