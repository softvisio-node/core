...
const QUERIES = {
    ...
    "upsertUserNotificationTypeChannel": sql`INSERT INTO user_notification_type_channel ( user_id, type, channel, enabled ) VALUES ( ?, ?, ?, ? ) ON CONFLICT ( user_id, type ) DO UPDATE SET enabled = EXCLUDED.enabled`.prepare(),
};
