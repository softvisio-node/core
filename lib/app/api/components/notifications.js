...
export default class extends Component {
    ...
    async getUserNotificationsProfile ( userId ) {
        ...
        for ( const type in this.#types ) {
            ...
            if ( this.internalNotificationsEnabled ) {
                ...
                if ( typeProfile.internal != null ) profile.internalNotificationsEnabled = true;
            }
            ...
            if ( this.emailNotificationsEnabled ) {
                ...
                if ( typeProfile.email != null ) profile.emailNotificationsEnabled = true;
            }
            ...
            if ( this.telegramNotificationsEnabled ) {
                ...
                if ( typeProfile.telegram != null ) profile.telegramNotificationsEnabled = true;
            }
            ...
            if ( this.pushNotificationsEnabled ) {
                ...
                if ( typeProfile.push != null ) profile.pushNotificationsEnabled = true;
            }
        }

        if ( profile.internalNotificationsEnabled || profile.emailNotificationsEnabled || profile.telegramNotificationsEnabled || profile.pushNotificationsEnabled ) {
            profile.types = types;
        }
    ...
    async _init () {
        ...
        for ( const type of Object.values( this.#types ) ) {
            if ( type.internal != null ) this.#internalNotificationsEnabled = true;
            if ( type.email != null ) this.#emailNotificationsEnabled = true;
            if ( type.telegram != null ) this.#telegramNotificationsEnabled = true;
            if ( type.push != null ) this.#pushNotificationsEnabled = true;
        }
