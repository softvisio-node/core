...
const QUERIES = {
    ...
    "upsertUserNotificationTypeChannel": sql`INSERT INTO user_notification_type_channel ( user_id, type, channel, enabled ) VALUES ( ?, ?, ?, ? ) ON CONFLICT ( user_id, type, channel ) DO UPDATE SET enabled = EXCLUDED.enabled`.prepare(),
};
...
export default class extends Component {
    ...
    async setUserNotificationTypeChannelEnabled ( userId, type, channel, enabled ) {
