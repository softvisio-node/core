...
export default class extends Component {
    ...
    get internalChannelEnabled () {
        return this.#internalChannelEnabled;
    }
    ...
    get emailChannelEnabled () {
        return this.#emailChannelEnabled;
    }
    ...
    get telegramChannelEnabled () {
        return this.#telegramChannelEnabled;
    }
    ...
    get pushChannelEnabled () {
        return this.#pushChannelEnabled;
    }
    ...
    async _init () {
        ...
        this.#internalChannelEnabled = this.api.config.notifications.internalChannelEnabled;

        // email notifications
        if ( this.api.config.notifications.smtp ) {
            this.#emailChannelEnabled = this.api.config.notifications.emailChannelEnabled;
        ...
        if ( this.api.config.notifications.telegramBot.apiKey ) {
            this.#telegramChannelEnabled = this.api.config.notifications.telegramChannelEnabled;
        }
        else {
            this.#telegramChannelEnabled = false;
        }

        // push notifications
        if ( this.api.config.notifications.firebase?.serviceAccount ) {
            this.#pushChannelEnabled = this.api.config.notifications.pushChannelEnabled;
        ...
        for ( const type of Object.values( this.#types ) ) {
            ...
            for ( const channel of Object.keys( this.#channels ) ) {
                ...
                channels[channel].enabled ??= this[channel + "ChannelEnabled"];
        ...
        if ( !enabledChannels.internal ) this.#internalChannelEnabled = false;
        if ( !enabledChannels.email ) this.#emailChannelEnabled = false;
        if ( !enabledChannels.telegram ) this.#telegramChannelEnabled = false;
        if ( !enabledChannels.push ) this.#pushChannelEnabled = false;

        this.#hasEnabledNotifications = this.#internalChannelEnabled || this.#emailChannelEnabled || this.#telegramChannelEnabled || this.#pushChannelEnabled;
