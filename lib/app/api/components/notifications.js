...
export default class extends Component {
    ...
    async _init () {
        ...
        this.#internalNotificationsEnabled = this.api.config.notifications.internalChannelEnabled;

        // email notifications
        if ( this.api.config.notifications.smtp ) {
            this.#emailNotificationsEnabled = this.api.config.notifications.emailChannelEnabled;
        ...
        if ( this.api.config.notifications.telegramBot.apiKey ) {
            this.#telegramNotificationsEnabled = this.api.config.notifications.telegramChannelEnabled;
        }
        else {
        ...
        if ( this.api.config.notifications.firebase?.serviceAccount ) {
            this.#pushNotificationsEnabled = this.api.config.notifications.pushChannelEnabled;
