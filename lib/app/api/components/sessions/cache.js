...
export default class extends Component {
    ...
    // protected
    async _init () {
        this.#userTokensCache = new CacheLru( { "maxSize": this.api.config.tokensCacheMaxSize } );

        this.#userSessionsCache = new CacheLru( { "maxSize": this.api.config.sessionsCacheMaxSize } );
