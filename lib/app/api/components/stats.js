...
export default class extends Component {
    ...
    // protected
    async _init () {
        setInterval( this.#insertApiCalls.bind( this, true ), insertApiCallsInterval );

        setInterval( this.#updateLastUsedStats.bind( this, true ), updateLastUsedStatsInterval );
    ...
    async _shutDown () {
        ...
        await this.#updateLastUsedStats( true );
    }
...
` );
    ...
    async #updateLastUsedStats ( force ) {
