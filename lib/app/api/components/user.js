...
const QUERIES = {
    ...
    "setTelegramUsername": sql`UPDATE "user" SET telegram_username = ? WHERE id = ? AND NOT EXISTS ( SELECT FROM "user" WHERE telegram_username = ? ) RETURNING telegram_user_id`.prepare(),
...
export default class extends Component {
    ...
    async setTelegramUsername ( userId, telegramUsername, { dbh } = {} ) {
        ...
        const res = await dbh.selectRow( QUERIES.setTelegramUsername, [telegramUsername, userId, telegramUsername] );
