...
const QUERIES = {
    ...
    "setTelegramUsername": sql`UPDATE "user" SET telegram_username = ?, telegram_user_id = ( SELECT id FROM telegram_user WHERE name = ? ) WHERE id = ? ON CONFLICT ( telegram_username ) DO NOTTHING RETURNING telehram_user_id`.prepare(),
...
export default class extends Component {
    ...
    async setTelegramUsername ( userId, telegramUsername, { dbh } = {} ) {
        ...
        const res = await dbh.selectRow( QUERIES.setTelegramUsername, [telegramUsername, telegramUsername, userId] );
