...
export default class extends Component {
    ...
    async setUserEmail ( userId, email, { dbh } = {} ) {
        ...
        // change user email
        res = await dbh.do( SQL.setUserEmail, [email, userId, email] );
    ...
    async setTelegramUsername ( userId, telegramUsername, { dbh } = {} ) {
        ...
        const res = await dbh.selectRow( SQL.setTelegramUsername, [telegramUsername, userId, telegramUsername] );
...
`
    ...
    async setUserLocale ( userId, locale, { dbh } = {} ) {
        ...
        const res = await dbh.do( SQL.setUserLocale, [locale, userId] );
