...
export default class extends Component {
    ...
    async getUserSessionById ( tokenId, { dbh } = {} ) {
        ...
        const res = await dbh.selectRow( QUERIES.getUserSessionById, [tokenId] );
    ...
    #onUserDelete ( data ) {
        ...
        this.api.frontend?.closeUserConnections( data.id, result( 4401 ) );
    }
    ...
    #onUserTokenDelete ( data ) {
        ...
        this.api.frontend?.closeTokenConnections( constants.tokenTypeUserToken, data.id, result( 4401 ) );
    }
    ...
    #onUserSessionDelete ( data ) {
        ...
        this.api.frontend?.closeTokenConnections( constants.tokenTypeUserSession, data.id, result( 4401 ) );
    }
