    ...
    constructor ( { server, ws, options, incomingEvents, outgoingEvents, publishRemoteIncomingEvent } ) {
        ...
        if ( this.api.isApi ) {
            ...
            // telegram bot user
                ...
                this.#sessionStateEvents.on( `telegram-bot/${ this.ctx.telegramBot.id }/user/${ this.ctx.telegramBotUser }/disable`, this.#onSessionDisable.bind( this ) );

                // telegram bot user unsubscribed
                this.#sessionStateEvents.on( `telegram-bot/${ this.ctx.telegramBot.id }/user/${ this.ctx.telegramBotUser }/unsubscribe`, this.#onSessionDisable.bind( this ) );

                // telegram bot user api user update
                this.#sessionStateEvents.on( `telegram-bot/${ this.ctx.telegramBot.id }/user/${ this.ctx.telegramBotUser }/api-user/update`, this.#onSessionDisable.bind( this ) );
            }
        }
    }
