...
export default class Context {
    ...
    async #call ( methodId, args, isVoidCall ) {
        ...
        try {
            ...
            // call method
            res = await api.app.monitoring.monitorCall( api.isApi ? "api" : "rpc", method.id, method.object[method.apiName].bind( method.object, ctx, ...args ) );
        }
        catch ( e ) {
            res = e;
        }
        ...
        // finish call
        await frontend.endApiCall( callDescriptor );
