...
export default class Context {
    ...
    async #call1 ( methodId, args, isVoidCall ) {
        ...
        try {
            ...
            method = api.frontend.schema.methods[methodId];
            ...
            if ( api.isApi ) {
                ...
                // too many calls
                if ( stats.userActiveCalls[statsUserId] >= totalMaxActiveCalls ) return result( -32802 );

                stats.methodActiveCalls[method.id] ||= {};

                // too many calls
                if ( stats.methodActiveCalls[method.id][statsUserId] >= methodMaxActiveCalls ) return result( -32802 );
