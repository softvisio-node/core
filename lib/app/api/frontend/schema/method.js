...
export default class {
    ...
    setSpec ( spec ) {
        ...
        if ( spec.roles ) this.#roles = spec.roles;
        ...
        if ( "activeRequestsLimit" in spec ) this.#activeRequestsLimit = spec.activeRequestsLimit;
        if ( "activeRequestsUserLimit" in spec ) this.#activeRequestsUserLimit = spec.activeRequestsUserLimit;
