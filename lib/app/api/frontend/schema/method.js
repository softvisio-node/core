...
import { kebabToCamelCase } from "#lib/utils/naming-conventions";
...
export default class {
    ...
    #maxActiveCallsPerGuest;
    #maxActiveCallsPerUser;
    ...
    get maxActiveCallsPerGuest () {
        return this.#maxActiveCallsPerGuest;
    }

    get maxActiveCallsPerUser () {
        return this.#maxActiveCallsPerUser;
    }
    ...
    setSpec ( spec ) {
        ...
        if ( "maxActiveCallsPerGuest" in spec ) {
            this.#maxActiveCallsPerGuest = spec.maxActiveCallsPerGuest;
        }

        if ( "maxActiveCallsPerUser" in spec ) {
            this.#maxActiveCallsPerUser = spec.maxActiveCallsPerUser;
        }
