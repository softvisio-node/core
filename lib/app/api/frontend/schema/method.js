...
export default class {
    ...
    get mmaxActiveCallsPerSession () {
        return this.#maxActiveCallsPerSession;
    }
    ...
    setSpec ( spec ) {
        ...
        if ( "maxActiveCallsPerSession" in spec ) {
            this.#maxActiveCallsPerSession = spec.maxActiveCallsPerSession;
        }
        else {
            this.#maxActiveCallsPerSession ||= 1;
        }
