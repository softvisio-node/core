...
export default class ApiMethod {
    ...
    get maxActiveCallsPerClient () {
        return this.#maxActiveCallsPerClient;
    }
    ...
    setSpec ( spec ) {
        ...
        if ( "maxActiveCallsPerClient" in spec ) {
            this.#maxActiveCallsPerClient = spec.maxActiveCallsPerClient;
        }
        this.#maxActiveCallsPerClient ||= 1;
