export default class Context {
    ...
    get isUserSessionToken () {
        return this.#auth.token?.isUserSessionToken;
    }
    ...
    async #call ( methodId, args, isVoid ) {
        ...
        if ( method.trustedSessionRequired && this.#auth.token.isUserSessionToken ) {
            const res = await this.api.checkTrustedSession( this.#auth.token.id, this.data.remoteAddress, this.data.userAgent );
