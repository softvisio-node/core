export default class Context {
    ...
    async #call ( methodId, args, isVoid ) {
        ...
        if ( checkObjectPermisisonsIds ) {
            for ( const [objectId, objectResolver] of Object.entries( checkObjectPermisisonsIds ) ) {
                if ( !( await this.api.checkObjectPermissions( objectId, objectResolver, this.userId, methodId ) ) ) {
