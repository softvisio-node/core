...
export default class {
    ...
    async endApiCall ( callDescriptor, res ) {
        if ( callDescriptor.log ) {
            ...
            if ( callDescriptor.startDate ) {
                await this.#log.logApiCall( callDescriptor.methodId, callDescriptor.startDate, callDescriptor.endDate, res );
            }
        }
        ...
        if ( this.#isShuttingDown && !this.#activeApiCalls ) {
