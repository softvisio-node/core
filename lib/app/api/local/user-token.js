    ...
    class extends Super {
            ...
            async _authenticateUserToken ( privateToken ) {
                ...
                return {
                    ...
                    "permissions": this.mergeUserPermissions( res.data.user_permissions, res.data.token_permissions ),
                };
            }
            ...
            async createUserToken ( userId, name, enabled, permissions = {}, options = {} ) {
                ...
                res = await dbh.begin( async dbh => {
                    ...
                    return result( 200, {
                        ...
                        "permissions": this.mergeUserPermissions( user.data.permissions, permissions ),
                    } );
                } );
            ...
            async getUserToken ( tokenId, options = {} ) {
                ...
                ( token.data.permissions = this.mergeUserPermissions( token.data.user_permissions, token.data.permissions ) ), delete token.data.user_permissions;
            ...
            async getUserTokens ( userId, options ) {
                ...
                if ( tokens.data ) {
                    for ( const token of tokens.data ) {
                        ( token.permissions = this.mergeUserPermissions( token.user_permissions, token.permissions ) ), delete token.user_permissions;
                    }
                }
