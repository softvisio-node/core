...
const QUERIES = {
    "getObjectUserRole": sql`SELECT role FROM object_user WHERE user_id = ? AND object_id = ?`.prepare(),
...
export default Super =>
    class extends ( Super || Object ) {
        ...
        async getObjectUsers ( objectId ) {
            ...
            const res = await this.dbh.select( QUERIES.getObjectsUsers, ["?d=" + this.defaultGravatarImage, this.defaultGravatarUrl, objectId] );
