...
export default Super =>
    class extends ( Super || Object ) {
        ...
        async checkObjectPermissions ( objectId, objectResolverType, userId, methodId ) {
            ...
            return this.#types[type]?.roles?.[role]?.permissions?.[methodId];
        }
        ...
        async getObjectUserRole ( objectId, userId ) {
            ...
            // role is invalid
            if ( !this.#types[objectType].roles[role] ) return;
        ...
        async getObjectUsers ( objectId ) {
            ...
            if ( res.data ) {
                const roles = this.#types[objectType].roles;
        ...
        async getObjectRoles ( objectId ) {
            ...
            return result( 200, Object.values( this.#types[objectType].roles ) );
        }
