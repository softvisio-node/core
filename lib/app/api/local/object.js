...
class ObjectPermissionsCache {
    ...
    constructor ( app, cacheSize ) {
        ...
        app.on( "api/object-permissions-cache/invalidate", this.invalidate.bind( this ) );
    }
...
module.exports = Super =>
    class extends ( Super || Object ) {
        ...
        async $init ( options ) {
            this.#cache = new ObjectPermissionsCache( this.app, CACHE_SIZE );
        ...
        async #setObjectPermissions ( objectId, userId, permissions, options = {} ) {
            ...
            // drop cache
            this.app.publish( "#api/api/object-permissions-cache/invalidate", cacheId );
