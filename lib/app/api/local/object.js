...
module.exports = Super =>
    class extends ( Super || Object ) {
        ...
        async $init ( options ) {
            this.#cache = new ObjectPermissionsCache( this, CACHE_SIZE );
        ...
        async #init ( objects ) {
            ...
            // setup dbh events
            await this.dbh.on( "event/api/object-permissions-cache/invalidate", cacheId => this.#cache.invalidate( cacheId ) );
            this.dbh.on( "unsubscribe", () => this.#cache.invalidateAll() );
