...
BEGIN
    PERFORM pg_notify( 'api/user-email/update', json_build_object( 'user_id', NEW.id::text )::text );
...
BEGIN
    ...
    PERFORM pg_notify( 'api/user-telegram-username/update', json_build_object( 'user_id', NEW.id::text )::text );
