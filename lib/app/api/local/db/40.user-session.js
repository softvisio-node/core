...
CREATE TABLE user_trusted_session (
    id int8 PRIMARY KEY REFERENCES user_session ( id ) ON DELETE CASCADE,
    created timestamptz NOT NULL DEFAULT CURRENT_TIMESTAMP,
    expires timestamptz NOT NULL,
...
BEGIN
    PERFORM pg_notify( 'api/invalidate-user-token', json_build_object(
        'token_type', ${constants.tokenTypeUserSession},
        'token_id', OLD.id::text
    )::text );
