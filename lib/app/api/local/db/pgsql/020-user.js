...
-- USER ID
CREATE SEQUENCE IF NOT EXISTS "user_id_seq" AS INT8 INCREMENT BY 1 MINVALUE 1 MAXVALUE 36028797018963967 NO CYCLE;

CREATE OR REPLACE FUNCTION gen_user_id(_type INTEGER) RETURNS INT8 VOLATILE STRICT AS $$
BEGIN
    RETURN (SELECT OVERLAY(nextval('user_id_seq')::bit(64) PLACING _type::bit(8) FROM 2)::int8);
END;
$$ LANGUAGE "plpgsql";

-- USER
CREATE TABLE "user" (
    "id" INT8 PRIMARY KEY NOT NULL DEFAULT gen_user_id(${CONST.TOKEN_TYPE_PASSWORD}),
