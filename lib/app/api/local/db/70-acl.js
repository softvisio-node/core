...
CREATE FUNCTION gen_acl_object_id( _type text ) RETURNS int8 AS $$
DECLARE
    _id int8;
BEGIN
    INSERT INTO acl_registry ( acl_type_id ) VALUES ( ( SELECT id FROM acl_type WHERE type = _type ) ) RETURNING id INTO _id;
