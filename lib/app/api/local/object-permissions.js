                    ...
                    if ( res.data ) {
                        ...
                        if ( this.#permissions[res.data.type] ) {
                            for ( const group in res.data.groups ) {
                                ...
                                objectPermissions.groups[group] = res.data.permissions[group];

                                // skip disabled groups
                                if ( !res.data.permissions[group] ) continue;

                                // add group permissions
                                objectPermissions.permissions = {
                                    ...objectPermissions.permissions,
                                    ...this.#permissions[res.data.type].groups[group].permissions,
                                };
                            }
                        }
                    }
