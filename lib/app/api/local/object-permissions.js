...
module.exports = mixin( Super =>
    class extends Super {
            ...
            async #setObjectUserGroups ( userId, objectType, objectGuid, groups, options = {} ) {
            ...
            async setObjectUserGroups ( userId, objectType, objectGuid, groups, options ) {
                ...
                return this.#setObjectUserGroups( userId, objectType, objectGuid, groups, options );
            }

            async updateObjectUserGroups ( userId, objectType, objectGuid, groups, options ) {
