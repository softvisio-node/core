    ...
    class extends Super {
            ...
            async #init ( permissions ) {
                ...
                for ( const id in permissions ) {
                    ...
                    if ( objectId in this.#objectId ) return result( [400, `Object id "${objectId}" is not unique`] );
                    if ( objectType in this.#objectType ) return result( [400, `Object type "${objectType}" is not unique`] );

                    this.#objectId[objectId] = objectType;
                    this.#objectType[objectType] = objectId;
            ...
            #getObjectType ( objectId ) {
                objectId = Number( BigInt( objectId ) >> 55n );
            ...
            getObjectId ( objectType ) {
                if ( !this.#objectType[objectType] ) throw `Object type is invalid`;
