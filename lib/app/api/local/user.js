    ...
    class extends Super {
            ...
            async _getUser ( userId ) {
                ...
                if ( typeof userId === "number" ) {
                    res = await this.#dbh.selectRow( q.getUserById, [userId] );
                }
                else {
                    res = await this.#dbh.selectRow( q.getUserByName, [userId] );
                }
            ...
            // XXX is username is email - return user already exists
            async createUser ( username, password, enabled, permissions, fields ) {
                ...
                if ( password == null || password === "" ) {
                    password = toBase58( crypto.randomBytes( 16 ) );
                }
            ...
            // TBD invalidate all user sessions on password change???
