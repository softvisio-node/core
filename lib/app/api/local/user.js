...
module.exports = mixin( Super =>
    class extends Super {
            ...
            async setUserPermissions ( userId, permissions, options = {} ) {
                ...
                res = await dbh.do( QUERIES.updatePermissions, [sql.json( permissions ), userId] );
            ...
            async updateUserPermissions ( userId, permissions, options = {} ) {
                ...
                res = await dbh.do( QUERIES.updatePermissions, [sql.json( permissions ), user.data.id] );
            ...
            #generatePassword () {
                return toBase64u( crypto.randomBytes( 16 ) );
            }
