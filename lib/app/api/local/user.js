...
const QUERIES = {
    ...
    "authUser": sql`SELECT "user"."id", "user"."permissions", "user_hash"."hash" FROM "user" LEFT JOIN "user_hash" ON "user"."id" = "user_hash"."id" WHERE "user"."name" = ? AND "user"."enabled" = TRUE`.prepare(),
