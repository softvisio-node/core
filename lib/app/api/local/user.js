    ...
    class extends Super {
            ...
            async createUser ( username, password, enabled, permissions, fields, options = {} ) {
                ...
                for ( const permission in permissions ) {
                    const res = this.validateUserPermissionName( permission );
            ...
            async setUserPermissions ( userId, permissions, options = {} ) {
                ...
                var res = await dbh.do( QUERIES.updatePermissions, [sql.JSON( permissions ), userId] );
            ...
            async updateUserPermissions ( userId, permissions, options = {} ) {
                ...
                var res = await dbh.do( QUERIES.updatePermissions, [sql.JSON( permissions ), user.data.id] );
