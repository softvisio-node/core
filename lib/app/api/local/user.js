    ...
    class extends Super {
            ...
            async createUser ( username, password, enabled, permissions, fields, options = {} ) {
                ...
                const user = await dbh.begin( async dbh => {
                    ...
                    // insert user hash
                    res = await dbh.do( QUERIES.upsertHash, [fields.guid, hash.data, hash.data] );
            ...
            async setUserName ( userId, username, password, options = {} ) {
                ...
                const res = await dbh.begin( async dbh => {
                    ...
                    // update user hash
                    res = await dbh.do( QUERIES.upsertHash, [user.data.guid, hash.data, hash.data] );
            ...
            async setUserPassword ( userId, password, options = {} ) {
                ...
                const res = await dbh.do( QUERIES.upsertHash, [user.data.guid, hash.data, hash.data] );
