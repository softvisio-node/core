...
module.exports = Super =>
    class extends ( Super || Object ) {
        ...
        async setUserName ( userId, username, password, options = {} ) {
            ...
            if ( res.ok ) this.app.emit( "@api/api/auth-cache/invalidate/user", user.data.id );
        ...
        async setUserPassword ( userId, password, options = {} ) {
            ...
            if ( !res.ok ) {
                ...
                this.app.emit( "@api/api/auth-cache/invalidate/user", user.data.name );
        ...
        async setUserEnabled ( userId, enabled, options = {} ) {
            ...
            if ( !res.ok ) {
                ...
                this.app.emit( "@api/api/auth-cache/invalidate/user", user.data.id );
        ...
        async removeUser ( userId, options = {} ) {
            ...
            if ( !res.ok ) {
                ...
                this.app.emit( "@api/api/auth-cache/invalidate/user", userId );
