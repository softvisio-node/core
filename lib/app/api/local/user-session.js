...
const QUERIES = {
    ...
    "insertSession": sql`INSERT INTO user_session ( user_id, device_id, expires, user_agent, remote_address ) VALUES ( ?, ?, ?, ?, ? ) RETURNING id`.prepare(),
    ...
    class extends ( Super || Object ) {
        ...
        async createUserSession ( userId, { deviceId, userAgent, remoteAddress, dbh } = {} ) {
            ...
            var res = await dbh.begin( async dbh => {
                ...
                // insert session
                let res = await dbh.selectRow( QUERIES.insertSession, [userId, deviceId, expires, userAgent, remoteAddress] );
