...
const QUERIES = {
    "auth": sql`
        ...
        WHERE
            ...
            AND user_session.id = user_session_key_hash.user_session_key_id
    ...
    "insertToken": sql`INSERT INTO user_session ( user_id, expires ) VALUES ( ?, ? ) RETURNING id`.prepare(),
    ...
    class extends ( Super || Object ) {
        ...
        async createUserSession ( userId, options = {} ) {
            ...
            var res = await dbh.begin( async dbh => {
                ...
                // insert token
                let res = await dbh.selectRow( QUERIES.insertToken, [userId, expires] );
