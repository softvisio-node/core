...
export default Super =>
    class extends ( Super || Object ) {
        ...
        // public
        async checkObjectPermissions ( objectId, objectResolverType, userId, method ) {
            ...
            enabled = this.#matchPermissions( methodId, typeSpec.basePermissions );
            ...
            for ( const role of user.roles ) {
                ...
                if ( enabled ) {
                    ...
                    enabled = this.#matchPermissions( methodId, roleSpec.permissions );
        ...
        #matchPermissions ( method, permissions ) {
            ...
            const namespace = method.substring( method.lastIndexOf( "/" ) + 1 );
            ...
            for ( const permission of permissions ) {
                if ( permission.endsWith( "/" ) ) {
                    ...
                    if ( permission.substring( 0, permission.length - 1 ) === namespace ) return true;
                }
                else {
