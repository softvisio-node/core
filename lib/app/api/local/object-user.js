...
export default Super =>
    class extends ( Super || Object ) {
        ...
        async checkObjectPermissions ( objectId, objectResolverType, userId, methodId ) {
            ...
            enabled = this.#matchPermissions( methodId, typeSpec.enabledPermissions );
            ...
            for ( const role of user.roles ) {
                ...
                enabled = !this.#matchPermissions( methodId, roleSpec.disabledPermissions );
        ...
        async #init ( objects ) {
            if ( objects.types ) {
                ...
                for ( const [type, spec] of Object.entries( objects.types ) ) {
                    ...
                    this.#types[type] = {
                        "enabledPermissions": spec.enabledPermissions,
                        "permissionsCache": {},
                        "roles": spec.roles,
                    };
                }
