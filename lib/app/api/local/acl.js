    ...
    class extends ( Super || Object ) {
        ...
        async #init ( acl ) {
            ...
            // pre-calc permissions
            {
                ...
                for ( const idType in this.#types ) {
                    for ( const aclType in this.#types ) {
                        if ( !this.#types[aclType].roles ) continue;

                        for ( const role in this.#types[aclType].roles ) {
                            const id = `${idType}/${aclType}/${role}`;
                            ...
                            for ( const method of Object.values( this.schema.methods ) ) {
                                ...
                                if ( ( method.aclTypes.has( "acl" ) && this.#types[idType].roles ) || method.aclTypes.has( idType ) ) {
