export default class {
    ...
    update ( data ) {
        ...
        if ( "locale" in data ) {
            this.#locale = this.app.locales.getValidLocale( data.locale );
        }

        if ( "gravatar" in data ) this.#avatar = `https://s.gravatar.com/avatar/${data.gravatar}?d=${this.app.locales.defaultGravatarEncoded}`;
