...
module.exports = class extends mix( User, UserActionToken, UserObjectPermissions, UserSession, UserToken, AppSettings, ApiCallLog, EventEmitter ) {
    #dbh;
    ...
    async init ( options = {} ) {
        ...
        await this.#dbh.loadSchema( __dirname + "/local/db/" + ( this.#dbh.isSqlite ? "sqlite" : "postgresql" ), "api" );
