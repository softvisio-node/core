...
export default Super =>
    class extends mixins( UserPermissions, User, UserActionToken, ObjectMixin, UserSession, UserToken, Settings, ApiCallLog, HealthCheck, APISchema, Super ) {
        #dbh;
        ...
        async _init ( options = {} ) {
            ...
            res = await this.createUser( CONST.ROOT_USER_NAME, password, true, null, this.app.env.root );
