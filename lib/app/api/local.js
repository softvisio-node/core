...
import ObjectRolesMixin from "./local/object-roles.js";
...
export default Super =>
    class extends mixins( UserPermissions, User, UserActionToken, ObjectRolesMixin, UserSession, UserToken, ApiCallLog, HealthCheck, ApiSchema, Super ) {
        #dbh;
