...
import UserApiKeys from "./local/user-api-keys.js";
...
export default Super =>
    class extends mixins( ApiSchema, UserRoles, User, UserActionToken, AclMixin, UserSession, UserApiKeys, ApiCallLog, HealthCheck, Super ) {
        #dbh;
        ...
        async authenticate ( token ) {
            if ( token.type === constants.tokenTypeUserCredentials ) {
                ...
                return this._authenticateUserApiKey( token );
            }
