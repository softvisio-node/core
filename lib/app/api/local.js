...
const Permissions = require( "./local/permissions" );
...
module.exports = class extends mix( Permissions, User, UserActionToken, UserObjectPermissions, UserSession, UserToken, AppSettings, ApiCallLog, EventEmitter ) {
    #dbh;
