...
const ApiLog = require( "./local/api-log" );

module.exports = class extends mix( User, UserActionToken, UserObjectPermissions, UserSession, UserToken, AppSettings, ApiLog, EventEmitter ) {
    #dbh;
