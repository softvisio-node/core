...
const QUERIES = {
    "logApiCall": sql`INSERT INTO "api_call_log" ("method_id", "api_version", "api_namespace", "method_name", "user_id", "connect_type", "started", "delay", "is_error", "status", "reason") VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`.prepare(),
};
