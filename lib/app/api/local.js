...
import ObjectPermissionsMixin from "./local/object-permissions.js";
...
export default Super =>
    class extends mixins( UserPermissions, User, UserActionToken, ObjectPermissionsMixin, UserSession, UserToken, ApiCallLog, HealthCheck, ApiSchema, Super ) {
        #dbh;
