...
import ObjectUserMixin from "./local/object-user.js";
...
export default Super =>
    class extends mixins( UserPermissions, User, UserActionToken, ObjectUserMixin, UserSession, UserToken, ApiCallLog, HealthCheck, ApiSchema, Super ) {
        #dbh;
