...
import Notifications from "#lib/app/api/backend/components/notifications";
...
export default class extends Events {
    ...
    async #initRootUser () {
        ...
        const rootPassword = this.api.config.root.password;

        res = await this.user.createUser(
            this.api.config.root.email,
            {
                "password": rootPassword,
                "telegram_username": this.api.config.root.telegramUsername,
            },
            { "root": true }
        );
