...
module.exports = class AuthCacheLocal {
    ...
    constructor ( app ) {
        app.on( "api/invalidate-user", this.#invalidateUser.bind( this ) );
        app.on( "api/invalidate-user-token", this.#invalidateUserToken.bind( this ) );
        app.on( "api/invalidate-all", this.#invalidateAll.bind( this ) );
