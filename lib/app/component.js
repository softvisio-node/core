...
export default class Component {
    ...
    // XXX remove
    get name () {
        console.warn( Error( `Component name will be removed` ) );
    ...
    async install () {
        try {
            ...
            // lock shut down
            if ( this._shutDown ) this.#shutDownLock = process.shutdown.lock( this.#id );
    ...
    async shutDown () {
        ...
        process.stdout.write( "Shutting down component: " + this.id + " ... " );
