export default class Component {
    ...
    constructor ( { components, name, location, required, dependencies, optionalDependencies, config, locale } ) {
    ...
    // XXX load component locale domains
    async install () {
        try {
    ...
    async _checkEnabled () {
        ...
        // all optional components are enabled by default
        return true;
    }
