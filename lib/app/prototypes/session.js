...
export default class extends Base {
    ...
    async API_signup ( ctx, fields ) {
        ...
        const res = await this.api.createUser( username, password, this.app.settings.newUserEnabled, null, fields );

        if ( res.ok ) {
            if ( this.app.settings.newUserEnabled ) {
...
`;
        ...
        return this.app.notifications.sendEmail( email, "Confirm your email", body );
    }
...
`;
        ...
        return this.app.notifications.sendEmail( email, "Reset Password", body );
    }
