...
// |==========+==========+==========================================================================|
// | ERROR    |    77:11 | @softvisio/camelcase, Identifier 'API_setEnabled' is not in camel case.  |
// |----------+----------+--------------------------------------------------------------------------|
// | ERROR    |    85:11 | @softvisio/camelcase, Identifier 'API_setPassword' is not in camel case. |
// |----------+----------+--------------------------------------------------------------------------|
// | ERROR    |    93:11 | @softvisio/camelcase, Identifier 'API_getPermissions' is not in camel    |
// |          |          | case.                                                                    |
// |----------+----------+--------------------------------------------------------------------------|
// | ERROR    |   101:11 | @softvisio/camelcase, Identifier 'API_setPermissions' is not in camel    |
// |          |          | case.                                                                    |
// |----------+----------+--------------------------------------------------------------------------|
// | ERROR    |   120:11 | @softvisio/camelcase, Identifier 'API_updatePermissions' is not in camel |
// |          |          | case.                                                                    |
// |----------+----------+--------------------------------------------------------------------------|
// | ERROR    |   149:11 | @softvisio/camelcase, Identifier 'API_setUsername' is not in camel case. |
// |----------+----------+--------------------------------------------------------------------------|
// | ERROR    |   153:11 | @softvisio/camelcase, Identifier 'API_deleteSessions' is not in camel    |
// |          |          | case.                                                                    |
// +----------+----------+--------------------------------------------------------------------------+
//
