...
export default class extends mixins( Read, Base ) {
    ...
    async API_getLatestStats ( ctx, method ) {
        return this.#getStats( TYPE_LATEST, UPDATE_INTERVAL_LATEST, method );
    }

    async API_getHistoryStats ( ctx, method ) {
        return this.#getStats( TYPE_HISTORY, UPDATE_INTERVAL_HISTORY, method );
    }

    // private
    async #getStats ( type, interval, method ) {
