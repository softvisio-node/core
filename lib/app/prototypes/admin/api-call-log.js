...
// |==========+==========+==========================================================================|
// | ERROR    |    24:11 | @softvisio/camelcase, Identifier 'API_readLog' is not in camel case.     |
// |----------+----------+--------------------------------------------------------------------------|
// | ERROR    |    36:11 | @softvisio/camelcase, Identifier 'API_readLatestStat' is not in camel    |
// |          |          | case.                                                                    |
// |----------+----------+--------------------------------------------------------------------------|
// | ERROR    |    40:11 | @softvisio/camelcase, Identifier 'API_readHistoryStat' is not in camel   |
// |          |          | case.                                                                    |
// +----------+----------+--------------------------------------------------------------------------+
//
