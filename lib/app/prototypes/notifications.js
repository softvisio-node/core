...
export default class extends mixins( Read, Base ) {
    ...
    async API_mark_read ( ctx, notifications ) {
        return this.app.notifications.markRead( ctx.userId, notifications );
    }

    async API_mark_unread ( ctx, notifications ) {
        return this.app.notifications.markUnread( ctx.userId, notifications );
    }

    async API_delete ( ctx, notifications ) {
        return this.app.notifications.delete( ctx.userId, notifications );
    }
}
