...
export default class extends Base {
    ...
    async API_setPassword ( ctx, password ) {
        ...
        if ( res.ok ) this.app.notifications.sendNotification( ctx.userId, "security", "Password changed", "Your password was changed." );
    ...
    async API_setEmail ( ctx, email ) {
        ...
        if ( res.ok ) this.app.notifications.sendNotification( ctx.userId, "security", "Email changed", "Your email address was changed." );
    ...
    async API_setTelegramUsername ( ctx, username ) {
        ...
        if ( res.ok ) this.app.notifications.sendNotification( ctx.userId, "security", "Telegram username changed", "Your telegram username was changed." );
