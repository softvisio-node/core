    ...
    class extends ( Super || Object ) {
        ...
        async _read ( ctx, mainQuery, { options, summaryQuery, dbh } = {} ) {
            ...
            if ( main.ok ) {
                ...
                // total from summary
                if ( totalRows != null ) {
                    main.meta.total_rows = totalRows;

                    main.meta.next_page = returnedRows < totalRows;
                }
