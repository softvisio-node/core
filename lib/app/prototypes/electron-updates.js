...
export default class extends mixins( Read, Base ) {
    ...
    async API_create ( ctx, file, data ) {
        ...
        res = await this.dbh.do( sql`INSERT INTO "electron_updates" ("id", "platform", "arch", "version", "version_sort") VALUES (?, ?, ?, ?, ?)`, [data.version, data.platform, data.arch, data.version, versionSort] );
...
// |==========+==========+==========================================================================|
// | ERROR    |    57:11 | @softvisio/camelcase, Identifier 'API_setPublished' is not in camel case.|
// +----------+----------+--------------------------------------------------------------------------+
//
