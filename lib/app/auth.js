...
module.exports = class Auth {
    ...
    async hasObjectPermissions ( objectGuid, permissions ) {
        return this.api.hasObjectPermissions( this.userId, objectGuid, permissions );
    }

    async call ( methodId, ...args ) {
        var res = await this._startRequest( methodId, args );
    ...
    async _startRequest ( methodId, args ) {
