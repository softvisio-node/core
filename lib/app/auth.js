...
module.exports = class AuthDescriptor {
    ...
    async call ( methodId, ...args ) {
        ...
        // validate arguments
        if ( !can.data[1].skipParamsValidation && !can.data[1].validate( args ) ) return result( [400, "Method arguments are invalid, refer to the api documentation"], can.data[1].validate.errors );
