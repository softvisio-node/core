...
module.exports = class Auth {
    ...
    async call ( methodId, ...args ) {
        ...
        // validate arguments
        if ( !can.data[1].noParamsValidation && !can.data[1].validate( args ) ) return result( [400, "Method arguments are invalid, refer to the api documentation"] );
    ...
    async callVoid ( methodId, ...args ) {
        ...
        // validate arguments
        if ( !can.data[1].noParamsValidation && !can.data[1].validate( args ) ) return;
