...
module.exports = class Auth {
    ...
    async call ( methodId, ...args ) {
        ...
        this._endRequest( started, auth, methodId, methodSpec, res );
    ...
    async _authorizeMethod ( methodId, args ) {
        ...
        if ( methodSpec.activeRequestsLimit && stat.total > methodSpec.activeRequestsLimit ) {
            ...
            this._endRequest( null, auth, methodId, methodSpec, res );
    ...
    _endRequest ( started, auth, methodId, methodSpec, res ) {
