...
export default class Notifications {
    ...
    async send ( type, users, subject, body, options ) {
    ...
    // XXX
    sendEmailNotification ( users, subject, body, options ) {}
    ...
    async #getUserNotificationsProfile ( userId ) {
        ...
        const res = await this.dbh.select( this.QUERIES.getProfile, [userId] );
