...
const ROOT_USER_ID_BIGINT = BigInt( ROOT_USER_ID );
const ROOT_USER_ID_STRING = "" + ROOT_USER_ID;
...
const Api = mixin( Super =>
    class extends Super {
            ...
            // VALIDATORS
            userIsRoot ( userId ) {
                return userId === ROOT_USER_ID_BIGINT || userId === ROOT_USER_ID_STRING || userId === ROOT_USER_ID || userId === ROOT_USER_NAME;
            }
