...
export default class Api {
    ...
    get maxApiRequestLength () {
        this.#maxApiRequestLength ??= DigitalSize.new( this.config.frontend.maxApiRequestLength ).bytes;

        return this.#maxApiRequestLength;
    }

    get maxUploadFileSize () {
        this.#maxUploadFileSize ??= DigitalSize.new( this.config.frontend.maxUploadFileSize ).bytes;
