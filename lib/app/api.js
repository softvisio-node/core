...
const ApiMixin = Super =>
    class extends ( Super || Object ) {
        ...
        async #healthCheck () {
            ...
            if ( this.#healthCheckSignal.tryLock() ) {

                // run health check
                try {
                    this.#healthCheckState = this.healthCheck();
                }
                catch ( e ) {
                ...
                this.#healthCheckSignal.unlock();

                this.#healthCheckSignal.broadcast();
            }
            else {
                await this.#healthCheckSignal.wait();
            }
