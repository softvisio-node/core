...
const Api = mixin( Super =>
    class extends Super {
            ...
            async _onWebsocketMessage ( ws, msg, isBinary ) {
                ...
                // rpc
                    ...
                    if ( msg.method ) {
                        const id = msg.id,
                            auth = ws.auth,
                            stat = this._createApiCallStat( auth, msg.method, API_CONNECT_TYPE_WEBSOCKET );
                        ...
                        // regular call
                            ...
                            if ( stat ) this._finishApiCallStat( stat, res );
                        ...
                        if ( stat ) this._logApiCallStat( stat );
                    }
                }
            }
            ...
            async _onHttpRequest ( res, req, methodId ) {
                ...
                if ( !apiRes ) {
                    ...
                    if ( !apiRes ) {
                        ...
                        stat = this._createApiCallStat( auth, methodId, apiCallMethod );
                        ...
                        if ( stat ) this._finishApiCallStat( stat, apiRes );
                    }
                }
            ...
            // XXX method "-" -> "_"
            _createApiCallStat ( auth, methodId, apiConnectType ) {
