...
module.exports = class Api extends mixins( Local, Events ) {
    ...
    constructor ( app, backend, options = {} ) {
        ...
        this.#authCache = new AuthCache( app );
    }
    ...
    async authenticate ( token ) {
        ...
        if ( !this.app.cluster.isBlocked ) auth = this.#authCache.get( token );
        ...
        if ( data ) {
            ...
            if ( !this.app.cluster.isBlocked ) this.#authCache.set( token, auth );
