...
export default class Components {
    ...
    load ( service ) {
        ...
        try {
            ...
            if ( this.service !== DEFAULT_SERVICE && !( this.service in ( this.#config.services || {} ) ) ) {
                return result( [500, `Application service "${this.service}" is not defined`] );
            }

            const colors = {},
                serviceComponents = this.#config.services?.[this.service] || {},
                components = {};
            ...
            const sort = ( componentName, required ) => {
                ...
                // process component
                    ...
                    if ( serviceComponents[componentName] !== false ) {
                        ...
                        component.appConfig = this.#config.components?.[componentName];
