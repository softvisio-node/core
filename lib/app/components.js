...
export default class Components {
    ...
    load ( service ) {
        ...
        try {
            ...
            if ( service !== "default" && !appConfig.services?.[service] ) {
                return result( [500, `Application service "${service}" is not defined`] );
            }

            const colors = {},
                components = appConfig.services?.[service] || {};
