...
export default class Components {
        ...
        try {
            ...
            const sort = ( componentName, required ) => {
                ...
                // process component
                    ...
                    const componentIsDisabled = appConfig.components?.[componentName] === false;
                    ...
                    if ( !componentIsDisabled ) {
                        ...
                        if ( required ) this.#requiredComponents.add( componentName );
    ...
    async configure () {
        ...
        for ( const component of Object.values( this.#components ).reverse() ) {
            ...
            if ( !component.isEnabled && this.#requiredComponents.has( component.name ) ) {
    ...
    async install () {
        ...
        for ( const component of Object.values( this.#components ) ) {
            ...
            if ( component.value == null ) {
                ...
                // required component must install not null value
                if ( this.#requiredComponents.has( component.name ) ) {
                    return result( [500, `Required component "${component.name}" is not installed`] );
                }
            }
            ...
            // component installed
                ...
                // check, that all component required dependencies are installed too
        ...
        console.log( `Application components:`, installedComponents.sort().join( ", " ) );
