...
export default Super =>
    ...
    class extends mixins( Read, Upload, Super ) {
        ...
        async API_create ( auth, args ) {
            return await this._upload( auth, args, this.#onUploadFinish.bind( this ), {
                "onStart": this.#onUploadStart.bind( this ),
                "onHash": this.#onUploadHash.bind( this ),
            } );
        }
