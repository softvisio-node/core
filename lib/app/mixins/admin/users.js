            ...
            async API_read ( auth, args = {} ) {
                ...
                // get all matched rows
                    ...
                    if ( args.where && args.where.search ) {
                        where.and( { "user.name": args.where.search }, sql`OR`, { "user.email": args.where.search }, sql`OR`, { "user.telegram_name": args.where.search } );
    ...
    "user"
            ...
            async API_suggest ( auth, args ) {
                ...
                if ( args && args.where && args.where.name ) {
                    where = sql`"name" LIKE %${args.where.name[1]}% OR "email" LIKE %${args.where.name[1]}% OR "telegram_name" LIKE %${args.where.name[1]}%`;
                }
