...
/** class: Users
    ...
    class extends mix( Read, Super ) {
            ...
            async API_create ( auth, fields ) {
                ...
                if ( permissions == null ) permissions = this.api.newUserPermissions;
            ...
            async API_get_permissions ( auth, userId ) {
                ...
                for ( const permission of permissions.data ) {
                    if ( auth.hasPermissions( [permission.id] ) ) permission.readonly = false;
                    else permission.readonly = true;
                }
