...
export default Super =>
    ...
    class extends ( Super || Object ) {
        ...
        get #uploadChunkSizeBase64 () {
            if ( this.#_uploadChunkSizeBase64 == null ) this.#_uploadChunkSizeBase64 = ( this.uploadChunkSize / 3 ) * 4 + 4;

            return this.#_uploadChunkSizeBase64;
        }

        // protected
        // onStart: function( upload )
        // onHash: function( upload )
            ...
            // continue upload
                ...
                if ( args.chunk ) {
                    ...
                    if ( typeof args.chunk === "string" ) {
                        if ( args.chunk.length > this.#uploadChunkSizeBase64 ) error = "Upload chunk size is invalid";

                        // decode base64
                        else {
                            try {
                                args.chunk = Buffer.from( args.chunk, "base64" );
                            }
                            catch ( e ) {
                                error = `Unable to decode chunk from base64`;
                            }
                        }
                    }
                    ...
                    // array buffer
                        ...
                        if ( args.chunk.byteLength > this.uploadChunkSize ) error = "Upload chunk size is invalid";

                        // convert ArrayBuffer to Buffer
                        else args.chunk = Buffer.from( args.chunk );
                    }
