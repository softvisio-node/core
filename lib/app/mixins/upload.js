            ...
            // continue upload
                ...
                if ( args.chunk ) {
                    ...
                    if ( typeof args.chunk === "string" ) {
                        if ( args.chunk.length > this.uploadChunkSize * 2 ) error = true;

                        // decode base64
                        else args.chunk = Buffer.from( args.chunk, "base64" );
                    }

                    // array buffer
                    else {
                        if ( args.chunk.byteLength > this.uploadChunkSize ) error = true;
