...
/** class: Session
    ...
    class extends Super {
             ...
             *     summary: Array of permissions. If null - permissions will not check.
             *     schema:
             *       type:
             *         - 'null'
             *         - array
             */
            async API_signin ( auth, credentials, allowedPermissions ) {
                ...
                if ( credentials ) {
                    ...
                    if ( allowedPermissions && !auth.hasPermissions( allowedPermissions ) ) return [200, { "is_authenticated": false }];
