...
const { TOKEN_TYPE_SESSION, TOKEN_TYPE_PASSWORD_RECOVERY } = require( "../../const" );
const q = {
...
/** class: Session
    ...
    class extends Super {
            ...
            async API_recover_password ( auth, userId ) {
                var token = await this.#api.createUserActionToken( userId, TOKEN_TYPE_PASSWORD_RECOVERY );
             ...
             * summary: Set user password using password recovery token for authentication.
             * permissions:
             * params:
             *   - name: token
             *     required: true
