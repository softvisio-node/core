    ...
    class extends Super {
            ...
            async API_signin ( auth, credentials ) {
                ...
                if ( credentials ) {
                    ...
                    const user = await this.#dbh.selectRow( sql`SELECT "id", "email", "gravatar" FROM "user" WHERE "id" = ?`, [userId] );
                ...
                // authenticated
                    ...
                    const user = await this.#dbh.selectRow( sql`SELECT "id", "email", "gravatar" FROM "user" WHERE "id" = ?`, [auth.userId] );
