...
const q = {
    "getUser": sql`SELECT "id", "guid", "name", "enabled", "permissions" FROM "user" WHERE "id" = ? OR "name" = ? OR "guid" = ?`.prepare(),
...
module.exports = mixin( ( Super ) =>
    class extends Super {
            ...
            async setUserPassword ( userId, password ) {
                ...
                res = await this.dbh.do( q.updateHash, [hash.data, user.data.guid] );
            ...
            async setUserEnabled ( userId, enabled ) {
                ...
                if ( !res.isOk() ) {
                    ...
                    this.invalidateUser( user.data.id );
            ...
            async setUserPermissions ( userId, permissions ) {
                ...
                var res = await this.dbh.do( q.updatePermissions, [sql.JSON( permissions ), user.data.id] );
