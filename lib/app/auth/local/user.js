...
module.exports = mixin( ( Super ) =>
    class extends Super {
        async userPasswordAuthenticate ( privateToken ) {
            ...
            const valid = await this.verifyPasswordHash( user.data.hash, privateToken.hash );
        ...
        async userSetPermissions ( userId, permissions ) {
            var user = await this.getUser( userId );
        ...
        async userUpdatePermissions ( userId, permissions ) {
            var user = await this.getUser( userId );
