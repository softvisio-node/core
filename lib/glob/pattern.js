...
export default class GlobPattern {
    ...
    constructor ( pattern, { prefix, caseSensitive = true, allowNegated = true, allowBraces = true, allowGlobstar = true, allowExtglob = true, matchBasename } = {} ) {
        ...
        if ( prefix ) {
            ...
            // XXX
            // prefix = Minimatch.escape( prefix, options );
        ...
        this.#minimatch = new Minimatch( this.#pattern, options );
