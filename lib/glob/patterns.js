...
export default class GlobPatterns {
    ...
    has ( pattern, { root, relativeGlobstar } = {} ) {
        ...
        return list.has( pattern, root, relativeGlobstar );
    }
    ...
    add ( patterns, { root, relativeGlobstar } = {} ) {
        ...
        for ( let pattern of patterns ) {
            ...
            list.add( pattern, root, relativeGlobstar );
        }
    ...
    delete ( patterns, { root, relativeGlobstar } = {} ) {
        ...
        for ( let pattern of patterns ) {
            ...
            list.delete( pattern, root, relativeGlobstar );
        }
    ...
    match ( string, { root } = {} ) {
        ...
        if ( !this.#ignore ) {
            ...
            if ( this.#ignored.match( string ) && !this.#ignored.match( string ) ) return true;
        }
