...
export class GlobPattern {
    ...
    constructor ( pattern, { caseSensitive, prefix, relativeGlobstar } = {} ) {
        this.#isCaseSensitive = caseSensitive == null ? true : !!caseSensitive;

        if ( !this.#isCaseSensitive ) {
            pattern = pattern.toLowerCase();
        }

        this.#pattern = this.#normalize( pattern, prefix, relativeGlobstar );
    }

    // static
    new ( pattern, { caseSensitive, prefix, relativeGlobstar } = {} ) {
    ...
    // private
    #normalize ( pattern, prefix, relativeGlobstar ) {
...
export class GlobPatternsList {
    ...
    #createPattern ( pattern, prefix, relativeGlobstar ) {
        ...
        return GlobPattern.new( pattern, { prefix, relativeGlobstar } );
    }
