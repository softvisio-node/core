...
export class GlobPattern {
    ...
    get text () {
        if ( this.#text == null ) {
            ...
            if ( this.#escapes.length ) {
                ...
                this.#text = this.#unescapedPattern.replaceAll( "\0", () => "\\" + this.#escapes[id++] );
            }
            else {
                this.#text = this.#unescapedPattern;
            }
    ...
    #compile () {
        ...
        // glob pattern
            ...
            this.#pattern = quoteMeta( this.#unescapedPattern )
            ...
            if ( this.#escapes.length ) {
                ...
                this.#pattern = this.#pattern.replaceAll( "\0", () => quoteMeta( this.#escapes[id++] ) );
            }
        }
        ...
        // static pattern
            ...
            if ( this.#escapes.length ) {
                ...
                this.#pattern = this.#pattern.replaceAll( "\0", () => this.#escapes[id++] );
            }

            this.#pattern = quoteMeta( this.#pattern );
        }

        this.#regExp = new RegExp( this.#pattern, this.#caseSensitive ? "" : "i" );
...
class GlobPatternsList {
    ...
    #compile () {
        ...
        if ( !this.hasPatterns ) {
            ...
            this.#pattern = "^(?:" + patterns.sort().join( "|" ) + ")$";
        }
