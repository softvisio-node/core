    ...
    #parse () {
        ...
        if ( !pattern ) {
            ...
            for ( let n = 0; n < this.#pattern.length; n++ ) {
                ...
                // braces separator
                else if ( char === "," && state.stack.at( -1 )?.type === "{" ) {
                ...
                // extglob start
                    ...
                    state.stack.push( { "type": "(", "quantifier": char } );
                ...
                // extglob separator
                    ...
                    // XXX check subpattern not empty
                ...
                // extglob end
                    ...
                    const quantifier = state.stack.pop().quantifier;
