...
export default class StreamSearch extends Events {
    ...
    get buffer () {
        return this.#lookbehindLength ? this.#lookbehind.slice( 0, this.#lookbehindLength ) : Buffer.alloc( 0 );
    }
    ...
    #feed ( data ) {
        ...
        if ( pos > 0 ) this.emit( "info", false, data, this.#bufpos, pos < len ? pos : len );
