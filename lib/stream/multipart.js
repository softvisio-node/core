...
export class MultipartStreamEncoder extends StreamJoiner {
    ...
    #write ( data, encoding, callback ) {
        ...
        if ( objectIsPlain( data ) ) {
            ( { headers, body, transform, name, filename } = data );
        }
        else {
            body = data;
        }
...
export class MultipartStreamDecoder extends StreamSplitter {
    ...
    async #processPart ( stream ) {
        try {
            ...
            if ( this.#lastPart ) throw "Invalid multipart data";
            ...
            if ( !chunk ) throw "Invalid multipart data";
            ...
            if ( !headers ) throw "Invalid multipart data";
