...
export default class Markdown {
    ...
    #toString ( { styles = {} } = {} ) {
        ...
        return this.toMarkdown( {
            "handlers": {
                "inlineCode": node => {
                    return this.#applyStyle( this.#prepareString( node ), styles.inlineCode );
                },

                "code": node => {
                    return `\`\`\`${ this.getCodeLanguage( node.lang )?.language || node.lang || "" }
${ this.#applyStyle( this.#prepareString( node ), styles.code ) }
\`\`\``;
                },
                ...
                "text": ( node, parent ) => {
                    return this.#applyStyle( this.#prepareString( node ) );
                },

                // italic
                "emphasis": ( node, parent, context ) => {
                    return this.#applyStyle( this.#prepareString( node ), styles.emphasis );
                },

                "strong": ( node, parent, context ) => {
                    return this.#applyStyle( this.#prepareString( node ), styles.strong );
                },

                // strikethrough
                "delete": ( node, parent ) => {
                    return this.#applyStyle( this.#prepareString( node ), styles.strikethrough );
                },
