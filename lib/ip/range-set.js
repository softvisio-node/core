    ...
    #add ( ranges ) {
        ...
        for ( let range of ranges ) {
            ...
            if ( range.isIpV4 ) {
                ...
                if ( !this.#firstAddressIpV4 || this.#firstAddressIpV4.value > range.firstAddress.value ) {
                    this.#firstAddressIpV4 = range.firstAddress;
                }

                if ( !this.#lastAddressIpV4 || this.#lastAddressIpV4.value < range.lastAddress.value ) {
                    this.#lastAddressIpV4 = range.lastAddress;
                }
            }
            else {
                ...
                if ( !this.#firstAddressIpV6 || this.#firstAddressIpV6.value > range.firstAddress.value ) {
                    this.#firstAddressIpV6 = range.firstAddress;
                }

                if ( !this.#lastAddressIpV6 || this.#lastAddressIpV6.value < range.lastAddress.value ) {
                    this.#lastAddressIpV6 = range.lastAddress;
                }
            }
        }
