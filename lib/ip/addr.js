...
export default class IPAddr {
    ...
    // static
    static new ( addr ) {
        if ( addr instanceof this ) return addr;
        ...
        if ( !this.#string ) {
            if ( this.#isV4 ) {
                ...
                if ( this.#value === 0n ) {
                    ...
                    if ( longestZero ) {
                        hextets.splice( longestZero[0], longestZero[2], longestZero[2] === 7 ? ":" : "" );
                    }
    ...
    getNextAddr () {
        ...
        if ( this.#isV4 ) return new this.constructor( this.#value + 1 );
        else return new this.constructor( this.#value + 1n );
    }
