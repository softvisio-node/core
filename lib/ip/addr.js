...
// XXX remove, after ip-num will be ported to the native BigInt
// XXX https://github.com/ip-num/ip-num/issues/59
import * as utils from "#lib/utils";
import url from "url";
import module from "module";
const BigInteger = module.createRequire( url.pathToFileURL( utils.resolve( "ip-num", import.meta.url ) ) )( "big-integer" );
