...
export default class IPRange {
    ...
    // XXX cache
    get prefix () {
        return this.#ipNumCidrRange.cidrPrefix;
    }
    ...
    toString () {
        if ( this.isCidrAble ) return this.toCidrString();
        else return this.toRangeString();
    }

    toCidrString () {
        return this.#ipNumCidrRange.toCidrString();
    }

    toRangeString () {
        return this.#ipNumRangedSet.toRangeString();
    }
