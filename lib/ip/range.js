    ...
    combine ( range ) {
        ...
        if ( this.isOverlapped( range ) || this.isConsecutive( range ) ) {
            return new this.constructor( [
                ...
                //
                this.firstAddress.value < range.firstAddress.value ? this.firstAddress : range.firstAddress,
                this.lastAddress.value > range.lastAddress.value ? this.lastAddress : range.lastAddress,
            ] );
        }
    }
}
