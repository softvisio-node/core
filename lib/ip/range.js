        ...
        // cidr or value or ip address
            ...
            if ( range instanceof IpAddress ) {
                ...
                if ( range.isIpV4 ) {
                    ...
                    else if ( Number.isNaN( prefix ) || prefix < 0 || prefix > 32 ) throw Error( PARSING_ERROR_MESSAGE );
                ...
                // v6
                    ...
                    else if ( Number.isNaN( prefix ) || prefix < 0 || prefix > 128 ) throw Error( PARSING_ERROR_MESSAGE );
