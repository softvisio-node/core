...
export default class IPRange {
        ...
        if ( range instanceof this.constructor ) {
            ...
            if ( idx > 0 ) {
                ...
                if ( addr.isV4 ) {
                    ...
                    this.#firstAddr = new IPAddr( addr.value & V4_MASK[prefix] );
                    this.#lastAddr = new IPAddr( addr.value | ~V4_MASK[prefix] );
                }
    ...
    toRangeString () {
        return this.#firstAddr + "-" + this.#lastAddr;
    }

    toCIDRString () {
        if ( this.prefix == null ) return;

        return this.#firstAddr + "/" + this.prefix;
    }
