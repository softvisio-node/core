...
export default class Table extends Events {
    ...
    constructor ( { style, width, maxWidth, header, ansi, columns, trim, wordWrap, columnWidth, margin, headerAlign, headerValign, align, valign } ) {
        super();
    ...
    #begin () {
        ...
        if ( !this.#width && this.#ended ) {
            ...
            if ( maxWidth ) maxWidth -= leftBorderWidth + rightBorderWidth + internalBorderWidth + internalBorderWidth * this.#columns.length;
