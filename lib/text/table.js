...
export default class Table {
    ...
    constructor ( { style, output, width, header, lazy, ansi, columns, trim, wordWrap, columnWidth, margin, headerAlign, headerValign, align, valign } ) {
    ...
    #addLine ( line ) {
        ...
        if ( this.#output ) this.#output.write( line + "\n" );
