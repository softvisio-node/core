...
module.exports = class Table {
     ...
     *           type: boolean
     *           default: false
     *           summary: Print rendered rows to console.
     *         ansi:
     *           type: boolean
     *           default: true
     *           summary: Alow ANSI escape characters.
     *         width:
     *           type: integer
     *           default: 80
     *           summary: Table width. If `console` set to `true` terminal width is used as default value.
     *         lazy:
     *           type: boolean
     *           default: false
     *           summary: Render table header of first row added.
     *         header:
     *           type: boolean
     *           default: true
     *           summary: Render table header.
     *         margin:
     *           type: array
     *           items:
     ...
     *           type: boolean
     *           default: false
     *           summary: Trim cell value.
     *         wordWrap:
     *           type: boolean
     *           default: true
     *           summary: Split words at spaces.
    ...
    #wrapColumn ( column, value, isHeader ) {
        ...
        for ( let line of value.split( "\n" ) ) {
            ...
            // reset ansi codes
            if ( this.#ansi && ANSI.test( line ) ) line += "\x1b[39m\x1b[22m\u001b[49m";
