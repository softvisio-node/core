...
export default class Table {
     ...
     *       type: object
     *       properties:
     *         style: { type: string, enum: [ascii, unicode, markdown, compact, borderless], default: ascii, summary: Table style. }
     ...
     *         columnWidth: { type: integer, summary: Column width. Can be overrided in column settings. }
     *         margin:
     *           type: array
     *           items:
    ...
    #wrapColumn ( column, value, isHeader ) {
        ...
        value = wrap( value, maxWidth, { "hard": true, "trim": column.trim, "wordWrap": column.wordWrap } );
