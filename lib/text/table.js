...
export default class Table {
    ...
    begin () {
        ...
        if ( this.#header && !this.#lazy ) buf += this.#renderHeader();
    ...
    add ( ...rows ) {
        ...
        if ( !this.#headerWritten ) buf += this.#renderHeader();
    ...
    #renderHeader () {
        ...
        if ( this.#headerWritten ) return buf;
        ...
        if ( this.#header ) {
            buf += this.#renderRow( this.#style.headerRow,
