...
export default class Table {
    ...
    constructor ( { style, console, width, header, lazy, ansi, columns, trim, wordWrap, columnWidth, margin, headerAlign, headerValign, align, valign } ) {
        ...
        width -= leftBorderWidth + rightBorderWidth + internalBorderWidth + internalBorderWidth * Object.values( columns ).length;

        this.#header = header ?? true;
        this.#lazy = lazy;
        this.#ansi = ansi ?? ( this.#console
        ...
        for ( const id in columns ) {
            ...
            margin = column.margin ?? margin ?? DEFAULT_MARGIN;
