...
class Bench {
    sync ( n, tests ) {
        ...
        const table = new Table( {
            ...
            "columns": {
                ...
                "duration": { "title": ansi.hl( "Duration\n(sec.)" ), "width": 15, "headerAlign": "center", "align": "right", "format": value => value.toFixed( 2 ) },
    ...
    #warm ( tests, n = 1000 ) {
        for ( const func of Object.values( tests ) ) {
            this.#run( n, func );
        }
    }
...
module.exports.bench = new Bench();
