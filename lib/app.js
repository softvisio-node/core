...
export default class App extends Events {
    ...
    async createAPI ( API, backend, options ) {
        ...
        this.#api.on( "client/connect", connectionId => this.#publishLocal( "client/connect", { connectionId, "type": "api" } ) );
        this.#api.on( "client/disconnect", connectionId => this.#publishLocal( "client/disconnect", { connectionId, "type": "api" } ) );
    ...
    async createRPC ( RPC, options ) {
        ...
        this.#rpc.on( "client/connect", connectionId => this.#publishLocal( "client/connect", { connectionId, "type": "rpc" } ) );
        this.#rpc.on( "client/disconnect", connectionId => this.#publishLocal( "client/disconnect", { connectionId, "type": "rpc" } ) );
