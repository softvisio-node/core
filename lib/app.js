...
module.exports = class extends Events {
    ...
    emit ( name, ...args ) {
        ...
        // route "api/" events to cluster
        if ( name.startsWith( "api/" ) ) {
            this.#cluster.emit( name, ...args );
        }

        // route "app/" events to cluster and all threads
        else if ( name.startsWith( "app/" ) ) {
            this.#cluster.emit( name, ...args );
        ...
        // route "users/" events to cluster and server only
        else if ( name.startsWith( "users/" ) ) {
            this.#cluster.emit( name, ...args );
        ...
        else if ( name.startsWith( "threads/" ) ) {
        ...
        // route "cluster/" events to cluster only
