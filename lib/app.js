...
export default class App {
    ...
    forwardEvent ( type, publisherId, name, msg ) {
        this.#events.emit( `${type}:${name}`, name, msg, {}, publisherId );
    }
    ...
    #publish ( source, name, args ) {
        ...
        // to api clients
            ...
            for ( const target of targets ) {
                this.#events.emit( `api:${target}/${name}`, name, args, cache );
        ...
        // to rpc clients
            ...
            this.#events.emit( `rpc:${name}`, name, args, cache );
