...
export default class App extends Events {
    ...
    async createAPI ( API, backend, options ) {
        ...
        this.#api.on( "client/connect", clientId => this.#publishLocal( "client/connect", [{ clientId, "type": "api" }] ) );
        this.#api.on( "client/disconnect", clientId => this.#publishLocal( "client/disconnect", [{ clientId, "type": "api" }] ) );
    ...
    async createRPC ( RPC, options ) {
        ...
        this.#rpc.on( "client/connect", clientId => this.#publishLocal( "client/connect", [{ clientId, "type": "rpc" }] ) );
        this.#rpc.on( "client/disconnect", clientId => this.#publishLocal( "client/disconnect", [{ clientId, "type": "rpc" }] ) );
    ...
    isClientConnected ( clientId ) {
        return ( this.#api && this.#api.isClientConnected( clientId ) ) || ( this.#rpc && this.#rpc.isClientConnected( clientId ) );
    }
