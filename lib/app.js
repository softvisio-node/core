...
module.exports = class extends EventEmitter {
    ...
    static runCli () {
        ...
        spec.options["reset-settings"] = {
            "short": false,
            "summary": `Applies application settings from the ".config.yaml".`,
            "default": false,
            "schema": {
                "type": "boolean",
            },
        ...
        spec.options["reset-root"] = {
            "short": false,
            "summary": `Sets root password from the ".config.yaml". If root password is not defined in ".config.yaml" if will be randomly generated.`,
            "default": false,
            "schema": {
                "type": "boolean",
            },
