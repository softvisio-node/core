...
export default class App extends Events {
    ...
    async run () {
        ...
        if ( privateHttpServerEnabled ) {
            ...
            if ( rpcEnabled ) this.#privateHttpServer.api( "/rpc", this.rpc );
        }
        ...
        if ( this.#privateHttpServer ) {
            ...
            res = await this.#privateHttpServer.listen( "0.0.0.0", 81 );

            if ( res.ok ) console.log( `listening on 0.0.0.0:81` );
            else console.log( `unable bind to the 0.0.0.0:81` );
