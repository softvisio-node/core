const { OBJECT_ID_APP } = require( "./const" );
...
module.exports = class extends EventEmitter {
    ...
    static runCli () {
        ...
        spec.options.devel = {
            "summary": "Runs application in development mode.",
            "default": false,
            "schema": {
                "type": "boolean",
            },
        ...
        spec.options["reset-settings"] = {
            "short": false,
            "summary": `Applies application settings from the ".env" files.`,
            "default": false,
            "schema": {
                "type": "boolean",
            },
        ...
        spec.options["reset-root"] = {
            "short": false,
            "summary": `Sets root password from the ".env" files. If root password is not defined in environment it will be randomly generated.`,
            "default": false,
            "schema": {
                "type": "boolean",
            },
