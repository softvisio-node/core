...
export default class App {
    ...
    emailIsFake ( email ) {
        return email.endsWith( constants.telegramUserDomain );
    }
    ...
    async #start () {
        ...
        const config = env.loadEnv( { "locale": this.#locale } );
        ...
        console.log( BULLET + ` Service:`, this.#components.service || "-" );
        ...
        if ( !this.#isShuttingDown ) {
            ...
            console.log( BULLET + ` Application started, pid:`, process.pid );
        }
