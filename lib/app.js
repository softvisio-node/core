    ...
    publish ( name, ...args ) {
        ...
        if ( event.group ) {
            ...
            // :users
                ...
                // to cluster group
                this.cluster.publish( event );
            }

            // :app
            else if ( event.group === "app" ) {

                // to local emitter
                this.emit( event.name, ...event.args );

                // to all threads
                this.threads.publish( event ); // to all threads
            ...
            return this.emit( event.name, ...event.args );
        }
    }
