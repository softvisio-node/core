...
export default class App {
    ...
    constructor ( location, config ) {
        ...
        this.#hub.forwardListener( this.#threads.hub, "out", "local", ( queue, name, args ) => this.#threads.publish( name, ...args ) );
    ...
    publish ( name, ...args ) {
        ...
        // global
            ...
            if ( this.#cluster ) this.#cluster.publish( "local", name, args );
        }
