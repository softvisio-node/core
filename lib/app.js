...
export default class App extends Events {
    ...
    async createApi ( Api, backend, options ) {
        ...
        this.#api.on( "client/connect", client => this.#publishLocal( "client/connect", [client, { "type": "api" }] ) );
        this.#api.on( "client/disconnect", client => this.#publishLocal( "client/disconnect", [client, { "type": "api" }] ) );
    ...
    async createRpc ( Rpc, options ) {
        ...
        this.#rpc.on( "client/connect", client => this.#publishLocal( "client/connect", [client, { "type": "rpc" }] ) );
        this.#rpc.on( "client/disconnect", client => this.#publishLocal( "client/disconnect", [client, { "type": "rpc" }] ) );
