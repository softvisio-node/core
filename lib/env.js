...
const XDG = {
    "CONFIG_HOME": process.env.XDG_CONFIG_HOME || XDG_DEFAULTS[process.platform].CONFIG_HOME,
    "DATA_HOME": process.env.XDG_DATA_HOME || XDG_DEFAULTS[process.platform].DATA_HOME,
    "CACHE_HOME": process.env.XDG_CACHE_HOME || XDG_DEFAULTS[process.platform].CACHE_HOME,
    "RUNTIME_DIR": process.env.XDG_RUNTIME_DIR || XDG_DEFAULTS[process.platform].RUNTIME_DIR,
    "CONFIG_DIRS": process.env.XDG_CONFIG_DIRS ? process.env.XDG_CONFIG_DIRS.split( PATH_SEP ) : XDG_DEFAULTS[process.platform].CONFIG_DIRS,
    "DATA_DIRS": process.env.XDG_DATA_DIRS ? process.env.XDG_DATA_DIRS.split( PATH_SEP ) : XDG_DEFAULTS[process.platform].DATA_DIRS,
};
...
class Env extends _Env {
    ...
    getXDGConfigDir ( name ) {
        return XDG.CONFIG_HOME + "/" + name;
    }

    getXDGDataDir ( name ) {
        return XDG.DATA_HOME + "/" + name;
    }

    getXDGCacheDir ( name ) {
        return XDG.CACHE_HOME + "/" + name;
    }

    getXDGRuntimeDir ( name ) {
        return XDG.RUNTIME_DIR + "/" + name;
    }
