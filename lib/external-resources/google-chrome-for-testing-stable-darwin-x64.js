...
const PRODUCT = "chrome-for-testing",
    CHANNEL = "stable",
    PLATFORM = "darwin-x64";

const ID = `c0rejs/core/resources/google-${ PRODUCT }-${ CHANNEL }-${ PLATFORM }`,
    PRODUCTS = {
...
export default class Http extends ExternalRecourceBuilder {
    ...
    async _build ( location ) {
        ...
        return result( 200, {
            onWriteEntry ( entry ) {
                if ( entry.path === "Google Chrome for Testing.app/Contents/MacOS/Google Chrome for Testing" ) {
