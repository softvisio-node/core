...
export default class TLD extends ExternalRecourceBuilder {
    ...
    async _build ( location ) {
        ...
        fs.writeFileSync( location + "/subnets.json", res.data, { "readable": true } );
    ...
    // private
    async #build () {
        const subnets = readConfig( "#resources/external-resources-sources/subnets.yaml", { "resolve": import.meta.url } );
