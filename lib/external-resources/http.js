...
export default class Http extends ExternalRecourceBuilder {
    ...
    async #build () {
        ...
        for ( const [ platform, config ] of Object.entries( UserAgent.chromePlatforms ) ) {
            data[ "chrome-" + platform ] = {
                "userAgent": UserAgent.createChromiumUserAgentString( "Chrome", platform, this.#majorVersion ),
                "http:": {
                ...
                "https:": {
                    ...
                    "Sec-CH-UA": UserAgent.createChromiumBrands( "Chrome", this.#majorVersion, false )
