...
export default class Http extends ExternalRecourceBuilder {
    ...
    async _getEtag () {
        ...
        return result( 200, JSON.stringify( this.#majorVersion ) );
    }
        ...
        for ( const [ platform, config ] of Object.entries( Browser.chromePlatforms ) ) {
            data[ platform ] = {
                ...
                "https:": {
                    "Accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7",
                    "Accept-Language": "en-US,en;q=0.9",
                    "Sec-CH-UA": `"Chrome";v="${ this.#majorVersion }", "Chromium";v="${ this.#majorVersion }", "Not_A Brand";v="24"`,
    ...
    async #getVersion () {
        ...
        this.#majorVersion = data.channels.Stable.version.match( /^(\d+)/ )[ 1 ];
