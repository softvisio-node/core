...
export default class Interval {
    ...
    #parse ( duration, unit ) {
        ...
        // number
            ...
            // float
                ...
                // XXX
                // params.nanoseconds = this.#parseFractionalUnit( duration, unit.name );
        ...
        // string
            ...
            if ( !params ) {
                ...
                for ( let n = 1; n < match.length; n += 3 ) {
                    ...
                    if ( unit.months ) {
                        params.months += Number( value ) * unit.months;
                    }
                    else {
                        params.nanoseconds += BigInt( value ) * unit.nanoseconds;
                    }
                }
    ...
    #parseUnits () {
        ...
        for ( const unit of Object.values( UNITS ) ) {
            if ( unit.skip || unit.months ) continue;
    ...
    //     while ( true ) {
    //         nanoseconds += value.trunc().multiply( UNITS[ unit ].nanoseconds ).bigint;
