    ...
    toNanoseconds () {
        if ( this.#toUnit.nanoseconds == null ) {
            ...
            for ( const name in this.#units ) {
                this.#toUnit.nanoseconds = this.#toUnit.nanoseconds.add( UNITS[ name ].nanoseconds * BigInt( this.#units[ name ] ) );
            }
        }
    ...
    #addUnit ( value, unit ) {
        ...
        if ( Number.isInteger( value ) ) {
            if ( UNITS[ unit ].months ) {
                ...
                this.#units.nanoseconds += BigInt( value ) * UNITS[ unit ].nanoseconds;
            }
        }
        else {
