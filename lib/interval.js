...
export default class Interval {
    ...
    toMicroseconds ( scale ) {
        if ( scale ) {
            return this.numericNanoseconds.divide( UNITS.microseconds.nanoseconds ).trunc( scale ).number;
        }
        else {
    ...
    toMilliseconds ( scale ) {
        if ( scale ) {
            return this.numericNanoseconds.divide( UNITS.milliseconds.nanoseconds ).trunc( scale ).number;
        }
        else {
    ...
    toSeconds ( scale ) {
        if ( scale ) {
            return this.numericNanoseconds.divide( UNITS.seconds.nanoseconds ).trunc( scale ).number;
        }
        else {
    ...
    toMinutes ( scale ) {
        if ( scale ) {
            return this.numericNanoseconds.divide( UNITS.minutes.nanoseconds ).trunc( scale ).number;
        }
        else {
    ...
    toHours ( scale ) {
        if ( scale ) {
            return this.numericNanoseconds.divide( UNITS.hours.nanoseconds ).trunc( scale ).number;
        }
        else {
    ...
    toDays ( scale ) {
        if ( scale ) {
            return this.numericNanoseconds.divide( UNITS.days.nanoseconds ).trunc( scale ).number;
        }
        else {
    ...
    toWeeks ( scale ) {
        if ( scale ) {
            return this.numericNanoseconds.divide( UNITS.weeks.nanoseconds ).trunc( scale ).number;
        }
        else {
    ...
    toMonths ( scale ) {
        if ( scale ) {
            return this.numericNanoseconds.divide( UNITS.months.nanoseconds ).trunc( scale ).number;
        }
        else {
    ...
    toQuarters ( scale ) {
        if ( scale ) {
            return this.numericNanoseconds.divide( UNITS.quarters.nanoseconds ).trunc( scale ).number;
        }
        else {
    ...
    toYears ( scale ) {
        if ( scale ) {
            return this.numericNanoseconds.divide( UNITS.years.nanoseconds ).trunc( scale ).number;
        }
        else {
