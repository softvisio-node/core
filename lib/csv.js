export default class Csv {
    ...
    constructor ( { header = true, fields, encoding } = {} ) {
        this.#header = header;
        this.#fields = fields;
    ...
    // static
    static parse ( buffer, { header, fields, encoding } = {} ) {
        const csv = new this( { header, fields, encoding } );
    ...
    static stringify ( rows, { header, fields } = {} ) {
        const csv = new this( { header, fields } );
