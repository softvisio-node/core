...
// UUID
const { bufferToUuid, uuidToBuffer } = require( "./util/uuid" );
module.exports.bufferToUuid = bufferToUuid;
module.exports.uuidToBuffer = uuidToBuffer;
 ...
 *       type: number
 */
module.exports.readChunk = async function ( stream, chunkLength ) {

    // chunk is already buffered
    if ( stream.readableLength >= chunkLength ) return stream.read( chunkLength );
    ...
    return new Promise( resolve => {
        ...
        const onReadable = function () {
            if ( stream.readableLength >= chunkLength ) {
                ...
                resolve( stream.read( chunkLength ) );
            }
        };
 ...
 *       type: object
 *       properties:
 *         eol: {summary: Line separator., type: string, default: "\n"}
 *         maxBufSize: {summary: Maximum internal buffer size., default: 65536, type: number}
 */
module.exports.readLine = async function ( stream, options = {} ) {
    ...
    return new Promise( resolve => {
        ...
        const onData = function ( data ) {
            ...
            const idx = buf.indexOf( options.eol );
...
// BASE58
module.exports.toBase58 = base58.encode;
module.exports.fromBase58 = base58.decode;
