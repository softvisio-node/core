...
class Benchmark {
    ...
    constructor ( tests, { warmingUpIterations, iterations, seconds, threads } = {} ) {
        this.#tests = tests;
    ...
    async #bench ( meta ) {
        ...
        // async, multiple threds
            ...
            if ( !meta.iterations ) throw `Iterations are required`;
...
export default async function benchmark ( tests, { warmingUpIterations, iterations, seconds, threads } = {} ) {
