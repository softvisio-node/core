...
class Benchmark {
    ...
    constructor ( title, tests, { warmingUpIterations, iterations, seconds, threads } = {} ) {
        this.#title = title;
        this.#tests = tests;
...
export default async function benchmark ( title, tests, { warmingUpIterations, iterations, seconds, threads } = {} ) {
