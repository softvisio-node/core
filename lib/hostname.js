...
import fs from "fs";
import net from "net";
import { validateDomainName } from "#lib/utils/validate";
import externalResources from "#lib/external-resources";

var LIST;

const PUBLIC_SUFFIXES = await externalResources.add( "softvisio-node/core/resources/public-suffixes", import.meta.url );
PUBLIC_SUFFIXES.on( "update", loadResources );

const TLD = await externalResources.add( "softvisio-node/core/resources/tld", import.meta.url );
TLD.on( "update", loadResources );
