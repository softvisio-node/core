...
const PUBLIC_SUFFIXES = externalResources.add( "softvisio-node/core/data/public-suffixes", import.meta.url ).on( "update", loadResources );
const TLD = externalResources.add( "softvisio-node/core/data/tld", import.meta.url ).on( "update", loadResources );
