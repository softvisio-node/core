...
const PUBLIC_SUFFIXES = externalResources.add( "softvisio-node/core/resources/public-suffixes", import.meta.url ).on( "update", loadResources );
const TLD = externalResources.add( "softvisio-node/core/resources/tld", import.meta.url ).on( "update", loadResources );
