...
export default class Locale extends Intl.Locale {
    ...
    formatFileSize ( value, format ) {
        var formatter = this.#fileSizeFormatters[format || ""];

        if ( !formatter ) {
            const parsedFormat = {
                "maximumFractionDigits": 1,
                ...this.parseFormat( format, fileSizeFormats ),
                "style": "unit",
            };
            ...
            if ( !parsedFormat.unit ) {
                ...
                for ( const threshold of fileSizeUnits ) {
            ...
            formatter = this.#fileSizeFormatters[format || ""] = new Intl.NumberFormat( this, parsedFormat );
        }
