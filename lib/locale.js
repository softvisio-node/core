...
export default class Locale {
    ...
    get hour12 () {
        return this.#dateTimeOptions?.hour12;
    }
    ...
    // private
    get #dateTimeOptions () {
        this.#_dateTimeOptions ??= new Intl.DateTimeFormat( this.intlLocale, { "dateStyle": "full", "timeStyle": "full" } ).resolvedOptions();
