...
export default class Locale extends Intl.Locale {
    ...
    formatRelativeDate ( milliseconds, format ) {
        format ||= "";
    ...
    // XXX
    formatRelativeDate1 ( duration, format ) {
        format ||= "";
        ...
        return ( relativeTimeFormatters[this.id][format] ??= new Intl.RelativeTimeFormat( this.id, this.parseFormat( format, relativeTimeFormats ) ) ).format( ...duration.getRelativeDateParams() );
    }
