...
export default class Locale extends Intl.Locale {
    ...
    formatRelativeTime ( milliseconds, format ) {
        ...
        return ( this.#relativeTimeFormatters[format] ??= new Intl.RelativeTimeFormat( this, this.parseFormat( format, relativeTimeFormats ) ) ).format( Math.round( milliseconds / timeunit[1] ), timeunit[0] );
    }
