...
export default class Locale {
    ...
    #parseOptions () {
        const dateTimeOptions = new Intl.DateTimeFormat( this.intlLocale, { "dateStyle": "full", "timeStyle": "full" } ).resolvedOptions();
        ...
        const numberParts = new Intl.NumberFormat( this.intlLocale, { "useGrouping": true } ).formatToParts( 123456789.1 );
