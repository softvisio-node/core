...
export default class Locale extends Intl.Locale {
    ...
    constructor ( locale ) {
        ...
        this.#pluralFunction = PLURAL_EXPRESSIONS[this.language];
    ...
    i18nt ( msgId, pluralMsgId, num ) {
        return new LocaleTemplate( this, msgId, pluralMsgId, num );
    }
    ...
    formatCurrency ( value, format ) {
        ...
        if ( !formatter ) {
            ...
            formatter = this.#currencyFormatters[format || ""] = new Intl.NumberFormat( this, parsedFormat );
        }
