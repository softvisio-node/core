...
// durationFormatters = {}; // XXX uncomment, when Intl.DurationFormat will be available
...
export default class Locale extends Intl.Locale {
    ...
    formatNumber ( value, format ) {
        ...
        return ( numberFormatters[this.id][format] ??= new Intl.NumberFormat( this, this.parseFormat( format, numberFormats ) ) ).format( value );
    }
    ...
    formatPercent ( value, format ) {
        ...
        if ( !formatter ) {
            ...
            formatter = percentFormatters[this.id][format] = new Intl.NumberFormat( this, parsedFormat );
        }
    ...
    formatCurrency ( value, format ) {
        ...
        if ( !formatter ) {
            ...
            formatter = currencyFormatters[this.id][formatterId] = new Intl.NumberFormat( this, parsedFormat );
        }
    ...
    formatDigitalSize ( value, format ) {
        ...
        if ( !formatter ) {
            ...
            if ( !parsedFormat.unit ) {
                ...
                formatter = digitalSizeFormatters[this.id][format] = new Intl.NumberFormat( this, parsedFormat );
            }
        }
