...
export default class Locale extends Intl.Locale {
    ...
    l10n ( msgId, plural, pluralNumber ) {
        const translation = this.#translate( msgId, plural, pluralNumber );
    ...
    #translate ( msgId, pluralMsgId, pluralNumber ) {
        ...
        // plural
        if ( pluralMsgId && typeof pluralNumber === "number" ) {
            id = pluralMsgId;
    ...
    #translateEnglish ( msgId, pluralMsgId, pluralNumber ) {
        ...
        if ( pluralMsgId && typeof pluralNumber === "number" && pluralNumber !== 1 ) {
