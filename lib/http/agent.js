...
class HTTPAgent extends http.Agent {
    ...
    createSocket ( req, options, cb ) {
        ...
        if ( this.#agent.proxy ) {
            ...
            options.updateHttpRequest = function ( update, auth ) {
                if ( update ) {
    ...
    createConnection ( options, callback ) {
        ...
        // proxied connection
        if ( this.#agent.proxy ) {
            const updateHttpRequest = options.updateHttpRequest;
            delete options.updateHttpRequest;

            this.#agent.proxy
                .connect( options, {}, updateHttpRequest )
