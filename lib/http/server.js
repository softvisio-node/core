const uws = require( "@softvisio/uws" );
const fs = require( "../fs" );
...
const DEFAULT_IDLE_TIMEOUT = 60 * 3; // 3 minutes
...
function getRealRemoteAddress ( req ) {
    return new IPAddr( Buffer.from( this.getProxiedRemoteAddressAsText() || this.getRemoteAddressAsText() ).toString() );
    ...
    //     if ( cloudflareConnectingIp && realRemoteAddress.findSubnet( "cloudflare" ) ) {
