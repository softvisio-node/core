    ...
    folder ( location, folder, options = {} ) {
        ...
        if ( location === "" ) {
            ...
            this.get( "/index.html", req => {
                req.writeStatus( 301 ).writeHeader( "Location", "/" ).end();
            } );
        }
        else {
            ...
            this.get( location, req => {
                req.writeStatus( 301 ).writeHeader( "Location", `${location}/` ).end();
            } );
        ...
        if ( process.env.NODE_ENV === "development" ) {
            this.options( `${location}/*`, req => {
                req.cork( () => {
                    ...
                    req.writeHeader( "Access-Control-Max-Age", 86400 ); // cache for 24 hours
