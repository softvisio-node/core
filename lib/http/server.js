...
export default class HttpServer {
    ...
    constructor ( options = {} ) {
        ...
        if ( options.setRealIpFrom ) {
            this.#setRealIpFrom = Array.isArray( options.setRealIpFrom ) ? options.setRealIpFrom : [ options.setRealIpFrom ];
        }
    ...
    ws ( location, { onUpgrade, createConnection, onConnect, onDisconnect, maxPayloadLength, idleTimeout, sendPingsAutomatically, compress, compression, maxBackpressure } = {} ) {
        ...
        // sends pings every idleTimeout - 2 seconds, disabled, if idleTimeout is 0
