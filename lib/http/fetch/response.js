...
export default class Response extends result.Result {
    ...
    // public
    async arrayBuffer () {
        return this.body.arrayBuffer( { "maxLength": this.#maxLength } );
    }

    async blob () {
        return this.body.blob( { "maxLength": this.#maxLength } );
    }

    async buffer () {
        return this.body.buffer( { "maxLength": this.#maxLength } );
    }
    ...
    async json () {
        return this.body.json( { "maxLength": this.#maxLength } );
    }

    async text () {
        return this.body.text( { "maxLength": this.#maxLength } );
    }
}
