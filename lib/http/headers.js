...
export default class Headers {
    ...
    add ( name, value ) {
        ...
        if ( typeof value !== "string" && name !== "set-cookie" ) value = String( value );
    ...
    createCookie ( name, value, { domain, path, expires, maxAge, secure, httpOnly, sameSite } = {} ) {
        const tokens = [];
        ...
        if ( expires ) tokens.push( `expires=${ expires }` );
