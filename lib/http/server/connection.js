...
export default class Connection {
    ...
    constructor ( ws, { minCompressionLength } = {} ) {
        this.#ws = ws;
        this.#minCompressionLength = minCompressionLength ?? DEFAULT_MIN_COMPRESSION_LENGTH;
    ...
    send ( data, isBinary, compression ) {
        ...
        this.#ws.send( data, !!isBinary, data.length >= this.#minCompressionLength );
    }
