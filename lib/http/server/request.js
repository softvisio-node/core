...
export default class Request extends Events {
    ...
    async buffer ( options ) {
        return this.stream.buffer( options );
    }

    async json ( options ) {
        return this.stream.json( options );
    }

    async text ( options ) {
        return this.stream.text( options );
    }

    async arrayBuffer ( options ) {
        return this.stream.arrayBuffer( options );
    }

    async blob ( options ) {
        return this.stream.blob( { "type": this.getHeader( "content-type" ), ...options } );
    }
