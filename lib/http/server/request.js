...
export default class Request extends Events {
    ...
    async end ( options ) {
        ...
        var status, headers, body, lastModified, eTag, compress, zlibOptions, close;
        ...
        // options is plain object
            ...
            ( { status, headers, body, lastModified, eTag, compress, zlibOptions, close } = options );
        }
        ...
        // options is result
            ...
            if ( objectIsPlain( options.data ) ) {
                ( { headers, body, lastModified, eTag, compress, zlibOptions, close } = options.data );
            }
            else {
                body = options.data;
            }
