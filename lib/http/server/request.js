...
export default class Request extends Events {
    ...
    upgrade ( context, { data, secWebSocketKey, secWebSocketProtocol, secWebSocketExtensions } = {} ) {
        secWebSocketKey ??= this.getHeader( "sec-websocket-key" );
        secWebSocketProtocol ??= this.getHeader( "sec-websocket-protocol" );
        secWebSocketExtensions ??= this.getHeader( "sec-websocket-extensions" );

        this.#res.upgrade( { data }, secWebSocketKey, secWebSocketProtocol, secWebSocketExtensions, context );
    }
