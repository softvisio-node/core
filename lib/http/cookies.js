...
export default class Cookies {
    ...
    // public
    // XXX set cookie for public suffix is not allowed
    add ( cookies, url ) {
        if ( !cookies ) return;
        ...
        for ( const cookie of cookies ) {
            ...
            if ( cookie.domain ) {
                ...
                // domain is not valid
                if ( !cookie.domain.isValid ) continue;
                ...
                if ( cookie.domain.isIp ) {
                    ...
                    // domain is invalid
                    if ( cookie.domain.ascii !== originDomain ) continue;
                }

                // the cover domain must cover (be a substring) the origin domain
                else if ( !( "." + originDomain ).endsWith( "." + cookie.domain.ascii ) ) {
                    continue;
                }
