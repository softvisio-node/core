            ...
            if ( line.startsWith( "#" ) ) {
                ...
                // other comment
                    ...
                    // XXX
                        ...
                        let comments = this.#readPoString( line.substring( 3 ).trim(), lines, prefix );

                        if ( comments ) {
                            try {
                                comments = yaml.parse( comments );
                            }
                            catch ( e ) {
                                comments = {
                                    "comments": [comments],
                            ...
                            message.extractedComments = PoFileMessage.mergeExtractedComments( message.extractedComments, comments );
                        }
                    }
                    else {
