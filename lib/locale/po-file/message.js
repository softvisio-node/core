export default class PoFileMessage {
    ...
    update ( { pluralId, references, flags, context, extractedComments } = {} ) {
        this.#pluralId ||= pluralId;

        if ( references ) this.#references = new Set( [...this.#references, ...references] );

        if ( flags ) this.#flags = new Set( [...this.#flags, ...flags] );
