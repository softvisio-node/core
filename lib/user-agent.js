...
export default class UserAgent {
    ...
    static createChromiumUserAgentString ( brand, platform, userAgentVersion ) {
        ...
        if ( brand.id === "chromium" ) {
            return `Mozilla/5.0 (${ platform.platform }) AppleWebKit/537.36 (KHTML, like Gecko) Chromium/${ majorVersion }.0.0.0${ platform.mobile
                ? " Mobile"
                : "" } Safari/537.36`;
        }
        ...
        // chrome
            ...
            return `Mozilla/5.0 (${ platform.platform }) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/${ majorVersion }.0.0.0${ platform.mobile
                ? " Mobile"
                : "" } Safari/537.36`;
        }
