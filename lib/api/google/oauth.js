...
const JWT_HEADER = util.toBase64u( Buffer.from( JSON.stringify( { "alg": "RS256", "typ": "JWT" } ) ) );
...
class GoogleOAuth {
    ...
    async getToken () {
        ...
        const jwtClaimSet = util.toBase64u( Buffer.from( JSON.stringify( {
        ...
        const jwtSignature = util.toBase64u( sign.sign( this.#pkey ) );
