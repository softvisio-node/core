...
module.exports = class GoogleSerp extends MaxThreads() {
    ...
    async _threadGetGoogleSearchResults ( keyword, options = {} ) {
        ...
        // open google
        try {
            await page.goto( `https://www.${googleDomain.domain}/`, { "waitUntil": "load" } );
        }
        catch ( e ) {
        ...
        while ( 1 ) {
            ...
            if ( !( await page.$( "div#result-stats" ) ) ) return this._onFinish( page, result( 200 ) );
