...
const googleDomain = require( "./domain" );
...
module.exports = class GoogleSerp extends MaxThreads {
    ...
    async _thread ( keyword, options = {} ) {
        ...
        if ( options.country ) {
            host = ( googleDomain.getByISO2( options.country || "" ) || googleDomain.getByISO2( "" ) ).googleDomain;
            ...
            host = googleDomain.getByISO2( "" ).googleDomain;
        }
