    ...
    async _thread ( keyword, options = {} ) {
        ...
        while ( 1 ) {
            ...
            while ( 1 ) {
                ...
                if ( ++attempt > this.#maxRetries ) return _res( [500, "Unable to get serp, max retries reached"] );
                ...
                if ( !siteKey || !datas ) return _res( [500, "Captcha params error"] );
            ...
            if ( !serp || !serp.length ) return _res( [500, "Google serp parsing error"] );
