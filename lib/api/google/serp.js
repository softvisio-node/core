...
module.exports = class GoogleSerp extends MaxThreads() {
    ...
    async _threadGetGoogleSearchResults ( keyword, options = {} ) {
        ...
        while ( 1 ) {
            ...
            while ( 1 ) {
                ...
                if ( !this.#captcha || ++attempt > this.#maxRetries ) return await this._onFinishRequest( page, result( [500, "Unable to get serp, max retries reached"] ) );
                ...
                if ( !siteKey || !datas || !callback ) return await this._onFinishRequest( page, result( [500, "Captcha params error"] ) );
    ...
    async _threadGetGoogleMapsResults ( keyword, options = {} ) {
        ...
        return await this._onFinishRequest( page, result( 200 ) );
    }
