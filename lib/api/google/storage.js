...
const DEFAULT_SCOPE = "fullControl";
...
export default class FirebaseMessaging {
    ...
    constructor ( key, { scope } = {} ) {
        this.#oauth = new Oauth( key, SCOPES[scope || DEFAULT_SCOPE] );
    }

    // properties
    get projectId () {
        return this.#oauth.projectId;
    }
    ...
    async createBucket ( bucket ) {
        return this.#request( this.apiUrl + "b", {
            "params": {
    ...
    async getBucket ( bucket ) {
        return this.#request( this.apiUrl + "b/" + encodeURIComponent( bucket ) );
    }
    ...
    async uploadFile ( path, file ) {
        ...
        return this.#request( this.uploadUrl + `b/${encodeURIComponent( bucket )}/o`, {
            "params": {
                "name": name,
                "uploadType": "media",
            },
    ...
    async getFiles ( bucket ) {
        return this.#request( this.apiUrl + `b/${encodeURIComponent( bucket )}/o` );
    }
    ...
    async getFile ( path ) {
        ...
        return this.#request( this.apiUrl + `b/${encodeURIComponent( bucket )}/o/${encodeURIComponent( name )}` );
    }
    ...
    async copyFile ( from, to ) {
        ...
        return this.#request( this.apiUrl + `b/${encodeURIComponent( from.bucket )}/o/${encodeURIComponent( from.name )}/copyTo/b/${encodeURIComponent( to.bucket )}/o/${encodeURIComponent( to.name )}`, {
            "request": {
                "method": "post",
            },
        } );
