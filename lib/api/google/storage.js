...
export default class FirebaseMessaging {
    ...
    async getBucket ( bucket ) {
        return this.#request( this.baseUrl + "b/" + encodeURIComponent( bucket ) );
    }
    ...
    async uploadFile ( path, file ) {
        ...
        return this.#request( `https://storage.googleapis.com/upload/storage/v1/b/${encodeURIComponent( bucket )}/o`, {
            "params": {
                "name": name,
                "uploadType": "media",
            },
    ...
    async getFiles ( bucket ) {
        return this.#request( this.baseUrl + `b/${encodeURIComponent( bucket )}/o` );
    }
    ...
    async getFile ( path ) {
        ...
        return this.#request( this.baseUrl + `b/${encodeURIComponent( bucket )}/o/${encodeURIComponent( name )}` );
    }
    ...
    async copyFile ( from, to ) {
        ...
        return this.#request( this.baseUrl + `b/${encodeURIComponent( from.bucket )}/o/${encodeURIComponent( from.name )}/copyTo/b/${encodeURIComponent( to.bucket )}/o/${encodeURIComponent( to.name )}`, {
            "request": {
                "method": "post",
            },
        } );
