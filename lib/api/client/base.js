...
module.exports = Super =>
    class extends ( Super || Object ) {
        ...
        #version = "v1";
        #token;
        #persistent; // keep connections persistent
        ...
        #pongInterval = 1000 * 40; // 40 seconds
        #pongClearInterval;
        ...
        constructor ( url, options = {} ) {
            ...
            this.#eventNamePrefix = options.eventNamePrefix ?? "event";

            // RPC
            this.#onRpc = options.onRpc;

            if ( this.#persistent ) this.#connect();
        }
        ...
        _onOpen () {
            if ( this.#persistent ) this.#startPong();
