...
module.exports = Super =>
    class extends ( Super || Object ) {
        ...
        #pingInterval = 1000 * 60; // 60 seconds
        #pingClearInterval;
        ...
        constructor ( url, options = {} ) {
            ...
            if ( !this.#onDemand ) this._connect();
        }
        ...
        _onOpen () {
            if ( !this.#onDemand ) this._startPing();
        ...
        _stopPing () {
            if ( this.#pingClearInterval ) clearInterval( this.#pingClearInterval );
        }
    };
