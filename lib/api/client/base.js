...
module.exports = class {
    ...
    constructor ( url, options = {} ) {
        ...
        if ( options.onOpen ) this.#emitter.on( "open", options.onOpen );
        if ( options.onClose ) this.#emitter.on( "close", options.onClose );
    ...
    _onClose ( status, reason ) {
        ...
        this.#emitter.emit( "close", result( [status, reason] ) );
    ...
    async _onMessage ( msg ) {
        ...
        // event
            ...
            this.#emitter.emit( "event/" + msg.name, ...msg.args );
        }
