...
export default class DockerEngine extends mixins( ContainersMixin, ImagesMixin, ServicesMixin, SystemMixin, Events ) {
    #_agent;
    ...
    async #request ( path, params ) {
        ...
        if ( params ) {
            for ( const name in params ) url.searchParams.set( name, params[name] );
        }
