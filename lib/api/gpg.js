                            ...
                            for ( let line of lines ) {
                                ...
                                if ( fields.type === "sec" ) {
                                    key = {
                                        ...
                                        "validity": KEY_VALIDITY[ fields.validity ],
                                        "creationDate": fields.creationDate,
                                        "expirationDate": fields.expirationDate,
                                        "fingerprint": null,
                                        "grip": null,
                                        "keyCapabilities": fields.keyCapabilities
                                            .split( "" )
                                            .map( keyCapability => KEY_CAPABILITIES[ keyCapability ] )
                                            .filter( keyCapability => keyCapability ),
                                        "fullCapabilities": [
                                ...
                                // ssb
                                    ...
                                    subkey = {
                                        ...
                                        "fingerprint": null,
                                        "grip": null,
                                        "keyCapabilities": fields.keyCapabilities.split( "" ).map( keyCapability => KEY_CAPABILITIES[ keyCapability ] ),
                                    };
