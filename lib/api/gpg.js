...
export default class Gpg {
    ...
    async encrypt ( data, recipients, { cwd, armor, compressLevel, output, sign, cacheKeys = true } = {} ) {
        const args = [];
    ...
    async sign ( data, users, { cwd, armor, compressLevel, output, encrypt, cacheKeys = true } = {} ) {
        const args = [];
    ...
    async detachSign ( data, users, { cwd, armor, compressLevel, output, cacheKeys = true } = {} ) {
        const args = [];
    ...
    async clearSign ( data, users, { cwd, compressLevel, output, cacheKeys = true } = {} ) {
        const args = [];
    ...
    // XXX
    async decrypt ( data, { cwd, output, users, cacheKeys = true } = {} ) {
        const args = [ "--decrypt" ];
    ...
    // XXX
    async verify ( data, { cwd, users, signature, cacheKeys = true } = {} ) {
        const args = [ "--verify" ];
