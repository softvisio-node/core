...
module.exports = class Majestic extends MaxThreads {
    ...
    async getAnchorText ( domain, options = {} ) {
        const params = {
            ...
            "datasource": "fresh",
            "item": domain,
            "Count": options.numAnchors || 10, // Number of results to be returned back. Def. 10, max. 1_000
            "TextMode": 0,
            "Mode": 0,
            "FilterAnchorText": null,
            "FilterAnchorTextMode": 0,
            "FilterRefDomain": null,
            "UsePrefixScan": 0,
        };

        return await this.runThread( params );
    }
