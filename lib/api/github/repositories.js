...
export default Super =>
    class extends ( Super || class {} ) {
        ...
        async getDependabotsecurityupdatesStatus ( repo ) {
        ...
        async enableDependabotsecurityupdates ( repo ) {
            return this._doRequest( "PUT", `repos/${ repo }/automated-security-fixes` );
        }

        // https://docs.github.com/en/rest/repos/repos#disable-dependabot-security-updates
        async disableDependabotsecurityupdates ( repo ) {
            return this._doRequest( "DELETE", `repos/${ repo }/automated-security-fixes` );
        }

        // https://docs.github.com/en/rest/repos/repos#check-if-private-vulnerability-reporting-is-enabled-for-a-repository
        async getPrivateVulnerabilityReportingStatus ( repo ) {
        ...
        async enablePrivateVulnerabilityReporting ( repo ) {
            return this._doRequest( "PUT", `repos/${ repo }/private-vulnerability-reporting` );
        }

        // https://docs.github.com/en/rest/repos/repos#disable-private-vulnerability-reporting-for-a-repository
        async disablePrivateVulnerabilityReporting ( repo ) {
            return this._doRequest( "DELETE", `repos/${ repo }/private-vulnerability-reporting` );
        }

        // https://docs.github.com/en/rest/repos/repos#check-if-vulnerability-alerts-are-enabled-for-a-repository
        async getVulnerabilityAlertsStatus ( repo ) {
        ...
        async enableVulnerabilityAlerts ( repo ) {
            return this._doRequest( "PUT", `repos/${ repo }/vulnerability-alerts` );
        }

        // https://docs.github.com/en/rest/repos/repos#disable-vulnerability-alerts
        async disableVulnerabilityAlerts ( repo ) {
            return this._doRequest( "DELETE", `repos/${ repo }/vulnerability-alerts` );
        }
    };
