...
export default class Smtp {
    ...
    constructor ( url, { proxy, maxThreads } = {} ) {
        ...
        this.#threadsPool = new ThreadsPool( { "maxThreads": maxThreads || DEFAULT_MAX_THREADS } );
    }
    ...
    async testSmtp () {
        return this.#threadsPool.addThread( this.#testSmtp.bind( this ) );
    }

    async sendEmail ( { to, from, replyTo, cc, bcc, subject, text, html, attachments } = {} ) {
        return this.#threadsPool.addThread( this.#sendEmail.bind( this, {
            to,
            from,
            replyTo,
            cc,
