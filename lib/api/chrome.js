...
class Chrome {
    ...
    async getTabs () {
        ...
        return json.map( tab => new Tab( this, tab ) );
    }
    ...
    async openTab ( url ) {
        ...
        return new Tab( this, json );
    }

    async closeTab ( id ) {
        return fetch( `http://${this.host}:${this.port}/json/close/` + id );
    }

    async activateTab ( id ) {
        return fetch( `http://${this.host}:${this.port}/json/activate/` + id );
    }
