...
export default class Git {
    ...
    // XXX getIndexStatus
    async getDirtyStatus () {
        const res = await this.exec( [ "status", "-z", "--short", "--untracked-files=all" ] );
        ...
        if ( !res.ok ) {
            ...
            for ( const line of res.data.split( "\0" ) ) {
                ...
                data.files[ match.groups.file ] = {
                    ...
                    "workingTree": match.groups.workingTree,
                };
