...
export default class Git {
    ...
    async getRelease ( { commit, stable } = {} ) {
            ...
            if ( stable ) {
                ...
                // commit release is pre-release
                    ...
                    if ( !data.version ) {
                        ...
                        // XXX calculate commits for pre-release commits
                    }
                }
            }
            else {
        ...
        //     // get distance from start to HEAD
        //     res = await this.exec( [ "rev-list", "--count", commit ] );
        //     if ( !res.ok ) return res;

        //     data.distance = Number( res.data.trim() );
        // }
