...
export default class Acme {
    ...
    async #updateAccountKey ( data ) {
        return this.#apiResourceRequest( "keyChange", data );
    }
    ...
    async #apiResourceRequest ( resource, data, { includeJwsKid = true, includeExternalAccountBinding = false } = {} ) {
        var res;
