...
export default class Acme {
    ...
    constructor ( { directory, accountKey, email } = {} ) {
    ...
    async #getDirectories () {
        ...
        return result( 300, this.#directories );
    }
    ...
    #createSignedBody ( url, payload = null, { nonce = null, kid = null } = {} ) {
        ...
        const signer = crypto.createSign( signerAlg ).update( `${result.protected}.${result.payload}`, "utf8" );
