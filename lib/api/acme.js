...
export default class Acme {
        ...
        for ( const domain of domains ) {
            try {
                ...
                if ( domain.startsWith( "*." ) ) {
                    ...
                    if ( !hostname.isValid || hostname.isTld || !hostname.tldIsValid ) {
                        return false;
                    }
                }
                ...
                // regular domain
                    ...
                    if ( !hostname.isValid || hostname.isTld || !hostname.tldIsValid || hostname.isPublicSuffix ) {
                        return false;
                    }
                }
            }
    ...
    async #verifyChallenge ( { type, domain, dnsTxtRecordName, httpLocation, content, dnsTtl = 60, interval = 3 } ) {
        var attempt;
        ...
        if ( type === "http-01" ) {
            ...
            attempt = Math.ceil( dnsTtl / interval ) + 10;
