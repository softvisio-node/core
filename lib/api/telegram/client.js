...
export default class TelegramClientApi {
    ...
    constructor ( apiId, apiHash, { test, storageOptions, deviceModel, appVersion } = {} ) {
        this.#apiId = apiId;
        ...
        this.#mtProto.updateInitConnectionParams( {
            "device_model": deviceModel || env.package.name,
            "app_version": appVersion || env.package.version,
        } );
    }
    ...
    async #signIn ( { phoneNumber, phoneCode, password, firstName, lastName } ) {
        ...
        // not signed in
            ...
            if ( !phoneNumber ) {
                return result( [ 401, "Phone number is invalid" ], {
            ...
            if ( !phoneCode ) {
                return result( [ 401, "Phone code is invalid" ], {
    ...
    async #checkPassword ( password ) {
        ...
        // password is is not specified
            ...
            return result( [ 401, "Password is invalid" ], {
