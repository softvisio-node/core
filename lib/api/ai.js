...
export default class AiApi {
    ...
    async getEmbedding ( model, input ) {
        return this.getApi( model ).getEmbedding( model, input, { "simple": true } );
    }

    async getCompletion ( model, prompt ) {
        return this.getApi( model ).getCompletion( model, prompt, { "simple": true } );
    }
}
