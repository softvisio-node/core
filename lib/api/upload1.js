...
export default class softvisioApiUpload {
    #api = null;
    ...
    _setStatus ( status, progress ) {
        ...
        if ( this.onProgress ) {this.onProgress( this, status, this.reason, progress );}
    ...
    _startUpload ( data, cb ) {
        ...
        res => {
            // Request error
            if ( !res.isSuccess() ) {me._onRequestError( res );}
