...
const localEvents = new Set( [ "call" ] );
...
export default class Threads {
    ...
    once ( name, listener ) {
        if ( localEvents.has( name ) ) {
            this.#localEvents.once( name, listener );
        }
        else {
    ...
    async #onMessage ( thread, msg ) {
        ...
        if ( msg.method ) {
            ...
            // rpc call
                ...
                if ( this.#localEvents.listenerCount( "call" ) ) {
                    ...
                    if ( msg.id ) {
                        ...
                        try {
                            res = await this.#localEvents.enitSync( "call", msg.method, msg.params );
                        }
                        catch ( e ) {
                            res = result.catch( e );
                        }
                    ...
                    // void call
                        ...
                        try {
                            this.#localEvents.emitSync( "call", msg.method, msg.params );
                        }
                        catch ( e ) {
                            console.log( e );
                        }
