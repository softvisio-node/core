...
// return 200;
// return [200, "OK"] - unclear, "OK" can be a reason or data???;
// return [[200, "OK"], data];
// return {status:"", reason:"", data: "..."} - invalid;
// return res(200) - return as is;
module.exports.parseRes = function () {
    try {
        if ( typeof arguments[0] === "object" && arguments[0].constructor[IS_RESULT] ) return arguments[0];

        // return [ [ 200, "OK" ], data ];
        if ( Array.isArray( arguments[0] ) && Array.isArray( arguments[0][0] ) ) {
            return new Result( arguments[0][0], arguments[0][1] );
        }
