...
export default function glob ( pattern, { cwd, files = true, directories, markDirectories, ignore, sort } = {} ) {
    const found = [];
    ...
    const allowedPatterns = new GlobPatterns().add( pattern, { "relativeGlobstar": true } ),
        ignoredPatterns = new GlobPatterns().add( ignore, { "relativeGlobstar": true } );
