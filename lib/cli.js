...
const cliSchemaValidator = new Ajv().compile( fs.config.read( __dirname + "/../resources/schemas/cli.meta.schema.yaml" ) );
...
class Cli {
    ...
    processOptions () {
        ...
        // prepare arguments
        this.args = new Arguments( spec.arguments );
        ...
        while ( argv.length > 0 ) {
            ...
            // argument
                ...
                this.args.addValue( arg );
            }
        }

        // validate arguments
        errors.push( ...this.args.validate() );
...
// |=======+===============+==============================+================================================================================|
// | ERROR | 8:7           | no-unused-vars               | 'cliSchemaValidator' is assigned a value but never used.                       |
// |-------+---------------+------------------------------+--------------------------------------------------------------------------------|
// | ERROR | 40:15         | no-undef                     | 'cliSpecValidator' is not defined.                                             |
// |-------+---------------+------------------------------+--------------------------------------------------------------------------------|
// | ERROR | 43:26         | no-undef                     | 'cliSpecValidator' is not defined.                                             |
// +-------+---------------+------------------------------+--------------------------------------------------------------------------------+
//
