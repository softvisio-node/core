...
export default class CLI {
    ...
    constructor ( object, argv, commandsStack, commandTitle ) {
        ...
        // validate cli spec
        cliSpecValidator ??= new Ajv().compile( config.read( "#resources/schemas/cli.schema.yaml", { "resolve": import.meta.url } ) );
    ...
    async #processCommands () {
        ...
        // command found
            ...
            return CLI.new( await possibleCommands.getModule(), argv, this.#commandsStack, possibleCommands.title );
        }
    }
