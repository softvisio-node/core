...
class Cli {
    ...
    // TODO hot to call command class
    processCommands () {
        var argv = this.argv,
            spec = this.spec;
    ...
    printHelp ( exitCode ) {
        ...
        if ( this.spec.commands ) {
            ...
            usage += this.options.getUsage();

            usage += this.arguments.getUsage();

            console.log( usage + "\n" );

            console.log( this.options.getHelp() );

            console.log( this.arguments.getHelp() );
        }
