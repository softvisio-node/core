...
const ajv = _ajv().addSchema( fs.config.read( "#resources/schemas/doc.meta.schema.yaml", { "resolve": __filename } ) );
...
module.exports = class {
    ...
    async generate () {
        ...
        const fileTree = fs.fileTree(),
            ejs = require( "ejs" ),
            indexTmpl = require.resolve( "#resources/tmpl/doc/index.md.ejs" ),
            classTmpl = require.resolve( "#resources/tmpl/doc/api-class.md.ejs" );
