...
module.exports = class {
    ...
    async getApiSchema ( apiPath ) {
        ...
        for ( const classId in this.#classes ) {
            ...
            let apiClass = "/" + path.relative( apiPath, namespacePath );
                ...
                if ( member.isMethod ) {
                    if ( member.params ) {
                        ...
                        for ( const param of member.params ) {
                            ...
                            param.templateSchema = param.templateSchema.replace( /^/gm, "        " );
                        }
                    }
                    else {
                        member.templateParams = "";
...
// |=======+===============+==============================+================================================================================|
// | ERROR | 68:13         | no-unused-vars               | 'indexTmpl' is assigned a value but never used.                                |
// +-------+---------------+------------------------------+--------------------------------------------------------------------------------+
//
