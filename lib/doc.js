        ...
        if ( docBlocks ) {
            for ( let docBlock of docBlocks ) {
                ...
                if ( Object.hasOwnProperty.call( spec, "function" ) ) {
                    ...
                    if ( !spec.name ) throw `Function name is not defined in module "${moduleId}"`;
                ...
                // class
                    ...
                    if ( !spec.name ) throw `Class name is not defined in module "${moduleId}"`;
                ...
                // property
                    ...
                    if ( !spec.name ) throw `Property name is not defined in module "${moduleId}"`;
                ...
                // method
                    ...
                    if ( !spec.name ) throw `Method name is not defined in module "${moduleId}"`;
