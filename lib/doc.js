...
module.exports = class {
    ...
    _processFunction ( spec ) {
        ...
        if ( this.#modules[spec.module.id].members[spec._id] ) throw `Function "${spec.name}" for module "${spec.module.id}" is already defined.`;
    ...
    _processClass ( spec ) {
        ...
        spec._id = spec.module.id + "#" + spec.name;
        spec.members = {};

        // class is already defined
        if ( this.#classes[spec._id] ) throw `Class "${spec.name}" is already defined in module "${spec.module.id}".`;
