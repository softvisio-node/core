...
export default class Browser extends Events {
    ...
    // NOTE use "standalone" option to run browser in new process, otherwise it will be attached to the already running browser
    constructor ( url, { browser, defaultBrowser, incognito, headless, app, newWindow, width, height, maximized = true, signal, userDataDir, standalone = true, chromiumSandbox, detached } = {} ) {
        super();
