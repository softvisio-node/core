...
const PREFERRED_CHROMIUM_CHANNELS = {
    "darwin": "chrome",
    "linux": "chrome",
    "win32": "msedge",
};
...
export default class Browser extends Events {
    ...
    constructor ( url, { browser, defaultBrowser, incognito, headless, app, newWindow, width, height, maximized = true, signal, userDataDir, chromiumSandbox, detached } = {} ) {
        super();
    ...
    static get preferredChromiumChannel () {
        return PREFERRED_CHROMIUM_CHANNELS[ process.platform ];
    }
    ...
    static getBrowser ( browser ) {
        if ( browser ) {
            ...
            return this.availableBrowsers[ this.preferredChromiumChannel ] || this.availableBrowsers[ this.#defaultBrowser ];
        }
    }
