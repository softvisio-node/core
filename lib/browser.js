...
const CHROME_HEADLESS_SHELL = await externalResources
        .add( `c0rejs/core/resources/google-chrome-headless-shell-stable-${ process.platform }-${ process.arch }`, {
            "autoUpdate": false,
        } )
        .check( {
            "install": false,
    ...
    CHROME_FOR_TESTING = await externalResources
        .add( `c0rejs/core/resources/google-chrome-for-testing-stable-${ process.platform }-${ process.arch }`, {
            "autoUpdate": false,
        } )
        .check( {
            "install": false,
