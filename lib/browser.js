...
export default class Browser extends Events {
    ...
    static buildChromeUserAgent ( platform, majorVersion ) {
        return `Mozilla/5.0 ${ CHROME_PLATFORMS[ platform ].platform } AppleWebKit/537.36 (KHTML, like Gecko) Chrome/${ majorVersion }.0.0.0${ CHROME_PLATFORMS[ platform ].mobile } Safari/537.36`;
    }
