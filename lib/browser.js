...
export default class Browser extends Events {
    ...
    constructor ( url, { defaultBrowser, app, newWindow, width, height, maximized = true, signal, userDataDir, detached } = {} ) {
        super();
        ...
        if ( !command ) throw Error( `No chromium compatible browser found` );
