...
const PREFERRED_BROWSERS = {
    ...
    BROWSERS = {
        ...
        "chrome-for-testing": {
            ...
            "channel": "chrome",
            "paths": {
                "darwin": CHROME_FOR_TESTING.getResourcePath( "chrome" ), // XXX invalid, require update
        ...
        "chrome-headless-shell": {
            ...
            "headless": true,
            "paths": {
                "darwin": CHROME_HEADLESS_SHELL.getResourcePath( "chrome-headless-shell" ), // XXX invalid, require update
