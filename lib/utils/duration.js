...
export default class Duration {
    ...
    addDate ( date ) {
        ...
        if ( this.#units.week ) date.setDay( date.getDay() + this.#units.week * 7 );
        if ( this.#units.day ) date.setDay( date.getDay() + this.#units.day );
        if ( this.#units.hour ) date.setHour( date.getHour() + this.#units.hour );
        if ( this.#units.minute ) date.setMinute( date.getMinute() + this.#units.minute );
        if ( this.#units.second ) date.setSecond( date.getSecond() + this.#units.second );
        if ( this.#units.millisecond ) date.setMillisecond( date.getMillisecond() + this.#units.millisecond );
