        ...
        for ( const resource of Object.values( this.#resources ) ) {
            ...
            if ( !this.#repo ) {
                ...
                if ( updated.ok ) {
                    ...
                    if ( localIndex[resource.id]?.etag === updated.data && resource.isConsistent( this ) ) {
                        updated = result( 304 );
                    }
                    else {
                        updated = await resource.updateFromSource( this );
            ...
            // update from repository
                ...
                if ( localIndex[resource.id]?.etag === remoteIndex[resource.id]?.etag && resource.isConsistent( this ) ) {
                    ...
                    updated = await resource.updateFromRepo( this );
