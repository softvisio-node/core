...
const PROTOCOL = {
    ...
    "local-pool:": "./proxy/type/local/pool",
    "local-range:": "./proxy/type/local/range",
...
module.exports = class Proxy extends Events {
    ...
    set hostname ( value ) {
        ...
        const updated = this.#hostname !== value;
    ...
    set username ( value ) {
        const updated = this.#username !== value;
    ...
    set password ( value ) {
        const updated = this.#password !== value;
