await import( "@softvisio/core" );

import Events from "./events.js";
import CondVar from "./threads/condvar.js";
import { toMsgPack, fromMsgPack } from "./msgpack.js";
import { Worker } from "worker_threads";
import os from "os";
import module from "module";

const WORKER_THREAD = module.createRequire( import.meta.url ).resolve( "./threads/worker-thread.mjs" );
        ...
        for ( const threadName in threads ) {
            ...
            for ( let n = 1; n <= num; n++ ) {
                ...
                const worker = new Worker( WORKER_THREAD, {
                    "workerData": {
                        "path": typeof thread.path === "object" ? thread.path + "" : thread.path,
