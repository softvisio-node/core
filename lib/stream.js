...
stream.Readable.prototype.tmpFile = async function ( { maxLength, ...tmpFileOptions } = {} ) {
...
stream.Readable.prototype.toFileStream = async function ( fileStreamOptions ) {
    if ( this instanceof FileStream ) {
        return this;
    }
    else {
        return new FileStream( this, fileStreamOptions );
    }
};
