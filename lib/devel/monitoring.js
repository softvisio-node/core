...
class DevelMonitoringMark {
    ...
    toString () {
        if ( !this.#toString ) {
            ...
            if ( this.#hasCpu ) {
                this.#toString += `\ncpuUserDelta: ${locale.formatNumber( this.#cpuUserDelta, "signDisplay:always" )}, cpSystemDelta: ${locale.formatNumber( this.#cpuSystemDelta, "signDisplay:always" )}`;
            }

            if ( this.#hasMemory ) {
                this.#toString += `\nmemory: ${locale.formatDigitalSize( this.#memory )}, memoryDelta: ${locale.formatDigitalSize( this.#memoryDelta, "signDisplay:always" )}`;
            }

            if ( this.#hasFs ) {
                this.#toString += `\nfile system: ${locale.formatDigitalSize( this.#fsTotal )}, freeDelta: ${locale.formatDigitalSize( this.#fsFreeDelta, "signDisplay:always" )}`;
            }
        }
