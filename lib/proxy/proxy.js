...
class Proxy {
    ...
    constructor ( url, options = {} ) {
        ...
        this.#host = options.host || url.hostname || null;
        this.#port = options.port || url.port || null;
        this.#username = options.username || url.username || null;
        this.#password = options.password || url.password || null;
