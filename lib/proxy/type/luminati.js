...
export default class ProxyClientLuminati extends mixins( OptionsZone, OptionsCountry, OptionsState, OptionsCity, OptionsResolveRemote, OptionsDirect, OptionsSession, OptionsRotating, Upstream ) {
    _init ( url, options = {} ) {
