...
export default class ProxyLuminati extends mixins( OptionsZone, OptionsCountry, OptionsState, OptionsCity, OptionsResolveRemote, OptionsDirect, OptionsSession, OptionsRotating, Upstream ) {
    $init ( url, options = {} ) {
...
ProxyLuminati.register( "luminati:", ProxyLuminati );
