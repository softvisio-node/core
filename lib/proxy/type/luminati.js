...
module.exports = class ProxyLuminati extends mixins( OptionsZone, OptionsCountry, OptionsState, OptionsCity, OptionsResolveRemote, OptionsDirect, OptionsSession, Rotating, Upstream, Proxy ) {
    $init ( url, options = {} ) {
