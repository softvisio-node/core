...
module.exports = class ProxySoftvisio extends mixins( OptionsZone, OptionsCountry, OptionsState, OptionsCity, OptionsResolveRemote, OptionsSession, Rotating, Upstream, Proxy ) {
    get isHttp () {
        return true;
    }
