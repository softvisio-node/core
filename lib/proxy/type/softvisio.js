...
export default class ProxySoftvisio extends mixins( OptionsZone, OptionsCountry, OptionsState, OptionsCity, OptionsResolveRemote, OptionsSession, OptionsRotating, Upstream ) {
    get isHttp () {
        return true;
    }
...
ProxySoftvisio.register( "softvisio:", ProxySoftvisio );
