...
const Rotating = require( "../mixins/upstream-rotating" );
const Upstream = require( "../mixins/upstream" );

module.exports = class ProxyStatic extends mixins( OptionsZone, OptionsCountry, OptionsState, OptionsCity, OptionsResolve, OptionsSession, Rotating, Upstream, Proxy ) {
    get isHttp () {
        return true;
    }
