...
module.exports = class ProxyStatic extends mixins( OptionsZone, OptionsCountry, OptionsState, OptionsCity, OptionsResolve, OptionsSession, UpstreamRotating, Proxy ) {
    get isHttp () {
        return true;
    }
    ...
    // XXX merge options, returns proxy;
