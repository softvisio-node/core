...
const OptionsRemoteAddr = require( "../mixins/remote-addr" );
const OptionsLocalAddr = require( "../mixins/local-addr" );
...
module.exports = class ProxyStatic extends mixins( OptionsCountry, OptionsRemoteAddr, OptionsLocalAddr, Proxy ) {
    #isHttp = false;
    #isSocks = false;
    ...
    async connect ( url, options = {}, updateHttpRequest ) {
        ...
        if ( resolve ) {
            hostname = await dns.resolve4( hostname );
