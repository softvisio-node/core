...
function translateDefault ( msgId, pluralMsgId, num ) {
    var translation;
...
export default class Locale {
    ...
    // static
    static translateDefault ( msgId, pluralMsgId, num ) {
        return translateDefault( msgId, pluralMsgId, num );
    }
    ...
    i18n ( msgId, pluralMsgId, num ) {
        ...
        // fallback to English
        return this.translateDefault( msgId, pluralMsgId, num );
    }
    ...
    translateDefault ( msgId, pluralMsgId, num ) {
        return translateDefault( msgId, pluralMsgId, num );
    }
