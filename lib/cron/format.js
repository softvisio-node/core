    ...
    #parseField ( fieldValue, field ) {
        ...
        for ( const range of ranges ) {
            ...
            // field is restricted
                ...
                if ( field.name === "days" ) {
                    this.#fields.daysRestricted = true;
                }
                else if ( field.name === "daysOfWeek" ) {
                    this.#fields.daysOfWeekRestricted = true;
                }
        ...
        while ( true ) {
            ...
            if ( this.#fields.daysRestricted && this.#fields.daysOfWeekRestricted ) {
                ...
                if ( !addDays ) {
                    ...
                    if ( this.#fields.daysOfWeek && !this.#fields.daysOfWeek[ date.dayOfWeek ] ) {
                        addDaysOfWeek = this.#getAddValue( date.dayOfWeek, FIELDS_INDEX.daysOfWeek );
                    }
                }
            }

            // match: days OR daysOfWeek
            else {
                ...
                if ( addDays ) {
                    ...
                    // current day of week is allowed
                    else {
                        addDays = 0;
                    }
                }
            ...
            if ( addDays || addDaysOfWeek ) {
                date = date
                    .add( {
                        "days": addDays < addDaysOfWeek ? addDays : addDaysOfWeek,
                    } )
                    .round( {
                        "smallestUnit": "days",
                        "roundingMode": "floor",
