        ...
        while ( true ) {
            ...
            if ( this.#fields.daysOfMonth ) {
                ...
                if ( !this.#fields.daysOfMonth[ date.day ] ) {
                    addDays = this.#getAddValue( date.day, FIELDS_INDEX.daysOfMonth );
                }
            }
            ...
            if ( !this.#fields.daysOfMonth || addDays ) {
                ...
                if ( this.#fields.daysOfWeek ) {
                    ...
                    // current day of week is permitted
                    ...
                    // current day of week is not permitted
                        ...
                        const addDays1 = this.#getAddValue( date.dayOfWeek, FIELDS_INDEX.daysOfWeek );

                        if ( !addDays ) {
                            addDays = addDays1;
                        }
                        else if ( addDays1 < addDays ) {
                            addDays = addDays1;
                        }
                    }
                }
