...
import Bitbucket from "#lib/api/bitbucket";
...
const CONST = {
    "repo": "softvisio/databases",
    "path": os.platform() === "win32" ? process.env.LOCALAPPDATA + "/databases/maxmind" : "/var/lib/databases/maxmind",
...
class Maxmind {
    ...
    async update ( { force } = {} ) {
        ...
        // read config
        const cfg = await env.geteUserConfig();
