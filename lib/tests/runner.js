    ...
    #summaryReport ( options, stat ) {
        ...
        const table = new Table( {
            ...
            "columns": {
                ...
                "total": { "title": ansi.hl( "Total" ) },
                "skipped": { "title": ansi.hl( "Skip" ) },
                "ran": { "title": ansi.hl( "Ran" ) },
                "pass": { "title": ansi.ok( " PASS " ), "format": value => ansi.ok( ` ${value} ` ) },
                "fail": { "title": ansi.error( " FAIL " ), "format": value => ansi.error( ` ${value} ` ) },
            },
        } );
