...
class Runner {
    ...
    async run ( options = {} ) {
        ...
        console.log( "Tests:     ", `${this.#stats.tests.total} total,`, `${this.#stats.tests.ran} ran,`, `${text.ansi.dim( this.#stats.tests.skipped )} skipped,`, `${text.ansi.ok( " " + this.#stats.tests.passed + " " )} passed,`, `${text.ansi.error( " " + this.#stats.tests.failed + " " )} failed` );

        console.log( "Benchmarks:", `${this.#stats.benchmarks.total} total,`, `${this.#stats.benchmarks.ran} ran,`, `${text.ansi.dim( this.#stats.benchmarks.skipped )} skipped` );
