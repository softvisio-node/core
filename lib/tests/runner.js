...
class Runner {
    ...
    async run ( options = {} ) {
        ...
        if ( !options.benchmarks ) console.log( `Tests:      fail: ${ansi.error( " " + stat.stat.failTests + " " )}, pass: ${ansi.ok( " " + stat.stat.passTests + " " )}, total: ${stat.stat.totalTests}, skipped: ${stat.stat.skippedTests}, ran: ${stat.stat.ranTests}` );

        if ( options.benchmarks ) console.log( `Benchmarks: fail: ${ansi.error( " " + stat.stat.failBenchmarks + " " )}, pass: ${ansi.ok( " " + stat.stat.passBenchmarks + " " )}, total: ${stat.stat.totalBenchmarks}, skipped: ${stat.stat.skippedBenchmarks}, ran: ${stat.stat.ranBenchmarks}` );
