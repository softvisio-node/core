...
class Expect {
    ...
    toStrictEqual ( expected ) {
        ...
        const pass = this.#check( equals( this.#received, expected, toStrictEqualTesters, true ) );
...
const toStrictEqualTesters = [iterableEquality, typeEquality, sparseArrayEquality];
