...
class Test extends _Test {
    ...
    printStatus ( options ) {
        ...
        if ( this.isSkipped ) {
            if ( options.showSkipped ) console.log( `   ${ansi.dark( "○" )} ${this.name} ${this._formatReason( this.result.reason )}` );
        }
        else if ( this.result.ok ) {
            if ( options.showPassed ) console.log( `   ${ansi.brightGreen( "√" )} ${this.name} ${this._formatReason( this.durationText )}` );
        }
        else if ( !this.result.ok ) {
            console.log( `   ${ansi.brightRed( "×" )} ${this.name} ${this._formatReason( this.durationText )}` );
        }
    }
