...
class Benchmark extends Test {
    ...
    async run ( options, parent, skipNameFilter ) {
        ...
        else if ( !options.runBenchmarks ) return this._skip( "filtered" );
