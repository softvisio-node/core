    ...
    async run ( options, parent ) {
        ...
        for ( const name in meta ) {
            ...
            if ( baseSpeed == null ) {
                ...
                if ( meta[name].avgSpeed >= baseSpeed ) {
                    relSpeed = ( meta[name].avgSpeed * 100 ) / baseSpeed - 100;
                }
                else {
                    relSpeed = 0 - ( ( baseSpeed * 100 ) / meta[name].avgSpeed - 100 );
                }
            }
                ...
                "relSpeed": {
                    ...
                    format ( value ) {
                        if ( value == null ) {
                            ...
                            if ( value > 0 ) return ansi.ok( " +" + text + "% " );
                            else if ( value < 0 ) return ansi.error( " " + text + "% " );
                            else return text + "%";
                        }
                    },
                },
