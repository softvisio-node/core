...
class Benchmark extends Test {
    ...
    printStatus ( options ) {
        ...
        if ( this.isSkipped ) console.log( `     ${ansi.dim( "○" )} ${ansi.dim( this.label )} ${ansi.dim( this.name )} ${this.result.reason}` );
        else if ( this.result.ok ) console.log( `     ${ansi.brightGreen( "√" )} ${ansi.dim( this.label )} ${this.name}` );
        else if ( !this.result.ok ) console.log( `     ${ansi.brightRed( "×" )} ${ansi.dim( this.label )} ${this.name}` );
    }
