...
import ThreadsManager from "#lib/threads/semaphore";
...
class Benchmark extends Test {
    ...
    async #bench ( meta ) {
        ...
        // multiple threds
            ...
            const threadsManager = new ThreadsManager( { "maxThreads": meta.threads, "maxWaitingThreads": iterations } );
            ...
            for ( let j = 1; j <= iterations; j++ ) {
                ...
                threadsManager.runThread( wrapper ).then( () => semaphore.down() );
            }
