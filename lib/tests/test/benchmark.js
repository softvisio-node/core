...
class Benchmark extends Test {
    ...
    async run ( options, skipNameFilter ) {
        ...
        if ( !options.runBenchmarks ) return this._skip( "filtered" );
    ...
    printStatus ( options ) {
        ...
        if ( this.isSkipped ) console.log( indentSpace, ansi.dim( "○" ), ansi.dim( this.label ), ansi.dim( this.name ), this.result.reason );
        else if ( this.result.ok ) console.log( indentSpace, ansi.brightGreen( "√" ), ansi.dim( this.label ), this.name );
        else if ( !this.result.ok ) console.log( indentSpace, ansi.brightRed( "×" ), ansi.dim( this.label ), this.name );
    }
