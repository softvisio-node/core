...
export default class Connection extends Events {
    ...
    async call ( method, ...args ) {
        if ( this.#isClosed ) return result( 1006 ); // 1006 - Abnormal Closure\
    ...
    #onClose ( e ) {
        ...
        this.#clearPendingRequests( e.code, e.reason );
    ...
    // XXX if ( this.#isClosed ) return result(1006); // 1006 - Abnormal Closure
    #sendQueue ( msg ) {
    ...
    #clearPendingRequests ( status, reason ) {
