...
export default class extends Websocket {
    ...
    constructor ( url, options = {} ) {
        ...
        cacheOptions.max ||= DEFAULT_CACHE_SIZE;
    ...
    // public
    async callCached ( key, method, ...params ) {
        var maxAge;
        ...
        res = await this.call( method, ...params );
    ...
    upload ( method, file, params, onProgress ) {
        ...
        return new this.Upload( this, method, file, params, onProgress );
    }
