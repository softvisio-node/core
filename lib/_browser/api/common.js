...
export default class extends WebSocket {
    ...
    constructor ( url, options ) {
        ...
        this.#cache = new CacheLru( {
            "maxSize": ( options.cacheMaxSize ?? +url.searchParams.get( "cacheMaxSize" ) ) || DEFAULT_CACHE_MAX_SIZE,
            "maxAge": ( options.cacheMaxAge ?? +url.searchParams.get( "cacheMaxAge" ) ) || DEFAULT_CACHE_MAX_AGE,
        } );
