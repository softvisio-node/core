...
export default class extends WebSocket {
    ...
    constructor ( url, { token, locale, persistent, version, maxConnections, checkCertificate, onAuthorization, cache, cacheMaxSize, cacheMaxAge, clearCacheOn } = {} ) {
        super();
    ...
    upload ( method, formData, { signal } = {} ) {
        return new this.Upload( this, this.#getUploadUrl(), method, formData, signal );
    }
