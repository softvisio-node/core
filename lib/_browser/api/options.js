...
export default class extends Websocket {
    ...
    init ( url, options = {} ) {
        ...
        this.#cacheDrop = new Set( options.cacheDrop ?? url.searchParams.getAll( "cacheDrop" ) );
        for ( const name of this.#cacheDrop ) this.on( name, () => this.#cache.reset() );
    ...
    #buildURL () {
        ...
        for ( const name of this.#cacheDrop ) url.searchParams.append( "cacheDrop", name );
