...
export default class extends Http {
    ...
    async _connectWebSocket () {
        ...
        try {
            const records = this.isBrowser ? [{ "address": this.hostname }] : await this._lookup( this.hostname );
            ...
            for ( const record of records ) {
                ...
                // create connection
                const connection = new Connection( this, record.address, url, this.hostname, this.#ref );
                ...
                this.#connectionsHostnames.add( connection.address );
            }
        }
        catch ( e ) {
    ...
    #setReconnectTimeout () {
        ...
        this.#reconnectTimeout = setTimeout( this._connectWebSocket.bind( this ), this.#reconnectInterval ).unref();
    }
    ...
    #onDisconnect ( connection, res ) {
        ...
        this.#connectionsHostnames.delete( connection.address );
