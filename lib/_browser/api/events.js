...
export default class {
    ...
    _setEventsConnection ( connection ) {
    ...
    async #sync ( newConnection ) {
        ...
        if ( this.#pendingSubscribe.size ) {
            this.#connection.callVoid( "/subscribe", [...this.#pendingSubscribe] );
        ...
        if ( this.#pendingUnsubscribe.size ) {
            this.#connection.callVoid( "/unsubscribe", [...this.#pendingUnsubscribe] );
