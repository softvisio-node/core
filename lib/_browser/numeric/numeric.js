...
export default class Numeric {
    ...
    constructor ( value, { precision, scale } = {} ) {
        ...
        const decimalPlaces = this.#checkPrecision( precision );
        ...
        if ( decimalPlaces != null ) {
            ...
            if ( this.#checkPrecision( precision ) != null ) {
    ...
    #checkPrecision ( precision ) {
        if ( !precision && this.#scale == null ) return;
        ...
        if ( precision ) {
            ...
            if ( this.#scale != null ) {
                const maxIntegerPlaces = precision - this.#scale;
