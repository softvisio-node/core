...
export default class Numeric {
    ...
    constructor ( value, { precision, scale } = {} ) {
        ...
        if ( value == null ) {
            this.#DECIMAL = getDecimal( precision )( 0 );
        }
            ...
            this.#DECIMAL = getDecimal( precision )( value.toString() );
        }
        else {
            this.#DECIMAL = getDecimal( precision )( value );
        }

        // check precision
        this.#DECIMAL = this.#toPrecision( this.#DECIMAL, precision, this.#SCALE );
    }
