...
export default class Numeric {
    ...
    compare ( value ) {
        if ( this.constructor.isNumeric( value ) ) {
            return this.#decimal.compare( value[ decimalProperty ] );
        }
        else {
    ...
    eq ( value ) {
        if ( this.constructor.isNumeric( value ) ) {
            return this.#decimal.equals( value[ decimalProperty ] );
        }
        else {
    ...
    gt ( value ) {
        if ( this.constructor.isNumeric( value ) ) {
            return this.#decimal.greaterThan( value[ decimalProperty ] );
        }
        else {
    ...
    gte ( value ) {
        if ( this.constructor.isNumeric( value ) ) {
            return this.#decimal.greaterThanOrEqualTo( value[ decimalProperty ] );
        }
        else {
    ...
    lt ( value ) {
        if ( this.constructor.isNumeric( value ) ) {
            return this.#decimal.lessThan( value[ decimalProperty ] );
        }
        else {
    ...
    lte ( value ) {
        if ( this.constructor.isNumeric( value ) ) {
            return this.#decimal.lessThanOrEqualTo( value[ decimalProperty ] );
        }
        else {
