...
const DEFAULT_PRECISION = 32,
    ...
    ROUNDING_MODE = {
        ...
        "ROUND_HALF_UP": DECIMAL.ROUND_HALF_UP, // default
        "ROUND_HALF_DOWN": DECIMAL.ROUND_HALF_DOWN,
        "ROUND_HALF_EVEN": DECIMAL.ROUND_HALF_EVEN,
        "ROUND_HALF_CEIL": DECIMAL.ROUND_HALF_CEIL,
        "ROUND_HALF_FLOOR": DECIMAL.ROUND_HALF_FLOOR,
        "ROUND_MATH": DECIMAL.ROUND_HALF_CEIL, // like Math.round()
        "ROUND_POSTGRESQL": DECIMAL.ROUND_HALF_UP, // like in PostgreSQL
    },
...
function getDecimal ( precision, roundingMode, moduloMode ) {
    ...
    moduloMode ??= DEFAULT_MODULO_MODE;
...
export default class Numeric {
    ...
    static get EUCLID () {
        return MODULO_MODE.EUCLID;
    }

    static get ROUND_MATH () {
        return ROUNDING_MODE.ROUND_MATH;
    }

    static get ROUND_POSTGRESQL () {
        return ROUNDING_MODE.ROUND_POSTGRESQL;
    }
