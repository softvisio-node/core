...
export default class Numeric {
    ...
    constructor ( value, { precision, scale } = {} ) {
        ...
        if ( scale ) {
            if ( scale > 0 ) {
                ...
                if ( precision && this.#scale > precision ) {
        ...
        // update precision
        if ( precision && precision !== this.#numeric.constructor.precision ) {
            this.#numeric = getDecimal( precision )( this.#numeric );
        }

        const decimalPlaces = this.#checkPrecision( this.#numeric, precision, this.#scale );
        ...
        if ( decimalPlaces != null ) {
            ...
            if ( this.#checkPrecision( this.#numeric, precision, this.#scale ) != null ) {
    ...
    toPrecision ( precision ) {
        ...
        return new this.constructor( this.#numeric.toPrecision( precision ), {
            precision,
            scale,
        } );
    }
    ...
    #checkPrecision ( decimal, precision, scale ) {
        if ( !precision && scale == null ) return;
