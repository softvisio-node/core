...
export default class Numeric {
    ...
    static getRandomInt8 ( { signed, min, max, crypto, precision } = {} ) {
        if ( min == null ) {
            if ( signed ) {
                ...
                min = this.MIN_UNSIGNED_INT8.bigint;
            }
        }
    ...
    static getRandomInt16 ( { signed, min, max, crypto, precision } = {} ) {
        if ( min == null ) {
            if ( signed ) {
                ...
                min = this.MIN_UNSIGNED_INT16.bigint;
            }
        }
    ...
    static getRandomInt32 ( { signed, min, max, crypto, precision } = {} ) {
        if ( min == null ) {
            if ( signed ) {
                ...
                min = this.MIN_UNSIGNED_INT32.bigint;
            }
        }
    ...
    static getRandomInt53 ( { signed, min, max, crypto, precision } = {} ) {
        if ( min == null ) {
            if ( signed ) {
                ...
                min = this.MIN_UNSIGNED_INT53.bigint;
            }
        }
    ...
    static getRandomInt64 ( { signed, min, max, crypto, precision } = {} ) {
        if ( min == null ) {
            if ( signed ) {
                ...
                min = this.MIN_UNSIGNED_INT64.bigint;
            }
        }
    ...
    static getRandomInt128 ( { signed, min, max, crypto, precision } = {} ) {
        if ( min == null ) {
            if ( signed ) {
                ...
                min = this.MIN_UNSIGNED_INT128.bigint;
            }
        }
    ...
    toPrecision ( { precision, scale = this.SCALE } = {} ) {
        return new this.constructor( this.#numeric, {
            precision,
            scale,
        } );
    }
