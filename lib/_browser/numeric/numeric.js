...
export default class Numeric {
    ...
    #toPrecision ( decimal, precision, scale ) {
        ...
        // update precision
        if ( precision && precision !== decimal.constructor.precision ) {
            decimal = getDecimal( precision )( decimal );
        }

        const decimalPlaces = this.#checkPrecision( decimal, precision, scale );
        ...
        if ( decimalPlaces != null ) {
            ...
            if ( this.#checkPrecision( decimal, precision, scale ) != null ) {
