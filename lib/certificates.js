...
const dhParamPath = resolve( "#resources/dh-param.pem", import.meta.url ),
    localDomain = "local.softvisio.net",
    localCertificatePath = resource.getResourcePath( "local/certificate.pem" ),
    localPrivateKeyPath = resource.getResourcePath( "local/private-key.pem " );
...
class Certificates {
    ...
    get localCertificatePath () {
        return localCertificatePath;
    }

    get localPrivateKeyPath () {
        return localPrivateKeyPath;
    }

    // public
    encrypt ( getKey, data, { inputEncoding, outputEncoding } = {} ) {
    ...
    decrypt ( getKey, data, { inputEncoding, outputEncoding } = {} ) {
        if ( data == null ) return null;
