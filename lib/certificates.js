...
const DEFAULT_ISSUER = "Self-signed certificate",
...
export async function createCertificate ( { domains, issuer, organization, organizationUnit, locality, state, country, maxAge } = {} ) {
    ...
    certificate.issuer.typesAndValues.push( new pki.AttributeTypeAndValue( {
        "type": "2.5.4.3",
        "value": new asn1.BmpString( { "value": issuer || DEFAULT_ISSUER } ),
    } ) );
