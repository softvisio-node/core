...
const DEFAULT_MAX_AGE = "10 years",
    ALGORITHM = {
        "name": "ECDSA",
        "namedCurve": "P-384",
        "hash": "SHA-256",
    ...
    CERTIFICATES_RESOURCE = await externalResources.add( "c0rejs/core/resources/certificates" ).check(),
    DH_PARAMS_RESOURCE = await externalResources.add( "c0rejs/core/resources/dh-params" ).check();

export const dhParamsPath = DH_PARAMS_RESOURCE.getResourcePath( "dh-params.pem" ),
...
export async function createCertificate ( { domains, maxAge, commonName, ...attributes } = {} ) {
