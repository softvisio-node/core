...
export async function createCertificate ( { domains, commonName, organization, organizationUnit, locality, state, country, maxAge } = {} ) {
    ...
    if ( country ) {
        certificate.subject.typesAndValues.push( new pki.AttributeTypeAndValue( {
            "type": "2.5.4.6",
            "value": new asn1.BmpString( { "value": country } ),
        } ) );
