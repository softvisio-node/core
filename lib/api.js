...
class WebSocketDispatcher extends Agent {
    ...
    dispatch ( options, handler ) {
        if ( this.#api.tlsServerName ) {
            options.headers.host = this.#api.tlsServerName;
        }
...
export default class ApiClient extends Common {
    ...
    get tlsServerName () {
        if ( this.#tlsServerName === undefined ) {
            if ( isIP( this.hostname ) ) {
                this.#tlsServerName = null;
            }
            else {
                this.#tlsServerName = this.hostname;
            }
        }
    ...
    _createWebSocket ( url, protocols ) {
        this.#dispatcher ||= new WebSocketDispatcher( this );
