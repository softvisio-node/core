...
export default class EventsHub {
    ...
    constructor ( options = {} ) {
        if ( options.maxListeners ) this.#emitter.setMaxListeners( options.maxListeners );
    ...
    watchSubscriptions ( listener ) {
        this.#watch.on( "*", listener );

        return this;
    }

    unwatchSubscriptions ( listener ) {
    ...
    forwardSubscriptions ( target, { on, off, listener } = {} ) {
        ...
        this.watchSubscriptions( spec.watcher );
    }
    ...
    unforwardSubscriptions ( target ) {
        ...
        this.unwatchSubscriptions( spec.watcher );
