...
// cache: bool
// compressionThreshold: false, true, number
// headers: {}
...
async function sendFile ( req, path, options ) {
    ...
    var cache = options.cache,
        compress = !options.compressionThreshold ? false : options.compressionThreshold === true ? true : size >= options.compressionThreshold,
    ...
    folder ( location, folder, options ) {
        ...
        this.get( `${location}/*`, async ( res, req ) => {
            ...
            if ( filepath === path.sep ) {
                ...
                res.sendFile( req, folder + path.sep + filepath, options );
            }
        } );
    ...
    webpack ( location, folder ) {
        ...
        this.get( `${location}/*`, async ( res, req ) => {
            ...
            if ( filepath === path.sep ) {
                ...
                res.sendFile( req, folder + path.sep + filepath, optionsOther );
            }
        } );
