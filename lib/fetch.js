...
const resource = await externalResources.add( "softvisio-node/core/resources/http", import.meta.url );
resource.on( "update", resource => loadResources() );
...
function loadResources () {
    RESOURCES = config.readConfig( resource.location + "/http.json" );
}
