...
async function loadResources () {
    ...
    RESOURCES = JSON.parse( fs.readFileSync( resources.location + "/" + resources.get( "http" ).files[0], "utf8" ) );
}
...
Object.defineProperty( fetch, "resources", {
    "value": new Resources(),
} );

// fetch.resources = new Resources();
