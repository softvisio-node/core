...
var USER_AGENT = `Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.137 Safari/537.36`;
...
async function request ( url, options ) {
    ...
    // user-agent
    if ( !req.getHeader( "user-agent" ) ) req.setHeader( "User-Agent", USER_AGENT );
